...
</defs>`,D.innerText="Preview backend running in this workspace."),D.setAttribute("id",v)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",m):m()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gl=new Yd("@firebase/auth");function LS(t,...e){gl.logLevel<=Le.WARN&&gl.warn(`Auth (${Ti}): ${t}`,...e)}function Ga(t,...e){gl.logLevel<=Le.ERROR&&gl.error(`Auth (${Ti}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var jr,R_;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(P,w){function T(){}T.prototype=w.prototype,P.D=w.prototype,P.prototype=new T,P.prototype.constructor=P,P.C=function(C,x,R){for(var S=Array(arguments.length-2),Ne=2;Ne<arguments.length;Ne++)S[Ne-2]=arguments[Ne];return w.prototype[x].apply(C,S)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(P,w,T){T||(T=0);var C=Array(16);if(typeof w=="string")for(var x=0;16>x;++x)C[x]=w.charCodeAt(T++)|w.charCodeAt(T++)<<8|w.charCodeAt(T++)<<16|w.charCodeAt(T++)<<24;else for(x=0;16>x;++x)C[x]=w[T++]|w[T++]<<8|w[T++]<<16|w[T++]<<24;w=P.g[0],T=P.g[1],x=P.g[2];var R=P.g[3],S=w+(R^T&(x^R))+C[0]+3614090360&4294967295;w=T+(S<<7&4294967295|S>>>25),S=R+(x^w&(T^x))+C[1]+3905402710&4294967295,R=w+(S<<12&4294967295|S>>>20),S=x+(T^R&(w^T))+C[2]+606105819&4294967295,x=R+(S<<17&4294967295|S>>>15),S=T+(w^x&(R^w))+C[3]+3250441966&4294967295,T=x+(S<<22&4294967295|S>>>10),S=w+(R^T&(x^R))+C[4]+4118548399&4294967295,w=T+(S<<7&4294967295|S>>>25),S=R+(x^w&(T^x))+C[5]+1200080426&4294967295,R=w+(S<<12&4294967295|S>>>20),S=x+(T^R&(w^T))+C[6]+2821735955&4294967295,x=R+(S<<17&4294967295|S>>>15),S=T+(w^x&(R^w))+C[7]+4249261313&4294967295,T=x+(S<<22&4294967295|S>>>10),S=w+(R^T&(x^R))+C[8]+1770035416&4294967295,w=T+(S<<7&4294967295|S>>>25),S=R+(x^w&(T^x))+C[9]+2336552879&4294967295,R=w+(S<<12&4294967295|S>>>20),S=x+(T^R&(w^T))+C[10]+4294925233&4294967295,x=R+(S<<17&4294967295|S>>>15),S=T+(w^x&(R^w))+C[11]+2304563134&4294967295,T=x+(S<<22&4294967295|S>>>10),S=w+(R^T&(x^R))+C[12]+1804603682&4294967295,w=T+(S<<7&4294967295|S>>>25),S=R+(x^w&(T^x))+C[13]+4254626195&4294967295,R=w+(S<<12&4294967295|S>>>20),S=x+(T^R&(w^T))+C[14]+2792965006&4294967295,x=R+(S<<17&4294967295|S>>>15),S=T+(w^x&(R^w))+C[15]+1236535329&4294967295,T=x+(S<<22&4294967295|S>>>10),S=w+(x^R&(T^x))+C[1]+4129170786&4294967295,w=T+(S<<5&4294967295|S>>>27),S=R+(T^x&(w^T))+C[6]+3225465664&4294967295,R=w+(S<<9&4294967295|S>>>23),S=x+(w^T&(R^w))+C[11]+643717713&4294967295,x=R+(S<<14&4294967295|S>>>18),S=T+(R^w&(x^R))+C[0]+3921069994&4294967295,T=x+(S<<20&4294967295|S>>>12),S=w+(x^R&(T^x))+C[5]+3593408605&4294967295,w=T+(S<<5&4294967295|S>>>27),S=R+(T^x&(w^T))+C[10]+38016083&4294967295,R=w+(S<<9&4294967295|S>>>23),S=x+(w^T&(R^w))+C[15]+3634488961&4294967295,x=R+(S<<14&4294967295|S>>>18),S=T+(R^w&(x^R))+C[4]+3889429448&4294967295,T=x+(S<<20&4294967295|S>>>12),S=w+(x^R&(T^x))+C[9]+568446438&4294967295,w=T+(S<<5&4294967295|S>>>27),S=R+(T^x&(w^T))+C[14]+3275163606&4294967295,R=w+(S<<9&4294967295|S>>>23),S=x+(w^T&(R^w))+C[3]+4107603335&4294967295,x=R+(S<<14&4294967295|S>>>18),S=T+(R^w&(x^R))+C[8]+1163531501&4294967295,T=x+(S<<20&4294967295|S>>>12),S=w+(x^R&(T^x))+C[13]+2850285829&4294967295,w=T+(S<<5&4294967295|S>>>27),S=R+(T^x&(w^T))+C[2]+4243563512&4294967295,R=w+(S<<9&4294967295|S>>>23),S=x+(w^T&(R^w))+C[7]+1735328473&4294967295,x=R+(S<<14&4294967295|S>>>18),S=T+(R^w&(x^R))+C[12]+2368359562&4294967295,T=x+(S<<20&4294967295|S>>>12),S=w+(T^x^R)+C[5]+4294588738&4294967295,w=T+(S<<4&4294967295|S>>>28),S=R+(w^T^x)+C[8]+2272392833&4294967295,R=w+(S<<11&4294967295|S>>>21),S=x+(R^w^T)+C[11]+1839030562&4294967295,x=R+(S<<16&4294967295|S>>>16),S=T+(x^R^w)+C[14]+4259657740&4294967295,T=x+(S<<23&4294967295|S>>>9),S=w+(T^x^R)+C[1]+2763975236&4294967295,w=T+(S<<4&4294967295|S>>>28),S=R+(w^T^x)+C[4]+1272893353&4294967295,R=w+(S<<11&4294967295|S>>>21),S=x+(R^w^T)+C[7]+4139469664&4294967295,x=R+(S<<16&4294967295|S>>>16),S=T+(x^R^w)+C[10]+3200236656&4294967295,T=x+(S<<23&4294967295|S>>>9),S=w+(T^x^R)+C[13]+681279174&4294967295,w=T+(S<<4&4294967295|S>>>28),S=R+(w^T^x)+C[0]+3936430074&4294967295,R=w+(S<<11&4294967295|S>>>21),S=x+(R^w^T)+C[3]+3572445317&4294967295,x=R+(S<<16&4294967295|S>>>16),S=T+(x^R^w)+C[6]+76029189&4294967295,T=x+(S<<23&4294967295|S>>>9),S=w+(T^x^R)+C[9]+3654602809&4294967295,w=T+(S<<4&4294967295|S>>>28),S=R+(w^T^x)+C[12]+3873151461&4294967295,R=w+(S<<11&4294967295|S>>>21),S=x+(R^w^T)+C[15]+530742520&4294967295,x=R+(S<<16&4294967295|S>>>16),S=T+(x^R^w)+C[2]+3299628645&4294967295,T=x+(S<<23&4294967295|S>>>9),S=w+(x^(T|~R))+C[0]+4096336452&4294967295,w=T+(S<<6&4294967295|S>>>26),S=R+(T^(w|~x))+C[7]+1126891415&4294967295,R=w+(S<<10&4294967295|S>>>22),S=x+(w^(R|~T))+C[14]+2878612391&4294967295,x=R+(S<<15&4294967295|S>>>17),S=T+(R^(x|~w))+C[5]+4237533241&4294967295,T=x+(S<<21&4294967295|S>>>11),S=w+(x^(T|~R))+C[12]+1700485571&4294967295,w=T+(S<<6&4294967295|S>>>26),S=R+(T^(w|~x))+C[3]+2399980690&4294967295,R=w+(S<<10&4294967295|S>>>22),S=x+(w^(R|~T))+C[10]+4293915773&4294967295,x=R+(S<<15&4294967295|S>>>17),S=T+(R^(x|~w))+C[1]+2240044497&4294967295,T=x+(S<<21&4294967295|S>>>11),S=w+(x^(T|~R))+C[8]+1873313359&4294967295,w=T+(S<<6&4294967295|S>>>26),S=R+(T^(w|~x))+C[15]+4264355552&4294967295,R=w+(S<<10&4294967295|S>>>22),S=x+(w^(R|~T))+C[6]+2734768916&4294967295,x=R+(S<<15&4294967295|S>>>17),S=T+(R^(x|~w))+C[13]+1309151649&4294967295,T=x+(S<<21&4294967295|S>>>11),S=w+(x^(T|~R))+C[4]+4149444226&4294967295,w=T+(S<<6&4294967295|S>>>26),S=R+(T^(w|~x))+C[11]+3174756917&4294967295,R=w+(S<<10&4294967295|S>>>22),S=x+(w^(R|~T))+C[2]+718787259&4294967295,x=R+(S<<15&4294967295|S>>>17),S=T+(R^(x|~w))+C[9]+3951481745&4294967295,P.g[0]=P.g[0]+w&4294967295,P.g[1]=P.g[1]+(x+(S<<21&4294967295|S>>>11))&4294967295,P.g[2]=P.g[2]+x&4294967295,P.g[3]=P.g[3]+R&4294967295}r.prototype.u=function(P,w){w===void 0&&(w=P.length);for(var T=w-this.blockSize,C=this.B,x=this.h,R=0;R<w;){if(x==0)for(;R<=T;)s(this,P,R),R+=this.blockSize;if(typeof P=="string"){for(;R<w;)if(C[x++]=P.charCodeAt(R++),x==this.blockSize){s(this,C),x=0;break}}else for(;R<w;)if(C[x++]=P[R++],x==this.blockSize){s(this,C),x=0;break}}this.h=x,this.o+=w},r.prototype.v=function(){var P=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);P[0]=128;for(var w=1;w<P.length-8;++w)P[w]=0;var T=8*this.o;for(w=P.length-8;w<P.length;++w)P[w]=T&255,T/=256;for(this.u(P),P=Array(16),w=T=0;4>w;++w)for(var C=0;32>C;C+=8)P[T++]=this.g[w]>>>C&255;return P};function i(P,w){var T=c;return Object.prototype.hasOwnProperty.call(T,P)?T[P]:T[P]=w(P)}function o(P,w){this.h=w;for(var T=[],C=!0,x=P.length-1;0<=x;x--){var R=P[x]|0;C&&R==w||(T[x]=R,C=!1)}this.g=T}var c={};function l(P){return-128<=P&&128>P?i(P,function(w){return new o([w|0],0>w?-1:0)}):new o([P|0],0>P?-1:0)}function u(P){if(isNaN(P)||!isFinite(P))return m;if(0>P)return E(u(-P));for(var w=[],T=1,C=0;P>=T;C++)w[C]=P/T|0,T*=4294967296;return new o(w,0)}function h(P,w){if(P.length==0)throw Error("number format error: empty string");if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(P.charAt(0)=="-")return E(h(P.substring(1),w));if(0<=P.indexOf("-"))throw Error('number format error: interior "-" character');for(var T=u(Math.pow(w,8)),C=m,x=0;x<P.length;x+=8){var R=Math.min(8,P.length-x),S=parseInt(P.substring(x,x+R),w);8>R?(R=u(Math.pow(w,R)),C=C.j(R).add(u(S))):(C=C.j(T),C=C.add(u(S)))}return C}var m=l(0),p=l(1),v=l(16777216);t=o.prototype,t.m=function(){if(I(this))return-E(this).m();for(var P=0,w=1,T=0;T<this.g.length;T++){var C=this.i(T);P+=(0<=C?C:4294967296+C)*w,w*=4294967296}return P},t.toString=function(P){if(P=P||10,2>P||36<P)throw Error("radix out of range: "+P);if(D(this))return"0";if(I(this))return"-"+E(this).toString(P);for(var w=u(Math.pow(P,6)),T=this,C="";;){var x=V(T,w).g;T=k(T,x.j(w));var R=((0<T.g.length?T.g[0]:T.h)>>>0).toString(P);if(T=x,D(T))return R+C;for(;6>R.length;)R="0"+R;C=R+C}},t.i=function(P){return 0>P?0:P<this.g.length?this.g[P]:this.h};function D(P){if(P.h!=0)return!1;for(var w=0;w<P.g.length;w++)if(P.g[w]!=0)return!1;return!0}function I(P){return P.h==-1}t.l=function(P){return P=k(this,P),I(P)?-1:D(P)?0:1};function E(P){for(var w=P.g.length,T=[],C=0;C<w;C++)T[C]=~P.g[C];return new o(T,~P.h).add(p)}t.abs=function(){return I(this)?E(this):this},t.add=function(P){for(var w=Math.max(this.g.length,P.g.length),T=[],C=0,x=0;x<=w;x++){var R=C+(this.i(x)&65535)+(P.i(x)&65535),S=(R>>>16)+(this.i(x)>>>16)+(P.i(x)>>>16);C=S>>>16,R&=65535,S&=65535,T[x]=S<<16|R}return new o(T,T[T.length-1]&-2147483648?-1:0)};function k(P,w){return P.add(E(w))}t.j=function(P){if(D(this)||D(P))return m;if(I(this))return I(P)?E(this).j(E(P)):E(E(this).j(P));if(I(P))return E(this.j(E(P)));if(0>this.l(v)&&0>P.l(v))return u(this.m()*P.m());for(var w=this.g.length+P.g.length,T=[],C=0;C<2*w;C++)T[C]=0;for(C=0;C<this.g.length;C++)for(var x=0;x<P.g.length;x++){var R=this.i(C)>>>16,S=this.i(C)&65535,Ne=P.i(x)>>>16,de=P.i(x)&65535;T[2*C+2*x]+=S*de,N(T,2*C+2*x),T[2*C+2*x+1]+=R*de,N(T,2*C+2*x+1),T[2*C+2*x+1]+=S*Ne,N(T,2*C+2*x+1),T[2*C+2*x+2]+=R*Ne,N(T,2*C+2*x+2)}for(C=0;C<w;C++)T[C]=T[2*C+1]<<16|T[2*C];for(C=w;C<2*w;C++)T[C]=0;return new o(T,0)};function N(P,w){for(;(P[w]&65535)!=P[w];)P[w+1]+=P[w]>>>16,P[w]&=65535,w++}function $(P,w){this.g=P,this.h=w}function V(P,w){if(D(w))throw Error("division by zero");if(D(P))return new $(m,m);if(I(P))return w=V(E(P),w),new $(E(w.g),E(w.h));if(I(w))return w=V(P,E(w)),new $(E(w.g),w.h);if(30<P.g.length){if(I(P)||I(w))throw Error("slowDivide_ only works with positive integers.");for(var T=p,C=w;0>=C.l(P);)T=F(T),C=F(C);var x=X(T,1),R=X(C,1);for(C=X(C,2),T=X(T,2);!D(C);){var S=R.add(C);0>=S.l(P)&&(x=x.add(T),R=S),C=X(C,1),T=X(T,1)}return w=k(P,x.j(w)),new $(x,w)}for(x=m;0<=P.l(w);){for(T=Math.max(1,Math.floor(P.m()/w.m())),C=Math.ceil(Math.log(T)/Math.LN2),C=48>=C?1:Math.pow(2,C-48),R=u(T),S=R.j(w);I(S)||0<S.l(P);)T-=C,R=u(T),S=R.j(w);D(R)&&(R=p),x=x.add(R),P=k(P,S)}return new $(x,P)}t.A=function(P){return V(this,P).h},t.and=function(P){for(var w=Math.max(this.g.length,P.g.length),T=[],C=0;C<w;C++)T[C]=this.i(C)&P.i(C);return new o(T,this.h&P.h)},t.or=function(P){for(var w=Math.max(this.g.length,P.g.length),T=[],C=0;C<w;C++)T[C]=this.i(C)|P.i(C);return new o(T,this.h|P.h)},t.xor=function(P){for(var w=Math.max(this.g.length,P.g.length),T=[],C=0;C<w;C++)T[C]=this.i(C)^P.i(C);return new o(T,this.h^P.h)};function F(P){for(var w=P.g.length+1,T=[],C=0;C<w;C++)T[C]=P.i(C)<<1|P.i(C-1)>>>31;return new o(T,P.h)}function X(P,w){var T=w>>5;w%=32;for(var C=P.g.length-T,x=[],R=0;R<C;R++)x[R]=0<w?P.i(R+T)>>>w|P.i(R+T+1)<<32-w:P.i(R+T);return new o(x,P.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,R_=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=u,o.fromString=h,jr=o}).apply(typeof Pm<"u"?Pm:typeof self<"u"?self:typeof window<"u"?window:{});var xa=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ds=new Yd("@firebase/firestore");function Ks(){return Ds.logLevel}function ue(t,...e){if(Ds.logLevel<=Le.DEBUG){const n=e.map(uh);Ds.debug(`Firestore (${Si}): ${t}`,...n)}}function cr(t,...e){if(Ds.logLevel<=Le.ERROR){const n=e.map(uh);Ds.error(`Firestore (${Si}): ${t}`,...n)}}function Kr(t,...e){if(Ds.logLevel<=Le.WARN){const n=e.map(uh);Ds.warn(`Firestore (${Si}): ${t}`,...n)}}function uh(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jC=new st(be.comparator);function ur(){return jC}const i1=new st(be.comparator);function Zi(...t){let e=i1;for(const n of t)e=e.insert(n.key,n);return e}function o1(t){let e=i1;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function ws(){return _o()}function a1(){return _o()}function _o(){return new Vs(t=>t.toString(),(t,e)=>t.isEqual(e))}const qC=new st(be.comparator),HC=new _t(be.comparator);function $e(...t){let e=HC;for(const n of t)e=e.add(n);return e}const zC=new _t(xe);function WC(){return zC}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ih{constructor(e,n,r,s){this.targetId=e,this.fromCache=n,this.Is=r,this.ds=s}static Es(e,n){let r=$e(),s=$e();for(const i of n.docChanges)switch(i.type){case 0:r=r.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new Ih(e,n.fromCache,r,s)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zR{constructor(){this.As=!1,this.Rs=!1,this.Vs=100,this.fs=function(){return vI()?8:_C(Bt())>0?6:4}()}initialize(e,n){this.gs=e,this.indexManager=n,this.As=!0}getDocumentsMatchingQuery(e,n,r,s){const i={result:null};return this.ps(e,n).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.ys(e,n,s,r).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new HR;return this.ws(e,n,o).next(c=>{if(i.result=c,this.Rs)return this.Ss(e,n,o,c.size)})}).next(()=>i.result)}Ss(e,n,r,s){return r.documentReadCount<this.Vs?(Ks()<=Le.DEBUG&&ue("QueryEngine","SDK will not create cache indexes for query:",Ys(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),G.resolve()):(Ks()<=Le.DEBUG&&ue("QueryEngine","Query:",Ys(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.fs*s?(Ks()<=Le.DEBUG&&ue("QueryEngine","The SDK decides to create cache indexes for query:",Ys(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Vn(n))):G.resolve())}ps(e,n){if(Km(n))return G.resolve(null);let r=Vn(n);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(n.limit!==null&&s===1&&(n=Ju(n,null,"F"),r=Vn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const o=$e(...i);return this.gs.getDocuments(e,o).next(c=>this.indexManager.getMinOffset(e,r).next(l=>{const u=this.bs(n,c);return this.Ds(n,u,o,l.readTime)?this.ps(e,Ju(n,null,"F")):this.vs(e,u,n,l)}))})))}ys(e,n,r,s){return Km(n)||s.isEqual(Pe.min())?G.resolve(null):this.gs.getDocuments(e,r).next(i=>{const o=this.bs(n,i);return this.Ds(n,o,r,s)?G.resolve(null):(Ks()<=Le.DEBUG&&ue("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Ys(n)),this.vs(e,o,n,pC(s,Vo)).next(c=>c))})}bs(e,n){let r=new _t(s1(e));return n.forEach((s,i)=>{cc(e,i)&&(r=r.add(i))}),r}Ds(e,n,r,s){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}ws(e,n,r){return Ks()<=Le.DEBUG&&ue("QueryEngine","Using full collection scan to execute query:",Ys(n)),this.gs.getDocumentsMatchingQuery(e,n,Yr.min(),r)}vs(e,n,r,s){return this.gs.getDocumentsMatchingQuery(e,r,s).next(i=>(n.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mt="WebChannelConnection";class oD extends sD{constructor(e){super(e),this.u_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}jo(e,n,r,s,i){const o=sd();return new Promise((c,l)=>{const u=new D_;u.setWithCredentials(!0),u.listenOnce(k_.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case Qa.NO_ERROR:const m=u.getResponseJson();ue(Mt,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(m)),c(m);break;case Qa.TIMEOUT:ue(Mt,`RPC '${e}' ${o} timed out`),l(new ae(q.DEADLINE_EXCEEDED,"Request time out"));break;case Qa.HTTP_ERROR:const p=u.getStatus();if(ue(Mt,`RPC '${e}' ${o} failed with status:`,p,"response text:",u.getResponseText()),p>0){let v=u.getResponseJson();Array.isArray(v)&&(v=v[0]);const D=v?.error;if(D&&D.status&&D.message){const I=function(k){const N=k.toLowerCase().replace(/_/g,"-");return Object.values(q).indexOf(N)>=0?N:q.UNKNOWN}(D.status);l(new ae(I,D.message))}else l(new ae(q.UNKNOWN,"Server responded with status "+u.getStatus()))}else l(new ae(q.UNAVAILABLE,"Connection failed."));break;default:Se(9055,{c_:e,streamId:o,l_:u.getLastErrorCode(),h_:u.getLastError()})}}finally{ue(Mt,`RPC '${e}' ${o} completed.`)}});const h=JSON.stringify(s);ue(Mt,`RPC '${e}' ${o} sending request:`,s),u.send(n,"POST",h,r,15)})}P_(e,n,r){const s=sd(),i=[this.$o,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=N_(),c=x_(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.zo(l.initMessageHeaders,n,r),l.encodeInitMessageHeaders=!0;const h=i.join("");ue(Mt,`Creating RPC '${e}' stream ${s}: ${h}`,l);const m=o.createWebChannel(h,l);this.T_(m);let p=!1,v=!1;const D=new iD({Ho:E=>{v?ue(Mt,`Not sending because RPC '${e}' stream ${s} is closed:`,E):(p||(ue(Mt,`Opening RPC '${e}' stream ${s} transport.`),m.open(),p=!0),ue(Mt,`RPC '${e}' stream ${s} sending:`,E),m.send(E))},Yo:()=>m.close()}),I=(E,k,N)=>{E.listen(k,$=>{try{N($)}catch(V){setTimeout(()=>{throw V},0)}})};return I(m,Ji.EventType.OPEN,()=>{v||(ue(Mt,`RPC '${e}' stream ${s} transport opened.`),D.s_())}),I(m,Ji.EventType.CLOSE,()=>{v||(v=!0,ue(Mt,`RPC '${e}' stream ${s} transport closed`),D.__(),this.I_(m))}),I(m,Ji.EventType.ERROR,E=>{v||(v=!0,Kr(Mt,`RPC '${e}' stream ${s} transport errored. Name:`,E.name,"Message:",E.message),D.__(new ae(q.UNAVAILABLE,"The operation could not be completed")))}),I(m,Ji.EventType.MESSAGE,E=>{var k;if(!v){const N=E.data[0];We(!!N,16349);const $=N,V=$?.error||((k=$[0])===null||k===void 0?void 0:k.error);if(V){ue(Mt,`RPC '${e}' stream ${s} received error:`,V);const F=V.status;let X=function(T){const C=mt[T];if(C!==void 0)return m1(C)}(F),P=V.message;X===void 0&&(X=q.INTERNAL,P="Unknown error status: "+F+" with message "+V.message),v=!0,D.__(new ae(X,P)),m.close()}else ue(Mt,`RPC '${e}' stream ${s} received:`,N),D.a_(N)}}),I(c,O_.STAT_EVENT,E=>{E.stat===zu.PROXY?ue(Mt,`RPC '${e}' stream ${s} detected buffering proxy`):E.stat===zu.NOPROXY&&ue(Mt,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{D.o_()},0),D}terminate(){this.u_.forEach(e=>e.close()),this.u_=[]}T_(e){this.u_.push(e)}I_(e){this.u_=this.u_.filter(n=>n===e)}}function hu(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ln{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new ae(q.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new ae(q.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return xe(this._lat,e._lat)||xe(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Ln._jsonSchemaVersion}}static fromJSON(e){if(ta(e,Ln._jsonSchema))return new Ln(e.latitude,e.longitude)}}Ln._jsonSchemaVersion="firestore/geoPoint/1.0",Ln._jsonSchema={type:yt("string",Ln._jsonSchemaVersion),latitude:yt("number"),longitude:yt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,Fe=J?X.value?p.value.otherScanDescription:p.value.subScanType:"N/A",on=J?P.value?p.value.otherScanPlaceDescription:p.value.scanPlace:"N/A",an=J?`${p.value.scanType} of the ${on}, protocol: "${Fe}"`:"Not specified",Ot=`
    ${Ge}
    ...
    **GENERATE RECOMMENDATION BASED ON THE FOLLOWING DATA. FOLLOW THE RULES FOR THE SPECIFIED USER TYPE ABOVE.**
    ...
    - **User type:** ${pt}
    - **Examination type:** ${an}
    - **Number of scans:** ${p.value.numberOfScans}
    - **Exposure time:** "Not provided"
    - **Patient parameters:** "age: ${new Date().getFullYear()-new Date(p.value.birthDate).getFullYear()}, sex: ${p.value.gender}, pregnancy status: ${p.value.isPregnant?`Yes, due around ${p.value.estimatedDueDate}`:"No"}, body thickness: ${p.value.weight?`${p.value.weight}kg`:"Not provided"}"
    - **Distance from source:** "Not provided"
    - **Shielding availability:** "Not provided"
    - **Estimated dose (mSv):** ${Y!==null?Y.toFixed(3):"N/A"}
    ...
    - **Reason / Symptoms / Medical History:** "${p.value.currentSymptoms||"Not provided"}. History: ${p.value.medicalHistory||"None"}"
    - **Doctor's Additional Context on Positioning/Shielding:** "${p.value.doctorAdditionalContext||"None"}"
    - **Language for response:** ${it==="en"?"English":"Arabic"}
  ...
  `,H={type:"OBJECT",properties:{recommendationText:{type:"STRING"},Warning:{type:"STRING"}},required:["recommendationText","Warning"]};try{const Me=await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyC8npsehZb6bm1r7lOc4oofjwkrldVINvY",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:[{text:Ot}]}],generationConfig:{responseMimeType:"application/json",responseSchema:H}})});if(!Me.ok)throw new Error(`API Error: ${Me.statusText}`);const A=await Me.json(),O=JSON.parse(A.candidates[0].content.parts[0].text);E.value={...O,patientCalculatedMsv:Y,doctorOccupationalMsv:$.value?0:fe}}catch(le){console.error("AI advice generation failed. Using fallback.",le),E.value={recommendationText:it==="en"?"AI service failed. Please use clinical judgment.":"فشلت خدمة الذكاء الاصطناعي. يرجى استخدام الحكم السريري.",Warning:it==="en"?"Review inputs carefully.":"راجع المدخلات بعناية.",patientCalculatedMsv:Y,doctorOccupationalMsv:$.value?0:fe}}finally{v.value=!1}},ce=async()=>{if(!E.value||!p.value.patientId){alert("No recommendation data to save or patient ID is missing.");return}if(E.value.patientCalculatedMsv===null){alert(i.value==="en"?"Cannot save a record without specific scan details.":"لا يمكن حفظ سجل بدون تفاصيل فحص محددة.");return}D.value=!0;try{const J=p.value.scanPlace==="other"?p.value.otherScanPlaceDescription:p.value.scanPlace,Y=p.value.subScanType==="Other"?p.value.otherScanDescription:p.value.subScanType,fe={patientId:p.value.patientId,scanType:p.value.scanType,scanPlace:J,scanDetail:Y,numberOfScans:p.value.numberOfScans,scanDate:Oe.now(),patientDose:Number(E.value.patientCalculatedMsv)||0,doctorDose:Number(E.value.doctorOccupationalMsv)||0,reason:p.value.currentSymptoms||"As per AI recommendation",notes:E.value.recommendationText,isPersonalScan:m.value==="personal"};if(await s.createScan(fe))alert(i.value==="en"?"Scan record saved successfully!":"!تم حفظ سجل الفحص بنجاح"),c&&c(),E.value=null;else throw new Error(s.error)}catch(J){console.error("Error saving scan from recommendation:",J),alert(i.value==="en"?`Failed to save scan: ${J.message}`:`فشل حفظ الفحص: ${J.message}`)}finally{D.value=!1}};return(J,Y)=>(U(),j("div",{class:"recommend-page",dir:y(i)==="ar"?"rtl":"ltr"},[d("main",kk,[d("section",Ok,[d("h2",null,_(y(i)==="en"?"Medical Scan Advisor":"مستشار الفحص الطبي"),1),d("p",null,_(y(i)==="en"?"Fill in the details to get AI-powered advice. Scan details are optional for patients.":"املأ التفاصيل للحصول على نصيحة مدعومة بالذكاء الاصطناعي. تفاصيل الفحص اختيارية للمرضى."),1),d("div",xk,[d("button",{class:zr({active:m.value==="personal"}),onClick:Y[0]||(Y[0]=fe=>m.value="personal")},_(y(i)==="en"?"For Myself":"لنفسي"),3),N.value==="doctor"?(U(),j("button",{key:0,class:zr({active:m.value==="general"}),onClick:Y[1]||(Y[1]=fe=>m.value="general")},_(y(i)==="en"?"For Another Patient":"لمريض آخر"),3)):pe("",!0)]),I.value?(U(),j("div",Nk,[d("span",null,_(y(i)==="en"?"Loading Patient Data...":"جاري تحميل بيانات المريض..."),1)])):pe("",!0),p.value.patientId&&p.value.patientName?(U(),j("div",Vk,[at(_(y(i)==="en"?"Getting recommendation for:":"الحصول على توصية لـ:")+" ",1),d("strong",null,_(p.value.patientName),1),at(" ("+_(p.value.weight?`${p.value.weight} kg`:"Weight N/A")+") ",1)])):pe("",!0),d("form",{onSubmit:tt(de,["prevent"]),class:"recommend-form"},[d("div",Mk,[d("label",null,_(y(i)==="en"?"Weight (kg)":"الوزن (كجم)"),1),ee(d("input",{type:"number",step:"0.1","onUpdate:modelValue":Y[2]||(Y[2]=fe=>p.value.weight=fe),disabled:m.value==="personal",placeholder:"e.g. 70.5"},null,8,Lk),[[me,p.value.weight]])]),d("div",$k,[d("label",null,[at(_(y(i)==="en"?"Date of Birth":"تاريخ الميلاد")+" ",1),Y[16]||(Y[16]=d("span",{class:"required-indicator"},"*",-1))]),ee(d("input",{type:"date","onUpdate:modelValue":Y[3]||(Y[3]=fe=>p.value.birthDate=fe),disabled:m.value==="personal",required:""},null,8,Fk),[[me,p.value.birthDate]])]),d("div",Uk,[d("label",null,[at(_(y(i)==="en"?"Gender":"الجنس")+" ",1),Y[17]||(Y[17]=d("span",{class:"required-indicator"},"*",-1))]),ee(d("select",{"onUpdate:modelValue":Y[4]||(Y[4]=fe=>p.value.gender=fe),disabled:m.value==="personal",required:""},[d("option",jk,_(y(i)==="en"?"Male":"ذكر"),1),d("option",qk,_(y(i)==="en"?"Female":"أنثى"),1)],8,Bk),[[lt,p.value.gender]])]),p.value.gender==="female"?(U(),j("div",Hk,[d("div",zk,[d("label",null,[ee(d("input",{type:"checkbox","onUpdate:modelValue":Y[5]||(Y[5]=fe=>p.value.isPregnant=fe),disabled:m.value==="personal"},null,8,Wk),[[Ko,p.value.isPregnant]]),d("span",null,_(y(i)==="en"?"Is Pregnant?":"هل هي حامل؟"),1)])]),p.value.isPregnant?(U(),j("div",Gk,[d("label",null,[at(_(y(i)==="en"?"Estimated Due Date":"تاريخ الولادة المتوقع")+" ",1),Y[18]||(Y[18]=d("span",{class:"required-indicator"},"*",-1))]),ee(d("input",{type:"date","onUpdate:modelValue":Y[6]||(Y[6]=fe=>p.value.estimatedDueDate=fe),disabled:m.value==="personal",required:""},null,8,Kk),[[me,p.value.estimatedDueDate]])])):pe("",!0)])):pe("",!0),d("div",Yk,[d("label",null,_(y(i)==="en"?"Relevant Medical History":"التاريخ الطبي ذو الصلة"),1),ee(d("textarea",{"onUpdate:modelValue":Y[7]||(Y[7]=fe=>p.value.medicalHistory=fe),rows:"3",disabled:m.value==="personal"},null,8,Xk),[[me,p.value.medicalHistory]])]),d("div",Qk,[d("label",null,_(y(i)==="en"?"Current Symptoms":"الأعراض الحالية"),1),ee(d("textarea",{"onUpdate:modelValue":Y[8]||(Y[8]=fe=>p.value.currentSymptoms=fe),rows:"3"},null,512),[[me,p.value.currentSymptoms]])]),N.value==="doctor"&&m.value==="general"?(U(),j("div",Jk,[d("h3",Zk,_(y(i)==="en"?"Occupational Exposure Context":"سياق التعرض المهني"),1),d("div",eO,[d("label",null,_(y(i)==="en"?"Your positioning, shielding, etc. (Optional)":"موقعك، التدريع المستخدم، إلخ (اختياري)"),1),ee(d("textarea",{"onUpdate:modelValue":Y[9]||(Y[9]=fe=>p.value.doctorAdditionalContext=fe),rows:"3"},null,512),[[me,p.value.doctorAdditionalContext]])])])):pe("",!0),d("h3",tO,_(y(i)==="en"?"Scan to Consider (Optional for Patients)":"الفحص المقترح (اختياري للمرضى)"),1),d("div",nO,[d("label",null,[at(_(y(i)==="en"?"Place of Scan":"مكان الفحص")+" ",1),V.value?(U(),j("span",rO,"*")):pe("",!0)]),ee(d("select",{"onUpdate:modelValue":Y[10]||(Y[10]=fe=>p.value.scanPlace=fe),required:V.value},[d("option",iO,_(y(i)==="en"?"Select...":"اختر..."),1),(U(),j(Xe,null,Jt(u,fe=>d("option",{key:fe.value,value:fe.value},_(y(i)==="en"?fe.en:fe.ar),9,oO)),64))],8,sO),[[lt,p.value.scanPlace]])]),P.value?(U(),j("div",aO,[d("label",null,[at(_(y(i)==="en"?"Please specify other place":"يرجى تحديد المكان الآخر")+" ",1),V.value?(U(),j("span",lO,"*")):pe("",!0)]),ee(d("input",{type:"text","onUpdate:modelValue":Y[11]||(Y[11]=fe=>p.value.otherScanPlaceDescription=fe),required:V.value},null,8,cO),[[me,p.value.otherScanPlaceDescription]])])):pe("",!0),d("div",uO,[d("div",dO,[d("label",null,[at(_(y(i)==="en"?"Scan Category":"فئة الفحص")+" ",1),V.value?(U(),j("span",hO,"*")):pe("",!0)]),ee(d("select",{"onUpdate:modelValue":Y[12]||(Y[12]=fe=>p.value.scanType=fe),required:V.value},[d("option",pO,_(y(i)==="en"?"CT Scan":"الأشعة المقطعية"),1),d("option",mO,_(y(i)==="en"?"X-ray":"الأشعة السينية"),1)],8,fO),[[lt,p.value.scanType]])]),d("div",gO,[d("label",null,[at(_(y(i)==="en"?"Scan Protocol":"بروتوكول الفحص")+" ",1),V.value?(U(),j("span",yO,"*")):pe("",!0)]),ee(d("select",{"onUpdate:modelValue":Y[13]||(Y[13]=fe=>p.value.subScanType=fe),required:V.value},[d("option",_O,_(y(i)==="en"?"Select...":"اختر..."),1),(U(!0),j(Xe,null,Jt(F.value,fe=>(U(),j("option",{key:fe.value,value:fe.value},_(y(i)==="en"?fe.en:fe.ar),9,bO))),128))],8,vO),[[lt,p.value.subScanType]])])]),X.value?(U(),j("div",wO,[d("label",null,[at(_(y(i)==="en"?"Please specify scan protocol":"يرجى تحديد بروتوكول الفحص")+" ",1),V.value?(U(),j("span",EO,"*")):pe("",!0)]),ee(d("input",{type:"text","onUpdate:modelValue":Y[14]||(Y[14]=fe=>p.value.otherScanDescription=fe),required:V.value},null,8,TO),[[me,p.value.otherScanDescription]])])):pe("",!0),d("button",{type:"submit",disabled:v.value,class:"action-button"},_(v.value?y(i)==="en"?"Getting Advice...":"جاري الحصول على النصيحة...":y(i)==="en"?"Get Advice":"الحصول على نصيحة"),9,IO)],32),k.value?(U(),j("div",SO,_(k.value),1)):pe("",!0),E.value?(U(),j("div",AO,[E.value.Warning?(U(),j("div",PO,[d("h4",null,_(y(i)==="en"?"Important Note":"ملاحظة هامة"),1),d("p",CO,_(E.value.Warning),1)])):pe("",!0),d("div",RO,[E.value.patientCalculatedMsv!==null?(U(),j("div",DO,[d("div",kO,[d("h4",null,_(w.value),1),d("p",null,[d("strong",null,_(E.value.patientCalculatedMsv)+" mSv",1)])]),C.value?(U(),j("div",OO,[d("h4",null,_(T.value),1),d("p",null,[d("strong",null,_(E.value.doctorOccupationalMsv.toFixed(5))+" mSv",1)])])):pe("",!0)])):pe("",!0),d("div",xO,[d("h4",null,_(y(i)==="en"?"AI-Powered Advice":"نصيحة مدعومة بالذكاء الاصطناعي"),1),d("p",NO,_(E.value.recommendationText),1)])]),E.value.patientCalculatedMsv!==null?(U(),j("div",VO,[d("button",{onClick:ce,disabled:D.value,class:"action-button save-button"},_(D.value?y(i)==="en"?"Saving...":"...جاري الحفظ":y(i)==="en"?"Save as Scan Record":"حفظ كسجل فحص"),9,MO),d("p",LO,_(y(i)==="en"?"This will create a new scan record with the estimated doses.":"سيؤدي هذا إلى إنشاء سجل فحص جديد بالجرعات المقدرة."),1)])):pe("",!0)])):pe("",!0),d("p",$O,[d("a",{href:"#",onClick:Y[15]||(Y[15]=tt(fe=>y(e).push("/dashboard"),["prevent"]))},_(y(i)==="en"?"Back to Dashboard":"العودة إلى لوحة التحكم"),1)])])])],8,Dk))}},UO=vt(FO,[["__scopeId","data-v-7af1ecf9"]]);/*!
...
Always provide the output in clear, human-friendly language and reference international safety standards (ICRP 103, IAEA GSR Part 3, WHO 2016).
`,P=$?h.value?i.value.otherScanDescription:i.value.subScanType:"N/A",w=$?m.value?i.value.otherScanPlaceDescription:i.value.scanPlace:"N/A",T=$?`${i.value.scanType} of the ${w}, protocol: "${P}"`:"Not specified",C=`
    ${X}
    ...
    **GENERATE RECOMMENDATION BASED ON THE FOLLOWING DATA. YOU ARE ADDRESSING A PATIENT.**
    ...
    - **User type:** Patient
    - **Examination type:** ${T}
    - **Number of scans:** ${i.value.numberOfScans}
    - **Exposure time:** "Not provided"
    - **Patient parameters:** "age: ${new Date().getFullYear()-new Date(i.value.birthDate).getFullYear()}, sex: ${i.value.gender}, pregnancy status: ${i.value.isPregnant?`Yes, due around ${i.value.estimatedDueDate}`:"No"}, body thickness: ${i.value.weight?`${i.value.weight}kg`:"Not provided"}"
    - **Distance from source:** "Not provided"
    - **Shielding availability:** "Not provided"
    - **Estimated dose (mSv) for this scan:** ${V!==null?V.toFixed(3):"N/A"}
    - **Patient Cumulative Dose (This Year, including this scan):** ${I.value!==null?I.value.toFixed(3):"N/A"}
    - **Reason / Symptoms / Medical History:** "${i.value.currentSymptoms||"Not provided"}. History: ${i.value.medicalHistory||"None"}"
    - **Language for response:** ${F==="en"?"English":"Arabic"}
