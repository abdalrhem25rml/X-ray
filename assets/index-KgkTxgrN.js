...
*/var Br,Cv;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(A,w){function T(){}T.prototype=w.prototype,A.D=w.prototype,A.prototype=new T,A.prototype.constructor=A,A.C=function(P,O,R){for(var S=Array(arguments.length-2),xe=2;xe<arguments.length;xe++)S[xe-2]=arguments[xe];return w.prototype[O].apply(P,S)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(A,w,T){T||(T=0);var P=Array(16);if(typeof w=="string")for(var O=0;16>O;++O)P[O]=w.charCodeAt(T++)|w.charCodeAt(T++)<<8|w.charCodeAt(T++)<<16|w.charCodeAt(T++)<<24;else for(O=0;16>O;++O)P[O]=w[T++]|w[T++]<<8|w[T++]<<16|w[T++]<<24;w=A.g[0],T=A.g[1],O=A.g[2];var R=A.g[3],S=w+(R^T&(O^R))+P[0]+3614090360&4294967295;w=T+(S<<7&4294967295|S>>>25),S=R+(O^w&(T^O))+P[1]+3905402710&4294967295,R=w+(S<<12&4294967295|S>>>20),S=O+(T^R&(w^T))+P[2]+606105819&4294967295,O=R+(S<<17&4294967295|S>>>15),S=T+(w^O&(R^w))+P[3]+3250441966&4294967295,T=O+(S<<22&4294967295|S>>>10),S=w+(R^T&(O^R))+P[4]+4118548399&4294967295,w=T+(S<<7&4294967295|S>>>25),S=R+(O^w&(T^O))+P[5]+1200080426&4294967295,R=w+(S<<12&4294967295|S>>>20),S=O+(T^R&(w^T))+P[6]+2821735955&4294967295,O=R+(S<<17&4294967295|S>>>15),S=T+(w^O&(R^w))+P[7]+4249261313&4294967295,T=O+(S<<22&4294967295|S>>>10),S=w+(R^T&(O^R))+P[8]+1770035416&4294967295,w=T+(S<<7&4294967295|S>>>25),S=R+(O^w&(T^O))+P[9]+2336552879&4294967295,R=w+(S<<12&4294967295|S>>>20),S=O+(T^R&(w^T))+P[10]+4294925233&4294967295,O=R+(S<<17&4294967295|S>>>15),S=T+(w^O&(R^w))+P[11]+2304563134&4294967295,T=O+(S<<22&4294967295|S>>>10),S=w+(R^T&(O^R))+P[12]+1804603682&4294967295,w=T+(S<<7&4294967295|S>>>25),S=R+(O^w&(T^O))+P[13]+4254626195&4294967295,R=w+(S<<12&4294967295|S>>>20),S=O+(T^R&(w^T))+P[14]+2792965006&4294967295,O=R+(S<<17&4294967295|S>>>15),S=T+(w^O&(R^w))+P[15]+1236535329&4294967295,T=O+(S<<22&4294967295|S>>>10),S=w+(O^R&(T^O))+P[1]+4129170786&4294967295,w=T+(S<<5&4294967295|S>>>27),S=R+(T^O&(w^T))+P[6]+3225465664&4294967295,R=w+(S<<9&4294967295|S>>>23),S=O+(w^T&(R^w))+P[11]+643717713&4294967295,O=R+(S<<14&4294967295|S>>>18),S=T+(R^w&(O^R))+P[0]+3921069994&4294967295,T=O+(S<<20&4294967295|S>>>12),S=w+(O^R&(T^O))+P[5]+3593408605&4294967295,w=T+(S<<5&4294967295|S>>>27),S=R+(T^O&(w^T))+P[10]+38016083&4294967295,R=w+(S<<9&4294967295|S>>>23),S=O+(w^T&(R^w))+P[15]+3634488961&4294967295,O=R+(S<<14&4294967295|S>>>18),S=T+(R^w&(O^R))+P[4]+3889429448&4294967295,T=O+(S<<20&4294967295|S>>>12),S=w+(O^R&(T^O))+P[9]+568446438&4294967295,w=T+(S<<5&4294967295|S>>>27),S=R+(T^O&(w^T))+P[14]+3275163606&4294967295,R=w+(S<<9&4294967295|S>>>23),S=O+(w^T&(R^w))+P[3]+4107603335&4294967295,O=R+(S<<14&4294967295|S>>>18),S=T+(R^w&(O^R))+P[8]+1163531501&4294967295,T=O+(S<<20&4294967295|S>>>12),S=w+(O^R&(T^O))+P[13]+2850285829&4294967295,w=T+(S<<5&4294967295|S>>>27),S=R+(T^O&(w^T))+P[2]+4243563512&4294967295,R=w+(S<<9&4294967295|S>>>23),S=O+(w^T&(R^w))+P[7]+1735328473&4294967295,O=R+(S<<14&4294967295|S>>>18),S=T+(R^w&(O^R))+P[12]+2368359562&4294967295,T=O+(S<<20&4294967295|S>>>12),S=w+(T^O^R)+P[5]+4294588738&4294967295,w=T+(S<<4&4294967295|S>>>28),S=R+(w^T^O)+P[8]+2272392833&4294967295,R=w+(S<<11&4294967295|S>>>21),S=O+(R^w^T)+P[11]+1839030562&4294967295,O=R+(S<<16&4294967295|S>>>16),S=T+(O^R^w)+P[14]+4259657740&4294967295,T=O+(S<<23&4294967295|S>>>9),S=w+(T^O^R)+P[1]+2763975236&4294967295,w=T+(S<<4&4294967295|S>>>28),S=R+(w^T^O)+P[4]+1272893353&4294967295,R=w+(S<<11&4294967295|S>>>21),S=O+(R^w^T)+P[7]+4139469664&4294967295,O=R+(S<<16&4294967295|S>>>16),S=T+(O^R^w)+P[10]+3200236656&4294967295,T=O+(S<<23&4294967295|S>>>9),S=w+(T^O^R)+P[13]+681279174&4294967295,w=T+(S<<4&4294967295|S>>>28),S=R+(w^T^O)+P[0]+3936430074&4294967295,R=w+(S<<11&4294967295|S>>>21),S=O+(R^w^T)+P[3]+3572445317&4294967295,O=R+(S<<16&4294967295|S>>>16),S=T+(O^R^w)+P[6]+76029189&4294967295,T=O+(S<<23&4294967295|S>>>9),S=w+(T^O^R)+P[9]+3654602809&4294967295,w=T+(S<<4&4294967295|S>>>28),S=R+(w^T^O)+P[12]+3873151461&4294967295,R=w+(S<<11&4294967295|S>>>21),S=O+(R^w^T)+P[15]+530742520&4294967295,O=R+(S<<16&4294967295|S>>>16),S=T+(O^R^w)+P[2]+3299628645&4294967295,T=O+(S<<23&4294967295|S>>>9),S=w+(O^(T|~R))+P[0]+4096336452&4294967295,w=T+(S<<6&4294967295|S>>>26),S=R+(T^(w|~O))+P[7]+1126891415&4294967295,R=w+(S<<10&4294967295|S>>>22),S=O+(w^(R|~T))+P[14]+2878612391&4294967295,O=R+(S<<15&4294967295|S>>>17),S=T+(R^(O|~w))+P[5]+4237533241&4294967295,T=O+(S<<21&4294967295|S>>>11),S=w+(O^(T|~R))+P[12]+1700485571&4294967295,w=T+(S<<6&4294967295|S>>>26),S=R+(T^(w|~O))+P[3]+2399980690&4294967295,R=w+(S<<10&4294967295|S>>>22),S=O+(w^(R|~T))+P[10]+4293915773&4294967295,O=R+(S<<15&4294967295|S>>>17),S=T+(R^(O|~w))+P[1]+2240044497&4294967295,T=O+(S<<21&4294967295|S>>>11),S=w+(O^(T|~R))+P[8]+1873313359&4294967295,w=T+(S<<6&4294967295|S>>>26),S=R+(T^(w|~O))+P[15]+4264355552&4294967295,R=w+(S<<10&4294967295|S>>>22),S=O+(w^(R|~T))+P[6]+2734768916&4294967295,O=R+(S<<15&4294967295|S>>>17),S=T+(R^(O|~w))+P[13]+1309151649&4294967295,T=O+(S<<21&4294967295|S>>>11),S=w+(O^(T|~R))+P[4]+4149444226&4294967295,w=T+(S<<6&4294967295|S>>>26),S=R+(T^(w|~O))+P[11]+3174756917&4294967295,R=w+(S<<10&4294967295|S>>>22),S=O+(w^(R|~T))+P[2]+718787259&4294967295,O=R+(S<<15&4294967295|S>>>17),S=T+(R^(O|~w))+P[9]+3951481745&4294967295,A.g[0]=A.g[0]+w&4294967295,A.g[1]=A.g[1]+(O+(S<<21&4294967295|S>>>11))&4294967295,A.g[2]=A.g[2]+O&4294967295,A.g[3]=A.g[3]+R&4294967295}r.prototype.u=function(A,w){w===void 0&&(w=A.length);for(var T=w-this.blockSize,P=this.B,O=this.h,R=0;R<w;){if(O==0)for(;R<=T;)s(this,A,R),R+=this.blockSize;if(typeof A=="string"){for(;R<w;)if(P[O++]=A.charCodeAt(R++),O==this.blockSize){s(this,P),O=0;break}}else for(;R<w;)if(P[O++]=A[R++],O==this.blockSize){s(this,P),O=0;break}}this.h=O,this.o+=w},r.prototype.v=function(){var A=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);A[0]=128;for(var w=1;w<A.length-8;++w)A[w]=0;var T=8*this.o;for(w=A.length-8;w<A.length;++w)A[w]=T&255,T/=256;for(this.u(A),A=Array(16),w=T=0;4>w;++w)for(var P=0;32>P;P+=8)A[T++]=this.g[w]>>>P&255;return A};function i(A,w){var T=l;return Object.prototype.hasOwnProperty.call(T,A)?T[A]:T[A]=w(A)}function o(A,w){this.h=w;for(var T=[],P=!0,O=A.length-1;0<=O;O--){var R=A[O]|0;P&&R==w||(T[O]=R,P=!1)}this.g=T}var l={};function u(A){return-128<=A&&128>A?i(A,function(w){return new o([w|0],0>w?-1:0)}):new o([A|0],0>A?-1:0)}function c(A){if(isNaN(A)||!isFinite(A))return f;if(0>A)return k(c(-A));for(var w=[],T=1,P=0;A>=T;P++)w[P]=A/T|0,T*=4294967296;return new o(w,0)}function h(A,w){if(A.length==0)throw Error("number format error: empty string");if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(A.charAt(0)=="-")return k(h(A.substring(1),w));if(0<=A.indexOf("-"))throw Error('number format error: interior "-" character');for(var T=c(Math.pow(w,8)),P=f,O=0;O<A.length;O+=8){var R=Math.min(8,A.length-O),S=parseInt(A.substring(O,O+R),w);8>R?(R=c(Math.pow(w,R)),P=P.j(R).add(c(S))):(P=P.j(T),P=P.add(c(S)))}return P}var f=u(0),g=u(1),_=u(16777216);t=o.prototype,t.m=function(){if(N(this))return-k(this).m();for(var A=0,w=1,T=0;T<this.g.length;T++){var P=this.i(T);A+=(0<=P?P:4294967296+P)*w,w*=4294967296}return A},t.toString=function(A){if(A=A||10,2>A||36<A)throw Error("radix out of range: "+A);if(x(this))return"0";if(N(this))return"-"+k(this).toString(A);for(var w=c(Math.pow(A,6)),T=this,P="";;){var O=F(T,w).g;T=E(T,O.j(w));var R=((0<T.g.length?T.g[0]:T.h)>>>0).toString(A);if(T=O,x(T))return R+P;for(;6>R.length;)R="0"+R;P=R+P}},t.i=function(A){return 0>A?0:A<this.g.length?this.g[A]:this.h};function x(A){if(A.h!=0)return!1;for(var w=0;w<A.g.length;w++)if(A.g[w]!=0)return!1;return!0}function N(A){return A.h==-1}t.l=function(A){return A=E(this,A),N(A)?-1:x(A)?0:1};function k(A){for(var w=A.g.length,T=[],P=0;P<w;P++)T[P]=~A.g[P];return new o(T,~A.h).add(g)}t.abs=function(){return N(this)?k(this):this},t.add=function(A){for(var w=Math.max(this.g.length,A.g.length),T=[],P=0,O=0;O<=w;O++){var R=P+(this.i(O)&65535)+(A.i(O)&65535),S=(R>>>16)+(this.i(O)>>>16)+(A.i(O)>>>16);P=S>>>16,R&=65535,S&=65535,T[O]=S<<16|R}return new o(T,T[T.length-1]&-2147483648?-1:0)};function E(A,w){return A.add(k(w))}t.j=function(A){if(x(this)||x(A))return f;if(N(this))return N(A)?k(this).j(k(A)):k(k(this).j(A));if(N(A))return k(this.j(k(A)));if(0>this.l(_)&&0>A.l(_))return c(this.m()*A.m());for(var w=this.g.length+A.g.length,T=[],P=0;P<2*w;P++)T[P]=0;for(P=0;P<this.g.length;P++)for(var O=0;O<A.g.length;O++){var R=this.i(P)>>>16,S=this.i(P)&65535,xe=A.i(O)>>>16,oe=A.i(O)&65535;T[2*P+2*O]+=S*oe,b(T,2*P+2*O),T[2*P+2*O+1]+=R*oe,b(T,2*P+2*O+1),T[2*P+2*O+1]+=S*xe,b(T,2*P+2*O+1),T[2*P+2*O+2]+=R*xe,b(T,2*P+2*O+2)}for(P=0;P<w;P++)T[P]=T[2*P+1]<<16|T[2*P];for(P=w;P<2*w;P++)T[P]=0;return new o(T,0)};function b(A,w){for(;(A[w]&65535)!=A[w];)A[w+1]+=A[w]>>>16,A[w]&=65535,w++}function M(A,w){this.g=A,this.h=w}function F(A,w){if(x(w))throw Error("division by zero");if(x(A))return new M(f,f);if(N(A))return w=F(k(A),w),new M(k(w.g),k(w.h));if(N(w))return w=F(A,k(w)),new M(k(w.g),w.h);if(30<A.g.length){if(N(A)||N(w))throw Error("slowDivide_ only works with positive integers.");for(var T=g,P=w;0>=P.l(A);)T=j(T),P=j(P);var O=G(T,1),R=G(P,1);for(P=G(P,2),T=G(T,2);!x(P);){var S=R.add(P);0>=S.l(A)&&(O=O.add(T),R=S),P=G(P,1),T=G(T,1)}return w=E(A,O.j(w)),new M(O,w)}for(O=f;0<=A.l(w);){for(T=Math.max(1,Math.floor(A.m()/w.m())),P=Math.ceil(Math.log(T)/Math.LN2),P=48>=P?1:Math.pow(2,P-48),R=c(T),S=R.j(w);N(S)||0<S.l(A);)T-=P,R=c(T),S=R.j(w);x(R)&&(R=g),O=O.add(R),A=E(A,S)}return new M(O,A)}t.A=function(A){return F(this,A).h},t.and=function(A){for(var w=Math.max(this.g.length,A.g.length),T=[],P=0;P<w;P++)T[P]=this.i(P)&A.i(P);return new o(T,this.h&A.h)},t.or=function(A){for(var w=Math.max(this.g.length,A.g.length),T=[],P=0;P<w;P++)T[P]=this.i(P)|A.i(P);return new o(T,this.h|A.h)},t.xor=function(A){for(var w=Math.max(this.g.length,A.g.length),T=[],P=0;P<w;P++)T[P]=this.i(P)^A.i(P);return new o(T,this.h^A.h)};function j(A){for(var w=A.g.length+1,T=[],P=0;P<w;P++)T[P]=A.i(P)<<1|A.i(P-1)>>>31;return new o(T,A.h)}function G(A,w){var T=w>>5;w%=32;for(var P=A.g.length-T,O=[],R=0;R<P;R++)O[R]=0<w?A.i(R+T)>>>w|A.i(R+T+1)<<32-w:A.i(R+T);return new o(O,A.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,Cv=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=h,Br=o}).apply(typeof Pm<"u"?Pm:typeof self<"u"?self:typeof window<"u"?window:{});var Oa=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
...
`)};function ji(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(ba.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function Cf(a){let d="";return G(a,function(m,v){d+=v,d+=":",d+=m,d+=`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pt(t,e){const n={typeString:t};return e&&(n.value=e),n}function ea(t,e){if(!Fv(t))throw new ie(q.INVALID_ARGUMENT,"JSON must be an object");let n;for(const r in e)if(e[r]){const s=e[r].typeString,i="value"in e[r]?{value:e[r].value}:void 0;if(!(r in t)){n=`JSON missing required field: '${r}'`;break}const o=t[r];if(s&&typeof o!==s){n=`JSON field '${r}' must be a ${s}.`;break}if(i!==void 0&&o!==i.value){n=`Expected '${r}' field to equal '${i.value}'`;break}}if(n)throw new ie(q.INVALID_ARGUMENT,n);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ai(t){if(t.code!==q.FAILED_PRECONDITION||t.message!==yC)throw t;ce("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y{constructor(e){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,e(n=>{this.isDone=!0,this.result=n,this.nextCallback&&this.nextCallback(n)},n=>{this.isDone=!0,this.error=n,this.catchCallback&&this.catchCallback(n)})}catch(e){return this.next(void 0,e)}next(e,n){return this.callbackAttached&&be(59440),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(n,this.error):this.wrapSuccess(e,this.result):new Y((r,s)=>{this.nextCallback=i=>{this.wrapSuccess(e,i).next(r,s)},this.catchCallback=i=>{this.wrapFailure(n,i).next(r,s)}})}toPromise(){return new Promise((e,n)=>{this.next(e,n)})}wrapUserFunction(e){try{const n=e();return n instanceof Y?n:Y.resolve(n)}catch(n){return Y.reject(n)}}wrapSuccess(e,n){return e?this.wrapUserFunction(()=>e(n)):Y.resolve(n)}wrapFailure(e,n){return e?this.wrapUserFunction(()=>e(n)):Y.reject(n)}static resolve(e){return new Y((n,r)=>{n(e)})}static reject(e){return new Y((n,r)=>{r(e)})}static waitFor(e){return new Y((n,r)=>{let s=0,i=0,o=!1;e.forEach(l=>{++s,l.next(()=>{++i,o&&i===s&&n()},u=>r(u))}),o=!0,i===s&&n()})}static or(e){let n=Y.resolve(!1);for(const r of e)n=n.next(s=>s?Y.resolve(s):r());return n}static forEach(e,n){const r=[];return e.forEach((s,i)=>{r.push(n.call(this,s,i))}),this.waitFor(r)}static mapArray(e,n){return new Y((r,s)=>{const i=e.length,o=new Array(i);let l=0;for(let u=0;u<i;u++){const c=u;n(e[c]).next(h=>{o[c]=h,++l,l===i&&r(o)},h=>s(h))}})}static doWhile(e,n){return new Y((r,s)=>{const i=()=>{e()===!0?n().next(()=>{i()},s):r()};i()})}}function vC(t){const e=t.match(/Android ([\d.]+)/i),n=e?e[1].split(".").slice(0,2).join("."):"-1";return Number(n)}function Pi(t){return t.name==="IndexedDbTransactionError"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class MR{constructor(e){this.serializer=e,this.Br=new Map,this.Lr=new Map}getBundleMetadata(e,n){return Y.resolve(this.Br.get(n))}saveBundleMetadata(e,n){return this.Br.set(n.id,function(s){return{id:s.id,version:s.version,createTime:Vn(s.createTime)}}(n)),Y.resolve()}getNamedQuery(e,n){return Y.resolve(this.Lr.get(n))}saveNamedQuery(e,n){return this.Lr.set(n.name,function(s){return{name:s.name,query:SR(s.bundledQuery),readTime:Vn(s.readTime)}}(n)),Y.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LR{constructor(){this.overlays=new it(ge.comparator),this.kr=new Map}getOverlay(e,n){return Y.resolve(this.overlays.get(n))}getOverlays(e,n){const r=_s();return Y.forEach(n,s=>this.getOverlay(e,s).next(i=>{i!==null&&r.set(s,i)})).next(()=>r)}saveOverlays(e,n,r){return r.forEach((s,i)=>{this.wt(e,n,i)}),Y.resolve()}removeOverlaysForBatchId(e,n,r){const s=this.kr.get(r);return s!==void 0&&(s.forEach(i=>this.overlays=this.overlays.remove(i)),this.kr.delete(r)),Y.resolve()}getOverlaysForCollection(e,n,r){const s=_s(),i=n.length+1,o=new ge(n.child("")),l=this.overlays.getIteratorFrom(o);for(;l.hasNext();){const u=l.getNext().value,c=u.getKey();if(!n.isPrefixOf(c.path))break;c.path.length===i&&u.largestBatchId>r&&s.set(u.getKey(),u)}return Y.resolve(s)}getOverlaysForCollectionGroup(e,n,r,s){let i=new it((c,h)=>c-h);const o=this.overlays.getIterator();for(;o.hasNext();){const c=o.getNext().value;if(c.getKey().getCollectionGroup()===n&&c.largestBatchId>r){let h=i.get(c.largestBatchId);h===null&&(h=_s(),i=i.insert(c.largestBatchId,h)),h.set(c.getKey(),c)}}const l=_s(),u=i.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach((c,h)=>l.set(c,h)),!(l.size()>=s)););return Y.resolve(l)}wt(e,n,r){const s=this.overlays.get(r.key);if(s!==null){const o=this.kr.get(s.largestBatchId).delete(r.key);this.kr.set(s.largestBatchId,o)}this.overlays=this.overlays.insert(r.key,new nR(n,r));let i=this.kr.get(n);i===void 0&&(i=Ve(),this.kr.set(n,i)),this.kr.set(n,i.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class FR{constructor(){this.sessionToken=kt.EMPTY_BYTE_STRING}getSessionToken(e){return Y.resolve(this.sessionToken)}setSessionToken(e,n){return this.sessionToken=n,Y.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $R{constructor(e,n){this.indexManager=e,this.referenceDelegate=n,this.mutationQueue=[],this.er=1,this.Yr=new gt(yt.Qr)}checkEmpty(e){return Y.resolve(this.mutationQueue.length===0)}addMutationBatch(e,n,r,s){const i=this.er;this.er++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new tR(i,n,r,s);this.mutationQueue.push(o);for(const l of s)this.Yr=this.Yr.add(new yt(l.key,i)),this.indexManager.addToCollectionParentIndex(e,l.key.path.popLast());return Y.resolve(o)}lookupMutationBatch(e,n){return Y.resolve(this.Zr(n))}getNextMutationBatchAfterBatchId(e,n){const r=n+1,s=this.Xr(r),i=s<0?0:s;return Y.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return Y.resolve(this.mutationQueue.length===0?dd:this.er-1)}getAllMutationBatches(e){return Y.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,n){const r=new yt(n,0),s=new yt(n,Number.POSITIVE_INFINITY),i=[];return this.Yr.forEachInRange([r,s],o=>{const l=this.Zr(o.Hr);i.push(l)}),Y.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,n){let r=new gt(Oe);return n.forEach(s=>{const i=new yt(s,0),o=new yt(s,Number.POSITIVE_INFINITY);this.Yr.forEachInRange([i,o],l=>{r=r.add(l.Hr)})}),Y.resolve(this.ei(r))}getAllMutationBatchesAffectingQuery(e,n){const r=n.path,s=r.length+1;let i=r;ge.isDocumentKey(i)||(i=i.child(""));const o=new yt(new ge(i),0);let l=new gt(Oe);return this.Yr.forEachWhile(u=>{const c=u.key.path;return!!r.isPrefixOf(c)&&(c.length===s&&(l=l.add(u.Hr)),!0)},o),Y.resolve(this.ei(l))}ei(e){const n=[];return e.forEach(r=>{const s=this.Zr(r);s!==null&&n.push(s)}),n}removeMutationBatch(e,n){He(this.ti(n.batchId,"removed")===0,55003),this.mutationQueue.shift();let r=this.Yr;return Y.forEach(n.mutations,s=>{const i=new yt(s.key,n.batchId);return r=r.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,s.key)}).next(()=>{this.Yr=r})}rr(e){}containsKey(e,n){const r=new yt(n,0),s=this.Yr.firstAfterOrEqual(r);return Y.resolve(n.isEqual(s&&s.key))}performConsistencyCheck(e){return this.mutationQueue.length,Y.resolve()}ti(e,n){return this.Xr(e)}Xr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Zr(e){const n=this.Xr(e);return n<0||n>=this.mutationQueue.length?null:this.mutationQueue[n]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zR{constructor(){this.As=!1,this.Rs=!1,this.Vs=100,this.fs=function(){return _I()?8:vC(Ut())>0?6:4}()}initialize(e,n){this.gs=e,this.indexManager=n,this.As=!0}getDocumentsMatchingQuery(e,n,r,s){const i={result:null};return this.ps(e,n).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.ys(e,n,s,r).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new HR;return this.ws(e,n,o).next(l=>{if(i.result=l,this.Rs)return this.Ss(e,n,o,l.size)})}).next(()=>i.result)}Ss(e,n,r,s){return r.documentReadCount<this.Vs?(Ks()<=Ne.DEBUG&&ce("QueryEngine","SDK will not create cache indexes for query:",Ys(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),Y.resolve()):(Ks()<=Ne.DEBUG&&ce("QueryEngine","Query:",Ys(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.fs*s?(Ks()<=Ne.DEBUG&&ce("QueryEngine","The SDK decides to create cache indexes for query:",Ys(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Nn(n))):Y.resolve())}ps(e,n){if(Km(n))return Y.resolve(null);let r=Nn(n);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(n.limit!==null&&s===1&&(n=Ju(n,null,"F"),r=Nn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const o=Ve(...i);return this.gs.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const c=this.bs(n,l);return this.Ds(n,c,o,u.readTime)?this.ps(e,Ju(n,null,"F")):this.vs(e,c,n,u)}))})))}ys(e,n,r,s){return Km(n)||s.isEqual(Se.min())?Y.resolve(null):this.gs.getDocuments(e,r).next(i=>{const o=this.bs(n,i);return this.Ds(n,o,r,s)?Y.resolve(null):(Ks()<=Ne.DEBUG&&ce("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Ys(n)),this.vs(e,o,n,pC(s,Vo)).next(l=>l))})}bs(e,n){let r=new gt(r1(e));return n.forEach((s,i)=>{cc(e,i)&&(r=r.add(i))}),r}Ds(e,n,r,s){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}ws(e,n,r){return Ks()<=Ne.DEBUG&&ce("QueryEngine","Using full collection scan to execute query:",Ys(n)),this.gs.getDocumentsMatchingQuery(e,n,Gr.min(),r)}vs(e,n,r,s){return this.gs.getDocumentsMatchingQuery(e,r,s).next(i=>(n.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vt="WebChannelConnection";class oD extends sD{constructor(e){super(e),this.u_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}jo(e,n,r,s,i){const o=sh();return new Promise((l,u)=>{const c=new Rv;c.setWithCredentials(!0),c.listenOnce(Dv.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case Xa.NO_ERROR:const f=c.getResponseJson();ce(Vt,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(f)),l(f);break;case Xa.TIMEOUT:ce(Vt,`RPC '${e}' ${o} timed out`),u(new ie(q.DEADLINE_EXCEEDED,"Request time out"));break;case Xa.HTTP_ERROR:const g=c.getStatus();if(ce(Vt,`RPC '${e}' ${o} failed with status:`,g,"response text:",c.getResponseText()),g>0){let _=c.getResponseJson();Array.isArray(_)&&(_=_[0]);const x=_?.error;if(x&&x.status&&x.message){const N=function(E){const b=E.toLowerCase().replace(/_/g,"-");return Object.values(q).indexOf(b)>=0?b:q.UNKNOWN}(x.status);u(new ie(N,x.message))}else u(new ie(q.UNKNOWN,"Server responded with status "+c.getStatus()))}else u(new ie(q.UNAVAILABLE,"Connection failed."));break;default:be(9055,{c_:e,streamId:o,l_:c.getLastErrorCode(),h_:c.getLastError()})}}finally{ce(Vt,`RPC '${e}' ${o} completed.`)}});const h=JSON.stringify(s);ce(Vt,`RPC '${e}' ${o} sending request:`,s),c.send(n,"POST",h,r,15)})}P_(e,n,r){const s=sh(),i=[this.$o,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=xv(),l=Ov(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;c!==void 0&&(u.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(u.useFetchStreams=!0),this.zo(u.initMessageHeaders,n,r),u.encodeInitMessageHeaders=!0;const h=i.join("");ce(Vt,`Creating RPC '${e}' stream ${s}: ${h}`,u);const f=o.createWebChannel(h,u);this.T_(f);let g=!1,_=!1;const x=new iD({Ho:k=>{_?ce(Vt,`Not sending because RPC '${e}' stream ${s} is closed:`,k):(g||(ce(Vt,`Opening RPC '${e}' stream ${s} transport.`),f.open(),g=!0),ce(Vt,`RPC '${e}' stream ${s} sending:`,k),f.send(k))},Yo:()=>f.close()}),N=(k,E,b)=>{k.listen(E,M=>{try{b(M)}catch(F){setTimeout(()=>{throw F},0)}})};return N(f,Ji.EventType.OPEN,()=>{_||(ce(Vt,`RPC '${e}' stream ${s} transport opened.`),x.s_())}),N(f,Ji.EventType.CLOSE,()=>{_||(_=!0,ce(Vt,`RPC '${e}' stream ${s} transport closed`),x.__(),this.I_(f))}),N(f,Ji.EventType.ERROR,k=>{_||(_=!0,Wr(Vt,`RPC '${e}' stream ${s} transport errored. Name:`,k.name,"Message:",k.message),x.__(new ie(q.UNAVAILABLE,"The operation could not be completed")))}),N(f,Ji.EventType.MESSAGE,k=>{var E;if(!_){const b=k.data[0];He(!!b,16349);const M=b,F=M?.error||((E=M[0])===null||E===void 0?void 0:E.error);if(F){ce(Vt,`RPC '${e}' stream ${s} received error:`,F);const j=F.status;let G=function(T){const P=dt[T];if(P!==void 0)return p1(P)}(j),A=F.message;G===void 0&&(G=q.INTERNAL,A="Unknown error status: "+j+" with message "+F.message),_=!0,x.__(new ie(G,A)),f.close()}else ce(Vt,`RPC '${e}' stream ${s} received:`,b),x.a_(b)}}),N(l,kv.STAT_EVENT,k=>{k.stat===zu.PROXY?ce(Vt,`RPC '${e}' stream ${s} detected buffering proxy`):k.stat===zu.NOPROXY&&ce(Vt,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{x.o_()},0),x}terminate(){this.u_.forEach(e=>e.close()),this.u_=[]}T_(e){this.u_.push(e)}I_(e){this.u_=this.u_.filter(n=>n===e)}}function du(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dn{constructor(e){this._byteString=e}static fromBase64String(e){try{return new dn(kt.fromBase64String(e))}catch(n){throw new ie(q.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new dn(kt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:dn._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(ea(e,dn._jsonSchema))return dn.fromBase64String(e.bytes)}}dn._jsonSchemaVersion="firestore/bytes/1.0",dn._jsonSchema={type:pt("string",dn._jsonSchemaVersion),bytes:pt("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mn{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new ie(q.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new ie(q.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Oe(this._lat,e._lat)||Oe(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Mn._jsonSchemaVersion}}static fromJSON(e){if(ea(e,Mn._jsonSchema))return new Mn(e.latitude,e.longitude)}}Mn._jsonSchemaVersion="firestore/geoPoint/1.0",Mn._jsonSchema={type:pt("string",Mn._jsonSchemaVersion),latitude:pt("number"),longitude:pt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ln{constructor(e){this._values=(e||[]).map(n=>n)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(r,s){if(r.length!==s.length)return!1;for(let i=0;i<r.length;++i)if(r[i]!==s[i])return!1;return!0}(this._values,e._values)}toJSON(){return{type:Ln._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(ea(e,Ln._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(n=>typeof n=="number"))return new Ln(e.vectorValues);throw new ie(q.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Ln._jsonSchemaVersion="firestore/vectorValue/1.0",Ln._jsonSchema={type:pt("string",Ln._jsonSchemaVersion),vectorValues:pt("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
