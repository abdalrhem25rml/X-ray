 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OA="firebase-heartbeat-database",xA=1,Oo="firebase-heartbeat-store";let iu=null;function Q_(){return iu||(iu=QI(OA,xA,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Oo)}catch(n){console.warn(n)}}}}).catch(t=>{throw Br.create("idb-open",{originalErrorMessage:t.message})})),iu}async function NA(t){try{const n=(await Q_()).transaction(Oo),r=await n.objectStore(Oo).get(J_(t));return await n.done,r}catch(e){if(e instanceof pr)ir.warn(e.message);else{const n=Br.create("idb-get",{originalErrorMessage:e?.message});ir.warn(n.message)}}}async function lm(t,e){try{const r=(await Q_()).transaction(Oo,"readwrite");await r.objectStore(Oo).put(e,J_(t)),await r.done}catch(n){if(n instanceof pr)ir.warn(n.message);else{const r=Br.create("idb-set",{originalErrorMessage:n?.message});ir.warn(r.message)}}}function J_(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nr extends Jo{constructor(){super("facebook.com")}static credential(e){return Ss._fromParams({providerId:Nr.PROVIDER_ID,signInMethod:Nr.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Nr.credentialFromTaggedObject(e)}static credentialFromError(e){return Nr.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Nr.credential(e.oauthAccessToken)}catch{return null}}}Nr.FACEBOOK_SIGN_IN_METHOD="facebook.com";Nr.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Hr,kv;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(S,v){function w(){}w.prototype=v.prototype,S.D=v.prototype,S.prototype=new w,S.prototype.constructor=S,S.C=function(b,T,I){for(var A=Array(arguments.length-2),De=2;De<arguments.length;De++)A[De-2]=arguments[De];return v.prototype[T].apply(b,A)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(S,v,w){w||(w=0);var b=Array(16);if(typeof v=="string")for(var T=0;16>T;++T)b[T]=v.charCodeAt(w++)|v.charCodeAt(w++)<<8|v.charCodeAt(w++)<<16|v.charCodeAt(w++)<<24;else for(T=0;16>T;++T)b[T]=v[w++]|v[w++]<<8|v[w++]<<16|v[w++]<<24;v=S.g[0],w=S.g[1],T=S.g[2];var I=S.g[3],A=v+(I^w&(T^I))+b[0]+3614090360&4294967295;v=w+(A<<7&4294967295|A>>>25),A=I+(T^v&(w^T))+b[1]+3905402710&4294967295,I=v+(A<<12&4294967295|A>>>20),A=T+(w^I&(v^w))+b[2]+606105819&4294967295,T=I+(A<<17&4294967295|A>>>15),A=w+(v^T&(I^v))+b[3]+3250441966&4294967295,w=T+(A<<22&4294967295|A>>>10),A=v+(I^w&(T^I))+b[4]+4118548399&4294967295,v=w+(A<<7&4294967295|A>>>25),A=I+(T^v&(w^T))+b[5]+1200080426&4294967295,I=v+(A<<12&4294967295|A>>>20),A=T+(w^I&(v^w))+b[6]+2821735955&4294967295,T=I+(A<<17&4294967295|A>>>15),A=w+(v^T&(I^v))+b[7]+4249261313&4294967295,w=T+(A<<22&4294967295|A>>>10),A=v+(I^w&(T^I))+b[8]+1770035416&4294967295,v=w+(A<<7&4294967295|A>>>25),A=I+(T^v&(w^T))+b[9]+2336552879&4294967295,I=v+(A<<12&4294967295|A>>>20),A=T+(w^I&(v^w))+b[10]+4294925233&4294967295,T=I+(A<<17&4294967295|A>>>15),A=w+(v^T&(I^v))+b[11]+2304563134&4294967295,w=T+(A<<22&4294967295|A>>>10),A=v+(I^w&(T^I))+b[12]+1804603682&4294967295,v=w+(A<<7&4294967295|A>>>25),A=I+(T^v&(w^T))+b[13]+4254626195&4294967295,I=v+(A<<12&4294967295|A>>>20),A=T+(w^I&(v^w))+b[14]+2792965006&4294967295,T=I+(A<<17&4294967295|A>>>15),A=w+(v^T&(I^v))+b[15]+1236535329&4294967295,w=T+(A<<22&4294967295|A>>>10),A=v+(T^I&(w^T))+b[1]+4129170786&4294967295,v=w+(A<<5&4294967295|A>>>27),A=I+(w^T&(v^w))+b[6]+3225465664&4294967295,I=v+(A<<9&4294967295|A>>>23),A=T+(v^w&(I^v))+b[11]+643717713&4294967295,T=I+(A<<14&4294967295|A>>>18),A=w+(I^v&(T^I))+b[0]+3921069994&4294967295,w=T+(A<<20&4294967295|A>>>12),A=v+(T^I&(w^T))+b[5]+3593408605&4294967295,v=w+(A<<5&4294967295|A>>>27),A=I+(w^T&(v^w))+b[10]+38016083&4294967295,I=v+(A<<9&4294967295|A>>>23),A=T+(v^w&(I^v))+b[15]+3634488961&4294967295,T=I+(A<<14&4294967295|A>>>18),A=w+(I^v&(T^I))+b[4]+3889429448&4294967295,w=T+(A<<20&4294967295|A>>>12),A=v+(T^I&(w^T))+b[9]+568446438&4294967295,v=w+(A<<5&4294967295|A>>>27),A=I+(w^T&(v^w))+b[14]+3275163606&4294967295,I=v+(A<<9&4294967295|A>>>23),A=T+(v^w&(I^v))+b[3]+4107603335&4294967295,T=I+(A<<14&4294967295|A>>>18),A=w+(I^v&(T^I))+b[8]+1163531501&4294967295,w=T+(A<<20&4294967295|A>>>12),A=v+(T^I&(w^T))+b[13]+2850285829&4294967295,v=w+(A<<5&4294967295|A>>>27),A=I+(w^T&(v^w))+b[2]+4243563512&4294967295,I=v+(A<<9&4294967295|A>>>23),A=T+(v^w&(I^v))+b[7]+1735328473&4294967295,T=I+(A<<14&4294967295|A>>>18),A=w+(I^v&(T^I))+b[12]+2368359562&4294967295,w=T+(A<<20&4294967295|A>>>12),A=v+(w^T^I)+b[5]+4294588738&4294967295,v=w+(A<<4&4294967295|A>>>28),A=I+(v^w^T)+b[8]+2272392833&4294967295,I=v+(A<<11&4294967295|A>>>21),A=T+(I^v^w)+b[11]+1839030562&4294967295,T=I+(A<<16&4294967295|A>>>16),A=w+(T^I^v)+b[14]+4259657740&4294967295,w=T+(A<<23&4294967295|A>>>9),A=v+(w^T^I)+b[1]+2763975236&4294967295,v=w+(A<<4&4294967295|A>>>28),A=I+(v^w^T)+b[4]+1272893353&4294967295,I=v+(A<<11&4294967295|A>>>21),A=T+(I^v^w)+b[7]+4139469664&4294967295,T=I+(A<<16&4294967295|A>>>16),A=w+(T^I^v)+b[10]+3200236656&4294967295,w=T+(A<<23&4294967295|A>>>9),A=v+(w^T^I)+b[13]+681279174&4294967295,v=w+(A<<4&4294967295|A>>>28),A=I+(v^w^T)+b[0]+3936430074&4294967295,I=v+(A<<11&4294967295|A>>>21),A=T+(I^v^w)+b[3]+3572445317&4294967295,T=I+(A<<16&4294967295|A>>>16),A=w+(T^I^v)+b[6]+76029189&4294967295,w=T+(A<<23&4294967295|A>>>9),A=v+(w^T^I)+b[9]+3654602809&4294967295,v=w+(A<<4&4294967295|A>>>28),A=I+(v^w^T)+b[12]+3873151461&4294967295,I=v+(A<<11&4294967295|A>>>21),A=T+(I^v^w)+b[15]+530742520&4294967295,T=I+(A<<16&4294967295|A>>>16),A=w+(T^I^v)+b[2]+3299628645&4294967295,w=T+(A<<23&4294967295|A>>>9),A=v+(T^(w|~I))+b[0]+4096336452&4294967295,v=w+(A<<6&4294967295|A>>>26),A=I+(w^(v|~T))+b[7]+1126891415&4294967295,I=v+(A<<10&4294967295|A>>>22),A=T+(v^(I|~w))+b[14]+2878612391&4294967295,T=I+(A<<15&4294967295|A>>>17),A=w+(I^(T|~v))+b[5]+4237533241&4294967295,w=T+(A<<21&4294967295|A>>>11),A=v+(T^(w|~I))+b[12]+1700485571&4294967295,v=w+(A<<6&4294967295|A>>>26),A=I+(w^(v|~T))+b[3]+2399980690&4294967295,I=v+(A<<10&4294967295|A>>>22),A=T+(v^(I|~w))+b[10]+4293915773&4294967295,T=I+(A<<15&4294967295|A>>>17),A=w+(I^(T|~v))+b[1]+2240044497&4294967295,w=T+(A<<21&4294967295|A>>>11),A=v+(T^(w|~I))+b[8]+1873313359&4294967295,v=w+(A<<6&4294967295|A>>>26),A=I+(w^(v|~T))+b[15]+4264355552&4294967295,I=v+(A<<10&4294967295|A>>>22),A=T+(v^(I|~w))+b[6]+2734768916&4294967295,T=I+(A<<15&4294967295|A>>>17),A=w+(I^(T|~v))+b[13]+1309151649&4294967295,w=T+(A<<21&4294967295|A>>>11),A=v+(T^(w|~I))+b[4]+4149444226&4294967295,v=w+(A<<6&4294967295|A>>>26),A=I+(w^(v|~T))+b[11]+3174756917&4294967295,I=v+(A<<10&4294967295|A>>>22),A=T+(v^(I|~w))+b[2]+718787259&4294967295,T=I+(A<<15&4294967295|A>>>17),A=w+(I^(T|~v))+b[9]+3951481745&4294967295,S.g[0]=S.g[0]+v&4294967295,S.g[1]=S.g[1]+(T+(A<<21&4294967295|A>>>11))&4294967295,S.g[2]=S.g[2]+T&4294967295,S.g[3]=S.g[3]+I&4294967295}r.prototype.u=function(S,v){v===void 0&&(v=S.length);for(var w=v-this.blockSize,b=this.B,T=this.h,I=0;I<v;){if(T==0)for(;I<=w;)s(this,S,I),I+=this.blockSize;if(typeof S=="string"){for(;I<v;)if(b[T++]=S.charCodeAt(I++),T==this.blockSize){s(this,b),T=0;break}}else for(;I<v;)if(b[T++]=S[I++],T==this.blockSize){s(this,b),T=0;break}}this.h=T,this.o+=v},r.prototype.v=function(){var S=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);S[0]=128;for(var v=1;v<S.length-8;++v)S[v]=0;var w=8*this.o;for(v=S.length-8;v<S.length;++v)S[v]=w&255,w/=256;for(this.u(S),S=Array(16),v=w=0;4>v;++v)for(var b=0;32>b;b+=8)S[w++]=this.g[v]>>>b&255;return S};function i(S,v){var w=a;return Object.prototype.hasOwnProperty.call(w,S)?w[S]:w[S]=v(S)}function o(S,v){this.h=v;for(var w=[],b=!0,T=S.length-1;0<=T;T--){var I=S[T]|0;b&&I==v||(w[T]=I,b=!1)}this.g=w}var a={};function c(S){return-128<=S&&128>S?i(S,function(v){return new o([v|0],0>v?-1:0)}):new o([S|0],0>S?-1:0)}function u(S){if(isNaN(S)||!isFinite(S))return f;if(0>S)return V(u(-S));for(var v=[],w=1,b=0;S>=w;b++)v[b]=S/w|0,w*=4294967296;return new o(v,0)}function h(S,v){if(S.length==0)throw Error("number format error: empty string");if(v=v||10,2>v||36<v)throw Error("radix out of range: "+v);if(S.charAt(0)=="-")return V(h(S.substring(1),v));if(0<=S.indexOf("-"))throw Error('number format error: interior "-" character');for(var w=u(Math.pow(v,8)),b=f,T=0;T<S.length;T+=8){var I=Math.min(8,S.length-T),A=parseInt(S.substring(T,T+I),v);8>I?(I=u(Math.pow(v,I)),b=b.j(I).add(u(A))):(b=b.j(w),b=b.add(u(A)))}return b}var f=c(0),p=c(1),y=c(16777216);t=o.prototype,t.m=function(){if(O(this))return-V(this).m();for(var S=0,v=1,w=0;w<this.g.length;w++){var b=this.i(w);S+=(0<=b?b:4294967296+b)*v,v*=4294967296}return S},t.toString=function(S){if(S=S||10,2>S||36<S)throw Error("radix out of range: "+S);if(D(this))return"0";if(O(this))return"-"+V(this).toString(S);for(var v=u(Math.pow(S,6)),w=this,b="";;){var T=$(w,v).g;w=M(w,T.j(v));var I=((0<w.g.length?w.g[0]:w.h)>>>0).toString(S);if(w=T,D(w))return I+b;for(;6>I.length;)I="0"+I;b=I+b}},t.i=function(S){return 0>S?0:S<this.g.length?this.g[S]:this.h};function D(S){if(S.h!=0)return!1;for(var v=0;v<S.g.length;v++)if(S.g[v]!=0)return!1;return!0}function O(S){return S.h==-1}t.l=function(S){return S=M(this,S),O(S)?-1:D(S)?0:1};function V(S){for(var v=S.g.length,w=[],b=0;b<v;b++)w[b]=~S.g[b];return new o(w,~S.h).add(p)}t.abs=function(){return O(this)?V(this):this},t.add=function(S){for(var v=Math.max(this.g.length,S.g.length),w=[],b=0,T=0;T<=v;T++){var I=b+(this.i(T)&65535)+(S.i(T)&65535),A=(I>>>16)+(this.i(T)>>>16)+(S.i(T)>>>16);b=A>>>16,I&=65535,A&=65535,w[T]=A<<16|I}return new o(w,w[w.length-1]&-2147483648?-1:0)};function M(S,v){return S.add(V(v))}t.j=function(S){if(D(this)||D(S))return f;if(O(this))return O(S)?V(this).j(V(S)):V(V(this).j(S));if(O(S))return V(this.j(V(S)));if(0>this.l(y)&&0>S.l(y))return u(this.m()*S.m());for(var v=this.g.length+S.g.length,w=[],b=0;b<2*v;b++)w[b]=0;for(b=0;b<this.g.length;b++)for(var T=0;T<S.g.length;T++){var I=this.i(b)>>>16,A=this.i(b)&65535,De=S.i(T)>>>16,qe=S.i(T)&65535;w[2*b+2*T]+=A*qe,k(w,2*b+2*T),w[2*b+2*T+1]+=I*qe,k(w,2*b+2*T+1),w[2*b+2*T+1]+=A*De,k(w,2*b+2*T+1),w[2*b+2*T+2]+=I*De,k(w,2*b+2*T+2)}for(b=0;b<v;b++)w[b]=w[2*b+1]<<16|w[2*b];for(b=v;b<2*v;b++)w[b]=0;return new o(w,0)};function k(S,v){for(;(S[v]&65535)!=S[v];)S[v+1]+=S[v]>>>16,S[v]&=65535,v++}function x(S,v){this.g=S,this.h=v}function $(S,v){if(D(v))throw Error("division by zero");if(D(S))return new x(f,f);if(O(S))return v=$(V(S),v),new x(V(v.g),V(v.h));if(O(v))return v=$(S,V(v)),new x(V(v.g),v.h);if(30<S.g.length){if(O(S)||O(v))throw Error("slowDivide_ only works with positive integers.");for(var w=p,b=v;0>=b.l(S);)w=F(w),b=F(b);var T=q(w,1),I=q(b,1);for(b=q(b,2),w=q(w,2);!D(b);){var A=I.add(b);0>=A.l(S)&&(T=T.add(w),I=A),b=q(b,1),w=q(w,1)}return v=M(S,T.j(v)),new x(T,v)}for(T=f;0<=S.l(v);){for(w=Math.max(1,Math.floor(S.m()/v.m())),b=Math.ceil(Math.log(w)/Math.LN2),b=48>=b?1:Math.pow(2,b-48),I=u(w),A=I.j(v);O(A)||0<A.l(S);)w-=b,I=u(w),A=I.j(v);D(I)&&(I=p),T=T.add(I),S=M(S,A)}return new x(T,S)}t.A=function(S){return $(this,S).h},t.and=function(S){for(var v=Math.max(this.g.length,S.g.length),w=[],b=0;b<v;b++)w[b]=this.i(b)&S.i(b);return new o(w,this.h&S.h)},t.or=function(S){for(var v=Math.max(this.g.length,S.g.length),w=[],b=0;b<v;b++)w[b]=this.i(b)|S.i(b);return new o(w,this.h|S.h)},t.xor=function(S){for(var v=Math.max(this.g.length,S.g.length),w=[],b=0;b<v;b++)w[b]=this.i(b)^S.i(b);return new o(w,this.h^S.h)};function F(S){for(var v=S.g.length+1,w=[],b=0;b<v;b++)w[b]=S.i(b)<<1|S.i(b-1)>>>31;return new o(w,S.h)}function q(S,v){var w=v>>5;v%=32;for(var b=S.g.length-w,T=[],I=0;I<b;I++)T[I]=0<v?S.i(I+w)>>>v|S.i(I+w+1)<<32-v:S.i(I+w);return new o(T,S.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,kv=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=u,o.fromString=h,Hr=o}).apply(typeof Dm<"u"?Dm:typeof self<"u"?self:typeof window<"u"?window:{});var ka=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Ov,Qi,xv,Ka,zu,Nv,Vv,Mv;(function(){var t,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(l,d,g){return l==Array.prototype||l==Object.prototype||(l[d]=g.value),l};function n(l){l=[typeof globalThis=="object"&&globalThis,l,typeof window=="object"&&window,typeof self=="object"&&self,typeof ka=="object"&&ka];for(var d=0;d<l.length;++d){var g=l[d];if(g&&g.Math==Math)return g}throw Error("Cannot find global object")}var r=n(this);function s(l,d){if(d)e:{var g=r;l=l.split(".");for(var E=0;E<l.length-1;E++){var L=l[E];if(!(L in g))break e;g=g[L]}l=l[l.length-1],E=g[l],d=d(E),d!=E&&d!=null&&e(g,l,{configurable:!0,writable:!0,value:d})}}function i(l,d){l instanceof String&&(l+="");var g=0,E=!1,L={next:function(){if(!E&&g<l.length){var U=g++;return{value:d(U,l[U]),done:!1}}return E=!0,{done:!0,value:void 0}}};return L[Symbol.iterator]=function(){return L},L}s("Array.prototype.values",function(l){return l||function(){return i(this,function(d,g){return g})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function c(l){var d=typeof l;return d=d!="object"?d:l?Array.isArray(l)?"array":d:"null",d=="array"||d=="object"&&typeof l.length=="number"}function u(l){var d=typeof l;return d=="object"&&l!=null||d=="function"}function h(l,d,g){return l.call.apply(l.bind,arguments)}function f(l,d,g){if(!l)throw Error();if(2<arguments.length){var E=Array.prototype.slice.call(arguments,2);return function(){var L=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(L,E),l.apply(d,L)}}return function(){return l.apply(d,arguments)}}function p(l,d,g){return p=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?h:f,p.apply(null,arguments)}function y(l,d){var g=Array.prototype.slice.call(arguments,1);return function(){var E=g.slice();return E.push.apply(E,arguments),l.apply(this,E)}}function D(l,d){function g(){}g.prototype=d.prototype,l.aa=d.prototype,l.prototype=new g,l.prototype.constructor=l,l.Qb=function(E,L,U){for(var ee=Array(arguments.length-2),ze=2;ze<arguments.length;ze++)ee[ze-2]=arguments[ze];return d.prototype[L].apply(E,ee)}}function O(l){const d=l.length;if(0<d){const g=Array(d);for(let E=0;E<d;E++)g[E]=l[E];return g}return[]}function V(l,d){for(let g=1;g<arguments.length;g++){const E=arguments[g];if(c(E)){const L=l.length||0,U=E.length||0;l.length=L+U;for(let ee=0;ee<U;ee++)l[L+ee]=E[ee]}else l.push(E)}}class M{constructor(d,g){this.i=d,this.j=g,this.h=0,this.g=null}get(){let d;return 0<this.h?(this.h--,d=this.g,this.g=d.next,d.next=null):d=this.i(),d}}function k(l){return/^[\s\xa0]*$/.test(l)}function x(){var l=a.navigator;return l&&(l=l.userAgent)?l:""}function $(l){return $[" "](l),l}$[" "]=function(){};var F=x().indexOf("Gecko")!=-1&&!(x().toLowerCase().indexOf("webkit")!=-1&&x().indexOf("Edge")==-1)&&!(x().indexOf("Trident")!=-1||x().indexOf("MSIE")!=-1)&&x().indexOf("Edge")==-1;function q(l,d,g){for(const E in l)d.call(g,l[E],E,l)}function S(l,d){for(const g in l)d.call(void 0,l[g],g,l)}function v(l){const d={};for(const g in l)d[g]=l[g];return d}const w="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function b(l,d){let g,E;for(let L=1;L<arguments.length;L++){E=arguments[L];for(g in E)l[g]=E[g];for(let U=0;U<w.length;U++)g=w[U],Object.prototype.hasOwnProperty.call(E,g)&&(l[g]=E[g])}}function T(l){var d=1;l=l.split(":");const g=[];for(;0<d&&l.length;)g.push(l.shift()),d--;return l.length&&g.push(l.join(":")),g}function I(l){a.setTimeout(()=>{throw l},0)}function A(){var l=Lt;let d=null;return l.g&&(d=l.g,l.g=l.g.next,l.g||(l.h=null),d.next=null),d}class De{constructor(){this.h=this.g=null}add(d,g){const E=qe.get();E.set(d,g),this.h?this.h.next=E:this.g=E,this.h=E}}var qe=new M(()=>new Ce,l=>l.reset());class Ce{constructor(){this.next=this.g=this.h=null}set(d,g){this.h=d,this.g=g,this.next=null}reset(){this.next=this.g=this.h=null}}let me,Se=!1,Lt=new De,fn=()=>{const l=a.Promise.resolve(void 0);me=()=>{l.then(nn)}};var nn=()=>{for(var l;l=A();){try{l.h.call(l.g)}catch(g){I(g)}var d=qe;d.j(l),100>d.h&&(d.h++,l.next=d.g,d.g=l)}Se=!1};function Xe(){this.s=this.s,this.C=this.C}Xe.prototype.s=!1,Xe.prototype.ma=function(){this.s||(this.s=!0,this.N())},Xe.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Ze(l,d){this.type=l,this.g=this.target=d,this.defaultPrevented=!1}Ze.prototype.h=function(){this.defaultPrevented=!0};var _r=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var l=!1,d=Object.defineProperty({},"passive",{get:function(){l=!0}});try{const g=()=>{};a.addEventListener("test",g,d),a.removeEventListener("test",g,d)}catch{}return l}();function In(l,d){if(Ze.call(this,l?l.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,l){var g=this.type=l.type,E=l.changedTouches&&l.changedTouches.length?l.changedTouches[0]:null;if(this.target=l.target||l.srcElement,this.g=d,d=l.relatedTarget){if(F){e:{try{$(d.nodeName);var L=!0;break e}catch{}L=!1}L||(d=null)}}else g=="mouseover"?d=l.fromElement:g=="mouseout"&&(d=l.toElement);this.relatedTarget=d,E?(this.clientX=E.clientX!==void 0?E.clientX:E.pageX,this.clientY=E.clientY!==void 0?E.clientY:E.pageY,this.screenX=E.screenX||0,this.screenY=E.screenY||0):(this.clientX=l.clientX!==void 0?l.clientX:l.pageX,this.clientY=l.clientY!==void 0?l.clientY:l.pageY,this.screenX=l.screenX||0,this.screenY=l.screenY||0),this.button=l.button,this.key=l.key||"",this.ctrlKey=l.ctrlKey,this.altKey=l.altKey,this.shiftKey=l.shiftKey,this.metaKey=l.metaKey,this.pointerId=l.pointerId||0,this.pointerType=typeof l.pointerType=="string"?l.pointerType:qt[l.pointerType]||"",this.state=l.state,this.i=l,l.defaultPrevented&&In.aa.h.call(this)}}D(In,Ze);var qt={2:"touch",3:"pen",4:"mouse"};In.prototype.h=function(){In.aa.h.call(this);var l=this.i;l.preventDefault?l.preventDefault():l.returnValue=!1};var j="closure_listenable_"+(1e6*Math.random()|0),oe=0;function se(l,d,g,E,L){this.listener=l,this.proxy=null,this.src=d,this.type=g,this.capture=!!E,this.ha=L,this.key=++oe,this.da=this.fa=!1}function ae(l){l.da=!0,l.listener=null,l.proxy=null,l.src=null,l.ha=null}function Fe(l){this.src=l,this.g={},this.h=0}Fe.prototype.add=function(l,d,g,E,L){var U=l.toString();l=this.g[U],l||(l=this.g[U]=[],this.h++);var ee=R(l,d,E,L);return-1<ee?(d=l[ee],g||(d.fa=!1)):(d=new se(d,this.src,U,!!E,L),d.fa=g,l.push(d)),d};function P(l,d){var g=d.type;if(g in l.g){var E=l.g[g],L=Array.prototype.indexOf.call(E,d,void 0),U;(U=0<=L)&&Array.prototype.splice.call(E,L,1),U&&(ae(d),l.g[g].length==0&&(delete l.g[g],l.h--))}}function R(l,d,g,E){for(var L=0;L<l.length;++L){var U=l[L];if(!U.da&&U.listener==d&&U.capture==!!g&&U.ha==E)return L}return-1}var N="closure_lm_"+(1e6*Math.random()|0),H={};function K(l,d,g,E,L){if(Array.isArray(d)){for(var U=0;U<d.length;U++)K(l,d[U],g,E,L);return null}return g=_e(g),l&&l[j]?l.K(d,g,u(E)?!!E.capture:!1,L):z(l,d,g,!1,E,L)}function z(l,d,g,E,L,U){if(!d)throw Error("Invalid event type");var ee=u(L)?!!L.capture:!!L,ze=te(l);if(ze||(l[N]=ze=new Fe(l)),g=ze.add(d,g,E,ee,U),g.proxy)return g;if(E=ne(),g.proxy=E,E.src=l,E.listener=g,l.addEventListener)_r||(L=ee),L===void 0&&(L=!1),l.addEventListener(d.toString(),E,L);else if(l.attachEvent)l.attachEvent(Q(d.toString()),E);else if(l.addListener&&l.removeListener)l.addListener(E);else throw Error("addEventListener and attachEvent are unavailable.");return g}function ne(){function l(g){return d.call(l.src,l.listener,g)}const d=ue;return l}function Z(l,d,g,E,L){if(Array.isArray(d))for(var U=0;U<d.length;U++)Z(l,d[U],g,E,L);else E=u(E)?!!E.capture:!!E,g=_e(g),l&&l[j]?(l=l.i,d=String(d).toString(),d in l.g&&(U=l.g[d],g=R(U,g,E,L),-1<g&&(ae(U[g]),Array.prototype.splice.call(U,g,1),U.length==0&&(delete l.g[d],l.h--)))):l&&(l=te(l))&&(d=l.g[d.toString()],l=-1,d&&(l=R(d,g,E,L)),(g=-1<l?d[l]:null)&&X(g))}function X(l){if(typeof l!="number"&&l&&!l.da){var d=l.src;if(d&&d[j])P(d.i,l);else{var g=l.type,E=l.proxy;d.removeEventListener?d.removeEventListener(g,E,l.capture):d.detachEvent?d.detachEvent(Q(g),E):d.addListener&&d.removeListener&&d.removeListener(E),(g=te(d))?(P(g,l),g.h==0&&(g.src=null,d[N]=null)):ae(l)}}}function Q(l){return l in H?H[l]:H[l]="on"+l}function ue(l,d){if(l.da)l=!0;else{d=new In(d,this);var g=l.listener,E=l.ha||l.src;l.fa&&X(l),l=g.call(E,d)}return l}function te(l){return l=l[N],l instanceof Fe?l:null}var le="__closure_events_fn_"+(1e9*Math.random()>>>0);function _e(l){return typeof l=="function"?l:(l[le]||(l[le]=function(d){return l.handleEvent(d)}),l[le])}function pe(){Xe.call(this),this.i=new Fe(this),this.M=this,this.F=null}D(pe,Xe),pe.prototype[j]=!0,pe.prototype.removeEventListener=function(l,d,g,E){Z(this,l,d,g,E)};function Te(l,d){var g,E=l.F;if(E)for(g=[];E;E=E.F)g.push(E);if(l=l.M,E=d.type||d,typeof d=="string")d=new Ze(d,l);else if(d instanceof Ze)d.target=d.target||l;else{var L=d;d=new Ze(E,l),b(d,L)}if(L=!0,g)for(var U=g.length-1;0<=U;U--){var ee=d.g=g[U];L=Ve(ee,E,!0,d)&&L}if(ee=d.g=l,L=Ve(ee,E,!0,d)&&L,L=Ve(ee,E,!1,d)&&L,g)for(U=0;U<g.length;U++)ee=d.g=g[U],L=Ve(ee,E,!1,d)&&L}pe.prototype.N=function(){if(pe.aa.N.call(this),this.i){var l=this.i,d;for(d in l.g){for(var g=l.g[d],E=0;E<g.length;E++)ae(g[E]);delete l.g[d],l.h--}}this.F=null},pe.prototype.K=function(l,d,g,E){return this.i.add(String(l),d,!1,g,E)},pe.prototype.L=function(l,d,g,E){return this.i.add(String(l),d,!0,g,E)};function Ve(l,d,g,E){if(d=l.i.g[String(d)],!d)return!0;d=d.concat();for(var L=!0,U=0;U<d.length;++U){var ee=d[U];if(ee&&!ee.da&&ee.capture==g){var ze=ee.listener,wt=ee.ha||ee.src;ee.fa&&P(l.i,ee),L=ze.call(wt,E)!==!1&&L}}return L&&!E.defaultPrevented}function _t(l,d,g){if(typeof l=="function")g&&(l=p(l,g));else if(l&&typeof l.handleEvent=="function")l=p(l.handleEvent,l);else throw Error("Invalid listener argument");return 2147483647<Number(d)?-1:a.setTimeout(l,d||0)}function vt(l){l.g=_t(()=>{l.g=null,l.i&&(l.i=!1,vt(l))},l.l);const d=l.h;l.h=null,l.m.apply(null,d)}class rn extends Xe{constructor(d,g){super(),this.m=d,this.l=g,this.h=null,this.i=!1,this.g=null}j(d){this.h=arguments,this.g?this.i=!0:vt(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function St(l){Xe.call(this),this.h=l,this.g={}}D(St,Xe);var vr=[];function Ri(l){q(l.g,function(d,g){this.g.hasOwnProperty(g)&&X(d)},l),l.g={}}St.prototype.N=function(){St.aa.N.call(this),Ri(this)},St.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Et=a.JSON.stringify,sn=a.JSON.parse,ua=class{stringify(l){return a.JSON.stringify(l,void 0)}parse(l){return a.JSON.parse(l,void 0)}};function Ac(){}Ac.prototype.h=null;function sf(l){return l.h||(l.h=l.i())}function of(){}var Di={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Sc(){Ze.call(this,"d")}D(Sc,Ze);function Pc(){Ze.call(this,"c")}D(Pc,Ze);var os={},af=null;function ha(){return af=af||new pe}os.La="serverreachability";function lf(l){Ze.call(this,os.La,l)}D(lf,Ze);function ki(l){const d=ha();Te(d,new lf(d))}os.STAT_EVENT="statevent";function cf(l,d){Ze.call(this,os.STAT_EVENT,l),this.stat=d}D(cf,Ze);function Ft(l){const d=ha();Te(d,new cf(d,l))}os.Ma="timingevent";function uf(l,d){Ze.call(this,os.Ma,l),this.size=d}D(uf,Ze);function Oi(l,d){if(typeof l!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){l()},d)}function xi(){this.g=!0}xi.prototype.xa=function(){this.g=!1};function Q1(l,d,g,E,L,U){l.info(function(){if(l.g)if(U)for(var ee="",ze=U.split("&"),wt=0;wt<ze.length;wt++){var $e=ze[wt].split("=");if(1<$e.length){var Pt=$e[0];$e=$e[1];var Ct=Pt.split("_");ee=2<=Ct.length&&Ct[1]=="type"?ee+(Pt+"="+$e+"&"):ee+(Pt+"=redacted&")}}else ee=null;else ee=U;return"XMLHTTP REQ ("+E+") [attempt "+L+"]: "+d+`
`+g+`
`+ee})}function J1(l,d,g,E,L,U,ee){l.info(function(){return"XMLHTTP RESP ("+E+") [ attempt "+L+"]: "+d+`
`+g+`
`+U+" "+ee})}function Fs(l,d,g,E){l.info(function(){return"XMLHTTP TEXT ("+d+"): "+Z1(l,g)+(E?" "+E:"")})}function X1(l,d){l.info(function(){return"TIMEOUT: "+d})}xi.prototype.info=function(){};function Z1(l,d){if(!l.g)return d;if(!d)return null;try{var g=JSON.parse(d);if(g){for(l=0;l<g.length;l++)if(Array.isArray(g[l])){var E=g[l];if(!(2>E.length)){var L=E[1];if(Array.isArray(L)&&!(1>L.length)){var U=L[0];if(U!="noop"&&U!="stop"&&U!="close")for(var ee=1;ee<L.length;ee++)L[ee]=""}}}}return Et(g)}catch{return d}}var da={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},hf={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Cc;function fa(){}D(fa,Ac),fa.prototype.g=function(){return new XMLHttpRequest},fa.prototype.i=function(){return{}},Cc=new fa;function Er(l,d,g,E){this.j=l,this.i=d,this.l=g,this.R=E||1,this.U=new St(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new df}function df(){this.i=null,this.g="",this.h=!1}var ff={},Rc={};function Dc(l,d,g){l.L=1,l.v=ya(jn(d)),l.m=g,l.P=!0,pf(l,null)}function pf(l,d){l.F=Date.now(),pa(l),l.A=jn(l.v);var g=l.A,E=l.R;Array.isArray(E)||(E=[String(E)]),Cf(g.i,"t",E),l.C=0,g=l.j.J,l.h=new df,l.g=Wf(l.j,g?d:null,!l.m),0<l.O&&(l.M=new rn(p(l.Y,l,l.g),l.O)),d=l.U,g=l.g,E=l.ca;var L="readystatechange";Array.isArray(L)||(L&&(vr[0]=L.toString()),L=vr);for(var U=0;U<L.length;U++){var ee=K(g,L[U],E||d.handleEvent,!1,d.h||d);if(!ee)break;d.g[ee.key]=ee}d=l.H?v(l.H):{},l.m?(l.u||(l.u="POST"),d["Content-Type"]="application/x-www-form-urlencoded",l.g.ea(l.A,l.u,l.m,d)):(l.u="GET",l.g.ea(l.A,l.u,null,d)),ki(),Q1(l.i,l.u,l.A,l.l,l.R,l.m)}Er.prototype.ca=function(l){l=l.target;const d=this.M;d&&Hn(l)==3?d.j():this.Y(l)},Er.prototype.Y=function(l){try{if(l==this.g)e:{const Ct=Hn(this.g);var d=this.g.Ba();const Bs=this.g.Z();if(!(3>Ct)&&(Ct!=3||this.g&&(this.h.h||this.g.oa()||Vf(this.g)))){this.J||Ct!=4||d==7||(d==8||0>=Bs?ki(3):ki(2)),kc(this);var g=this.g.Z();this.X=g;t:if(mf(this)){var E=Vf(this.g);l="";var L=E.length,U=Hn(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){as(this),Ni(this);var ee="";break t}this.h.i=new a.TextDecoder}for(d=0;d<L;d++)this.h.h=!0,l+=this.h.i.decode(E[d],{stream:!(U&&d==L-1)});E.length=0,this.h.g+=l,this.C=0,ee=this.h.g}else ee=this.g.oa();if(this.o=g==200,J1(this.i,this.u,this.A,this.l,this.R,Ct,g),this.o){if(this.T&&!this.K){t:{if(this.g){var ze,wt=this.g;if((ze=wt.g?wt.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!k(ze)){var $e=ze;break t}}$e=null}if(g=$e)Fs(this.i,this.l,g,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Oc(this,g);else{this.o=!1,this.s=3,Ft(12),as(this),Ni(this);break e}}if(this.P){g=!0;let pn;for(;!this.J&&this.C<ee.length;)if(pn=ew(this,ee),pn==Rc){Ct==4&&(this.s=4,Ft(14),g=!1),Fs(this.i,this.l,null,"[Incomplete Response]");break}else if(pn==ff){this.s=4,Ft(15),Fs(this.i,this.l,ee,"[Invalid Chunk]"),g=!1;break}else Fs(this.i,this.l,pn,null),Oc(this,pn);if(mf(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Ct!=4||ee.length!=0||this.h.h||(this.s=1,Ft(16),g=!1),this.o=this.o&&g,!g)Fs(this.i,this.l,ee,"[Invalid Chunked Response]"),as(this),Ni(this);else if(0<ee.length&&!this.W){this.W=!0;var Pt=this.j;Pt.g==this&&Pt.ba&&!Pt.M&&(Pt.j.info("Great, no buffering proxy detected. Bytes received: "+ee.length),Fc(Pt),Pt.M=!0,Ft(11))}}else Fs(this.i,this.l,ee,null),Oc(this,ee);Ct==4&&as(this),this.o&&!this.J&&(Ct==4?jf(this.j,this):(this.o=!1,pa(this)))}else yw(this.g),g==400&&0<ee.indexOf("Unknown SID")?(this.s=3,Ft(12)):(this.s=0,Ft(13)),as(this),Ni(this)}}}catch{}finally{}};function mf(l){return l.g?l.u=="GET"&&l.L!=2&&l.j.Ca:!1}function ew(l,d){var g=l.C,E=d.indexOf(`
`,g);return E==-1?Rc:(g=Number(d.substring(g,E)),isNaN(g)?ff:(E+=1,E+g>d.length?Rc:(d=d.slice(E,E+g),l.C=E+g,d)))}Er.prototype.cancel=function(){this.J=!0,as(this)};function pa(l){l.S=Date.now()+l.I,gf(l,l.I)}function gf(l,d){if(l.B!=null)throw Error("WatchDog timer not null");l.B=Oi(p(l.ba,l),d)}function kc(l){l.B&&(a.clearTimeout(l.B),l.B=null)}Er.prototype.ba=function(){this.B=null;const l=Date.now();0<=l-this.S?(X1(this.i,this.A),this.L!=2&&(ki(),Ft(17)),as(this),this.s=2,Ni(this)):gf(this,this.S-l)};function Ni(l){l.j.G==0||l.J||jf(l.j,l)}function as(l){kc(l);var d=l.M;d&&typeof d.ma=="function"&&d.ma(),l.M=null,Ri(l.U),l.g&&(d=l.g,l.g=null,d.abort(),d.ma())}function Oc(l,d){try{var g=l.j;if(g.G!=0&&(g.g==l||xc(g.h,l))){if(!l.K&&xc(g.h,l)&&g.G==3){try{var E=g.Da.g.parse(d)}catch{E=null}if(Array.isArray(E)&&E.length==3){var L=E;if(L[0]==0){e:if(!g.u){if(g.g)if(g.g.F+3e3<l.F)Ta(g),wa(g);else break e;Lc(g),Ft(18)}}else g.za=L[1],0<g.za-g.T&&37500>L[2]&&g.F&&g.v==0&&!g.C&&(g.C=Oi(p(g.Za,g),6e3));if(1>=vf(g.h)&&g.ca){try{g.ca()}catch{}g.ca=void 0}}else cs(g,11)}else if((l.K||g.g==l)&&Ta(g),!k(d))for(L=g.Da.g.parse(d),d=0;d<L.length;d++){let $e=L[d];if(g.T=$e[0],$e=$e[1],g.G==2)if($e[0]=="c"){g.K=$e[1],g.ia=$e[2];const Pt=$e[3];Pt!=null&&(g.la=Pt,g.j.info("VER="+g.la));const Ct=$e[4];Ct!=null&&(g.Aa=Ct,g.j.info("SVER="+g.Aa));const Bs=$e[5];Bs!=null&&typeof Bs=="number"&&0<Bs&&(E=1.5*Bs,g.L=E,g.j.info("backChannelRequestTimeoutMs_="+E)),E=g;const pn=l.g;if(pn){const Aa=pn.g?pn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Aa){var U=E.h;U.g||Aa.indexOf("spdy")==-1&&Aa.indexOf("quic")==-1&&Aa.indexOf("h2")==-1||(U.j=U.l,U.g=new Set,U.h&&(Nc(U,U.h),U.h=null))}if(E.D){const $c=pn.g?pn.g.getResponseHeader("X-HTTP-Session-Id"):null;$c&&(E.ya=$c,Qe(E.I,E.D,$c))}}g.G=3,g.l&&g.l.ua(),g.ba&&(g.R=Date.now()-l.F,g.j.info("Handshake RTT: "+g.R+"ms")),E=g;var ee=l;if(E.qa=zf(E,E.J?E.ia:null,E.W),ee.K){Ef(E.h,ee);var ze=ee,wt=E.L;wt&&(ze.I=wt),ze.B&&(kc(ze),pa(ze)),E.g=ee}else Uf(E);0<g.i.length&&ba(g)}else $e[0]!="stop"&&$e[0]!="close"||cs(g,7);else g.G==3&&($e[0]=="stop"||$e[0]=="close"?$e[0]=="stop"?cs(g,7):Mc(g):$e[0]!="noop"&&g.l&&g.l.ta($e),g.v=0)}}ki(4)}catch{}}var tw=class{constructor(l,d){this.g=l,this.map=d}};function yf(l){this.l=l||10,a.PerformanceNavigationTiming?(l=a.performance.getEntriesByType("navigation"),l=0<l.length&&(l[0].nextHopProtocol=="hq"||l[0].nextHopProtocol=="h2")):l=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=l?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function _f(l){return l.h?!0:l.g?l.g.size>=l.j:!1}function vf(l){return l.h?1:l.g?l.g.size:0}function xc(l,d){return l.h?l.h==d:l.g?l.g.has(d):!1}function Nc(l,d){l.g?l.g.add(d):l.h=d}function Ef(l,d){l.h&&l.h==d?l.h=null:l.g&&l.g.has(d)&&l.g.delete(d)}yf.prototype.cancel=function(){if(this.i=wf(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const l of this.g.values())l.cancel();this.g.clear()}};function wf(l){if(l.h!=null)return l.i.concat(l.h.D);if(l.g!=null&&l.g.size!==0){let d=l.i;for(const g of l.g.values())d=d.concat(g.D);return d}return O(l.i)}function nw(l){if(l.V&&typeof l.V=="function")return l.V();if(typeof Map<"u"&&l instanceof Map||typeof Set<"u"&&l instanceof Set)return Array.from(l.values());if(typeof l=="string")return l.split("");if(c(l)){for(var d=[],g=l.length,E=0;E<g;E++)d.push(l[E]);return d}d=[],g=0;for(E in l)d[g++]=l[E];return d}function rw(l){if(l.na&&typeof l.na=="function")return l.na();if(!l.V||typeof l.V!="function"){if(typeof Map<"u"&&l instanceof Map)return Array.from(l.keys());if(!(typeof Set<"u"&&l instanceof Set)){if(c(l)||typeof l=="string"){var d=[];l=l.length;for(var g=0;g<l;g++)d.push(g);return d}d=[],g=0;for(const E in l)d[g++]=E;return d}}}function bf(l,d){if(l.forEach&&typeof l.forEach=="function")l.forEach(d,void 0);else if(c(l)||typeof l=="string")Array.prototype.forEach.call(l,d,void 0);else for(var g=rw(l),E=nw(l),L=E.length,U=0;U<L;U++)d.call(void 0,E[U],g&&g[U],l)}var Tf=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function sw(l,d){if(l){l=l.split("&");for(var g=0;g<l.length;g++){var E=l[g].indexOf("="),L=null;if(0<=E){var U=l[g].substring(0,E);L=l[g].substring(E+1)}else U=l[g];d(U,L?decodeURIComponent(L.replace(/\+/g," ")):"")}}}function ls(l){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,l instanceof ls){this.h=l.h,ma(this,l.j),this.o=l.o,this.g=l.g,ga(this,l.s),this.l=l.l;var d=l.i,g=new Li;g.i=d.i,d.g&&(g.g=new Map(d.g),g.h=d.h),If(this,g),this.m=l.m}else l&&(d=String(l).match(Tf))?(this.h=!1,ma(this,d[1]||"",!0),this.o=Vi(d[2]||""),this.g=Vi(d[3]||"",!0),ga(this,d[4]),this.l=Vi(d[5]||"",!0),If(this,d[6]||"",!0),this.m=Vi(d[7]||"")):(this.h=!1,this.i=new Li(null,this.h))}ls.prototype.toString=function(){var l=[],d=this.j;d&&l.push(Mi(d,Af,!0),":");var g=this.g;return(g||d=="file")&&(l.push("//"),(d=this.o)&&l.push(Mi(d,Af,!0),"@"),l.push(encodeURIComponent(String(g)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),g=this.s,g!=null&&l.push(":",String(g))),(g=this.l)&&(this.g&&g.charAt(0)!="/"&&l.push("/"),l.push(Mi(g,g.charAt(0)=="/"?aw:ow,!0))),(g=this.i.toString())&&l.push("?",g),(g=this.m)&&l.push("#",Mi(g,cw)),l.join("")};function jn(l){return new ls(l)}function ma(l,d,g){l.j=g?Vi(d,!0):d,l.j&&(l.j=l.j.replace(/:$/,""))}function ga(l,d){if(d){if(d=Number(d),isNaN(d)||0>d)throw Error("Bad port number "+d);l.s=d}else l.s=null}function If(l,d,g){d instanceof Li?(l.i=d,uw(l.i,l.h)):(g||(d=Mi(d,lw)),l.i=new Li(d,l.h))}function Qe(l,d,g){l.i.set(d,g)}function ya(l){return Qe(l,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),l}function Vi(l,d){return l?d?decodeURI(l.replace(/%25/g,"%2525")):decodeURIComponent(l):""}function Mi(l,d,g){return typeof l=="string"?(l=encodeURI(l).replace(d,iw),g&&(l=l.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l):null}function iw(l){return l=l.charCodeAt(0),"%"+(l>>4&15).toString(16)+(l&15).toString(16)}var Af=/[#\/\?@]/g,ow=/[#\?:]/g,aw=/[#\?]/g,lw=/[#\?@]/g,cw=/#/g;function Li(l,d){this.h=this.g=null,this.i=l||null,this.j=!!d}function wr(l){l.g||(l.g=new Map,l.h=0,l.i&&sw(l.i,function(d,g){l.add(decodeURIComponent(d.replace(/\+/g," ")),g)}))}t=Li.prototype,t.add=function(l,d){wr(this),this.i=null,l=$s(this,l);var g=this.g.get(l);return g||this.g.set(l,g=[]),g.push(d),this.h+=1,this};function Sf(l,d){wr(l),d=$s(l,d),l.g.has(d)&&(l.i=null,l.h-=l.g.get(d).length,l.g.delete(d))}function Pf(l,d){return wr(l),d=$s(l,d),l.g.has(d)}t.forEach=function(l,d){wr(this),this.g.forEach(function(g,E){g.forEach(function(L){l.call(d,L,E,this)},this)},this)},t.na=function(){wr(this);const l=Array.from(this.g.values()),d=Array.from(this.g.keys()),g=[];for(let E=0;E<d.length;E++){const L=l[E];for(let U=0;U<L.length;U++)g.push(d[E])}return g},t.V=function(l){wr(this);let d=[];if(typeof l=="string")Pf(this,l)&&(d=d.concat(this.g.get($s(this,l))));else{l=Array.from(this.g.values());for(let g=0;g<l.length;g++)d=d.concat(l[g])}return d},t.set=function(l,d){return wr(this),this.i=null,l=$s(this,l),Pf(this,l)&&(this.h-=this.g.get(l).length),this.g.set(l,[d]),this.h+=1,this},t.get=function(l,d){return l?(l=this.V(l),0<l.length?String(l[0]):d):d};function Cf(l,d,g){Sf(l,d),0<g.length&&(l.i=null,l.g.set($s(l,d),O(g)),l.h+=g.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const l=[],d=Array.from(this.g.keys());for(var g=0;g<d.length;g++){var E=d[g];const U=encodeURIComponent(String(E)),ee=this.V(E);for(E=0;E<ee.length;E++){var L=U;ee[E]!==""&&(L+="="+encodeURIComponent(String(ee[E]))),l.push(L)}}return this.i=l.join("&")};function $s(l,d){return d=String(d),l.j&&(d=d.toLowerCase()),d}function uw(l,d){d&&!l.j&&(wr(l),l.i=null,l.g.forEach(function(g,E){var L=E.toLowerCase();E!=L&&(Sf(this,E),Cf(this,L,g))},l)),l.j=d}function hw(l,d){const g=new xi;if(a.Image){const E=new Image;E.onload=y(br,g,"TestLoadImage: loaded",!0,d,E),E.onerror=y(br,g,"TestLoadImage: error",!1,d,E),E.onabort=y(br,g,"TestLoadImage: abort",!1,d,E),E.ontimeout=y(br,g,"TestLoadImage: timeout",!1,d,E),a.setTimeout(function(){E.ontimeout&&E.ontimeout()},1e4),E.src=l}else d(!1)}function dw(l,d){const g=new xi,E=new AbortController,L=setTimeout(()=>{E.abort(),br(g,"TestPingServer: timeout",!1,d)},1e4);fetch(l,{signal:E.signal}).then(U=>{clearTimeout(L),U.ok?br(g,"TestPingServer: ok",!0,d):br(g,"TestPingServer: server error",!1,d)}).catch(()=>{clearTimeout(L),br(g,"TestPingServer: error",!1,d)})}function br(l,d,g,E,L){try{L&&(L.onload=null,L.onerror=null,L.onabort=null,L.ontimeout=null),E(g)}catch{}}function fw(){this.g=new ua}function pw(l,d,g){const E=g||"";try{bf(l,function(L,U){let ee=L;u(L)&&(ee=Et(L)),d.push(E+U+"="+encodeURIComponent(ee))})}catch(L){throw d.push(E+"type="+encodeURIComponent("_badmap")),L}}function _a(l){this.l=l.Ub||null,this.j=l.eb||!1}D(_a,Ac),_a.prototype.g=function(){return new va(this.l,this.j)},_a.prototype.i=function(l){return function(){return l}}({});function va(l,d){pe.call(this),this.D=l,this.o=d,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}D(va,pe),t=va.prototype,t.open=function(l,d){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=l,this.A=d,this.readyState=1,$i(this)},t.send=function(l){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const d={headers:this.u,method:this.B,credentials:this.m,cache:void 0};l&&(d.body=l),(this.D||a).fetch(new Request(this.A,d)).then(this.Sa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Fi(this)),this.readyState=0},t.Sa=function(l){if(this.g&&(this.l=l,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=l.headers,this.readyState=2,$i(this)),this.g&&(this.readyState=3,$i(this),this.g)))if(this.responseType==="arraybuffer")l.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in l){if(this.j=l.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Rf(this)}else l.text().then(this.Ra.bind(this),this.ga.bind(this))};function Rf(l){l.j.read().then(l.Pa.bind(l)).catch(l.ga.bind(l))}t.Pa=function(l){if(this.g){if(this.o&&l.value)this.response.push(l.value);else if(!this.o){var d=l.value?l.value:new Uint8Array(0);(d=this.v.decode(d,{stream:!l.done}))&&(this.response=this.responseText+=d)}l.done?Fi(this):$i(this),this.readyState==3&&Rf(this)}},t.Ra=function(l){this.g&&(this.response=this.responseText=l,Fi(this))},t.Qa=function(l){this.g&&(this.response=l,Fi(this))},t.ga=function(){this.g&&Fi(this)};function Fi(l){l.readyState=4,l.l=null,l.j=null,l.v=null,$i(l)}t.setRequestHeader=function(l,d){this.u.append(l,d)},t.getResponseHeader=function(l){return this.h&&this.h.get(l.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const l=[],d=this.h.entries();for(var g=d.next();!g.done;)g=g.value,l.push(g[0]+": "+g[1]),g=d.next();return l.join(`\r
`)};function $i(l){l.onreadystatechange&&l.onreadystatechange.call(l)}Object.defineProperty(va.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(l){this.m=l?"include":"same-origin"}});function Df(l){let d="";return q(l,function(g,E){d+=E,d+=":",d+=g,d+=`\r
`}),d}function Vc(l,d,g){e:{for(E in g){var E=!1;break e}E=!0}E||(g=Df(g),typeof l=="string"?g!=null&&encodeURIComponent(String(g)):Qe(l,d,g))}function nt(l){pe.call(this),this.headers=new Map,this.o=l||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}D(nt,pe);var mw=/^https?$/i,gw=["POST","PUT"];t=nt.prototype,t.Ha=function(l){this.J=l},t.ea=function(l,d,g,E){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+l);d=d?d.toUpperCase():"GET",this.D=l,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Cc.g(),this.v=this.o?sf(this.o):sf(Cc),this.g.onreadystatechange=p(this.Ea,this);try{this.B=!0,this.g.open(d,String(l),!0),this.B=!1}catch(U){kf(this,U);return}if(l=g||"",g=new Map(this.headers),E)if(Object.getPrototypeOf(E)===Object.prototype)for(var L in E)g.set(L,E[L]);else if(typeof E.keys=="function"&&typeof E.get=="function")for(const U of E.keys())g.set(U,E.get(U));else throw Error("Unknown input type for opt_headers: "+String(E));E=Array.from(g.keys()).find(U=>U.toLowerCase()=="content-type"),L=a.FormData&&l instanceof a.FormData,!(0<=Array.prototype.indexOf.call(gw,d,void 0))||E||L||g.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[U,ee]of g)this.g.setRequestHeader(U,ee);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Nf(this),this.u=!0,this.g.send(l),this.u=!1}catch(U){kf(this,U)}};function kf(l,d){l.h=!1,l.g&&(l.j=!0,l.g.abort(),l.j=!1),l.l=d,l.m=5,Of(l),Ea(l)}function Of(l){l.A||(l.A=!0,Te(l,"complete"),Te(l,"error"))}t.abort=function(l){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=l||7,Te(this,"complete"),Te(this,"abort"),Ea(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Ea(this,!0)),nt.aa.N.call(this)},t.Ea=function(){this.s||(this.B||this.u||this.j?xf(this):this.bb())},t.bb=function(){xf(this)};function xf(l){if(l.h&&typeof o<"u"&&(!l.v[1]||Hn(l)!=4||l.Z()!=2)){if(l.u&&Hn(l)==4)_t(l.Ea,0,l);else if(Te(l,"readystatechange"),Hn(l)==4){l.h=!1;try{const ee=l.Z();e:switch(ee){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var d=!0;break e;default:d=!1}var g;if(!(g=d)){var E;if(E=ee===0){var L=String(l.D).match(Tf)[1]||null;!L&&a.self&&a.self.location&&(L=a.self.location.protocol.slice(0,-1)),E=!mw.test(L?L.toLowerCase():"")}g=E}if(g)Te(l,"complete"),Te(l,"success");else{l.m=6;try{var U=2<Hn(l)?l.g.statusText:""}catch{U=""}l.l=U+" ["+l.Z()+"]",Of(l)}}finally{Ea(l)}}}}function Ea(l,d){if(l.g){Nf(l);const g=l.g,E=l.v[0]?()=>{}:null;l.g=null,l.v=null,d||Te(l,"ready");try{g.onreadystatechange=E}catch{}}}function Nf(l){l.I&&(a.clearTimeout(l.I),l.I=null)}t.isActive=function(){return!!this.g};function Hn(l){return l.g?l.g.readyState:0}t.Z=function(){try{return 2<Hn(this)?this.g.status:-1}catch{return-1}},t.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.Oa=function(l){if(this.g){var d=this.g.responseText;return l&&d.indexOf(l)==0&&(d=d.substring(l.length)),sn(d)}};function Vf(l){try{if(!l.g)return null;if("response"in l.g)return l.g.response;switch(l.H){case"":case"text":return l.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in l.g)return l.g.mozResponseArrayBuffer}return null}catch{return null}}function yw(l){const d={};l=(l.g&&2<=Hn(l)&&l.g.getAllResponseHeaders()||"").split(`\r
`);for(let E=0;E<l.length;E++){if(k(l[E]))continue;var g=T(l[E]);const L=g[0];if(g=g[1],typeof g!="string")continue;g=g.trim();const U=d[L]||[];d[L]=U,U.push(g)}S(d,function(E){return E.join(", ")})}t.Ba=function(){return this.m},t.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Ui(l,d,g){return g&&g.internalChannelParams&&g.internalChannelParams[l]||d}function Mf(l){this.Aa=0,this.i=[],this.j=new xi,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Ui("failFast",!1,l),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Ui("baseRetryDelayMs",5e3,l),this.cb=Ui("retryDelaySeedMs",1e4,l),this.Wa=Ui("forwardChannelMaxRetries",2,l),this.wa=Ui("forwardChannelRequestTimeoutMs",2e4,l),this.pa=l&&l.xmlHttpFactory||void 0,this.Xa=l&&l.Tb||void 0,this.Ca=l&&l.useFetchStreams||!1,this.L=void 0,this.J=l&&l.supportsCrossDomainXhr||!1,this.K="",this.h=new yf(l&&l.concurrentRequestLimit),this.Da=new fw,this.P=l&&l.fastHandshake||!1,this.O=l&&l.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=l&&l.Rb||!1,l&&l.xa&&this.j.xa(),l&&l.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&l&&l.detectBufferingProxy||!1,this.ja=void 0,l&&l.longPollingTimeout&&0<l.longPollingTimeout&&(this.ja=l.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}t=Mf.prototype,t.la=8,t.G=1,t.connect=function(l,d,g,E){Ft(0),this.W=l,this.H=d||{},g&&E!==void 0&&(this.H.OSID=g,this.H.OAID=E),this.F=this.X,this.I=zf(this,null,this.W),ba(this)};function Mc(l){if(Lf(l),l.G==3){var d=l.U++,g=jn(l.I);if(Qe(g,"SID",l.K),Qe(g,"RID",d),Qe(g,"TYPE","terminate"),Bi(l,g),d=new Er(l,l.j,d),d.L=2,d.v=ya(jn(g)),g=!1,a.navigator&&a.navigator.sendBeacon)try{g=a.navigator.sendBeacon(d.v.toString(),"")}catch{}!g&&a.Image&&(new Image().src=d.v,g=!0),g||(d.g=Wf(d.j,null),d.g.ea(d.v)),d.F=Date.now(),pa(d)}qf(l)}function wa(l){l.g&&(Fc(l),l.g.cancel(),l.g=null)}function Lf(l){wa(l),l.u&&(a.clearTimeout(l.u),l.u=null),Ta(l),l.h.cancel(),l.s&&(typeof l.s=="number"&&a.clearTimeout(l.s),l.s=null)}function ba(l){if(!_f(l.h)&&!l.s){l.s=!0;var d=l.Ga;me||fn(),Se||(me(),Se=!0),Lt.add(d,l),l.B=0}}function _w(l,d){return vf(l.h)>=l.h.j-(l.s?1:0)?!1:l.s?(l.i=d.D.concat(l.i),!0):l.G==1||l.G==2||l.B>=(l.Va?0:l.Wa)?!1:(l.s=Oi(p(l.Ga,l,d),Hf(l,l.B)),l.B++,!0)}t.Ga=function(l){if(this.s)if(this.s=null,this.G==1){if(!l){this.U=Math.floor(1e5*Math.random()),l=this.U++;const L=new Er(this,this.j,l);let U=this.o;if(this.S&&(U?(U=v(U),b(U,this.S)):U=this.S),this.m!==null||this.O||(L.H=U,U=null),this.P)e:{for(var d=0,g=0;g<this.i.length;g++){t:{var E=this.i[g];if("__data__"in E.map&&(E=E.map.__data__,typeof E=="string")){E=E.length;break t}E=void 0}if(E===void 0)break;if(d+=E,4096<d){d=g;break e}if(d===4096||g===this.i.length-1){d=g+1;break e}}d=1e3}else d=1e3;d=$f(this,L,d),g=jn(this.I),Qe(g,"RID",l),Qe(g,"CVER",22),this.D&&Qe(g,"X-HTTP-Session-Id",this.D),Bi(this,g),U&&(this.O?d="headers="+encodeURIComponent(String(Df(U)))+"&"+d:this.m&&Vc(g,this.m,U)),Nc(this.h,L),this.Ua&&Qe(g,"TYPE","init"),this.P?(Qe(g,"$req",d),Qe(g,"SID","null"),L.T=!0,Dc(L,g,null)):Dc(L,g,d),this.G=2}}else this.G==3&&(l?Ff(this,l):this.i.length==0||_f(this.h)||Ff(this))};function Ff(l,d){var g;d?g=d.l:g=l.U++;const E=jn(l.I);Qe(E,"SID",l.K),Qe(E,"RID",g),Qe(E,"AID",l.T),Bi(l,E),l.m&&l.o&&Vc(E,l.m,l.o),g=new Er(l,l.j,g,l.B+1),l.m===null&&(g.H=l.o),d&&(l.i=d.D.concat(l.i)),d=$f(l,g,1e3),g.I=Math.round(.5*l.wa)+Math.round(.5*l.wa*Math.random()),Nc(l.h,g),Dc(g,E,d)}function Bi(l,d){l.H&&q(l.H,function(g,E){Qe(d,E,g)}),l.l&&bf({},function(g,E){Qe(d,E,g)})}function $f(l,d,g){g=Math.min(l.i.length,g);var E=l.l?p(l.l.Na,l.l,l):null;e:{var L=l.i;let U=-1;for(;;){const ee=["count="+g];U==-1?0<g?(U=L[0].g,ee.push("ofs="+U)):U=0:ee.push("ofs="+U);let ze=!0;for(let wt=0;wt<g;wt++){let $e=L[wt].g;const Pt=L[wt].map;if($e-=U,0>$e)U=Math.max(0,L[wt].g-100),ze=!1;else try{pw(Pt,ee,"req"+$e+"_")}catch{E&&E(Pt)}}if(ze){E=ee.join("&");break e}}}return l=l.i.splice(0,g),d.D=l,E}function Uf(l){if(!l.g&&!l.u){l.Y=1;var d=l.Fa;me||fn(),Se||(me(),Se=!0),Lt.add(d,l),l.v=0}}function Lc(l){return l.g||l.u||3<=l.v?!1:(l.Y++,l.u=Oi(p(l.Fa,l),Hf(l,l.v)),l.v++,!0)}t.Fa=function(){if(this.u=null,Bf(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var l=2*this.R;this.j.info("BP detection timer enabled: "+l),this.A=Oi(p(this.ab,this),l)}},t.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Ft(10),wa(this),Bf(this))};function Fc(l){l.A!=null&&(a.clearTimeout(l.A),l.A=null)}function Bf(l){l.g=new Er(l,l.j,"rpc",l.Y),l.m===null&&(l.g.H=l.o),l.g.O=0;var d=jn(l.qa);Qe(d,"RID","rpc"),Qe(d,"SID",l.K),Qe(d,"AID",l.T),Qe(d,"CI",l.F?"0":"1"),!l.F&&l.ja&&Qe(d,"TO",l.ja),Qe(d,"TYPE","xmlhttp"),Bi(l,d),l.m&&l.o&&Vc(d,l.m,l.o),l.L&&(l.g.I=l.L);var g=l.g;l=l.ia,g.L=1,g.v=ya(jn(d)),g.m=null,g.P=!0,pf(g,l)}t.Za=function(){this.C!=null&&(this.C=null,wa(this),Lc(this),Ft(19))};function Ta(l){l.C!=null&&(a.clearTimeout(l.C),l.C=null)}function jf(l,d){var g=null;if(l.g==d){Ta(l),Fc(l),l.g=null;var E=2}else if(xc(l.h,d))g=d.D,Ef(l.h,d),E=1;else return;if(l.G!=0){if(d.o)if(E==1){g=d.m?d.m.length:0,d=Date.now()-d.F;var L=l.B;E=ha(),Te(E,new uf(E,g)),ba(l)}else Uf(l);else if(L=d.s,L==3||L==0&&0<d.X||!(E==1&&_w(l,d)||E==2&&Lc(l)))switch(g&&0<g.length&&(d=l.h,d.i=d.i.concat(g)),L){case 1:cs(l,5);break;case 4:cs(l,10);break;case 3:cs(l,6);break;default:cs(l,2)}}}function Hf(l,d){let g=l.Ta+Math.floor(Math.random()*l.cb);return l.isActive()||(g*=2),g*d}function cs(l,d){if(l.j.info("Error code "+d),d==2){var g=p(l.fb,l),E=l.Xa;const L=!E;E=new ls(E||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||ma(E,"https"),ya(E),L?hw(E.toString(),g):dw(E.toString(),g)}else Ft(2);l.G=0,l.l&&l.l.sa(d),qf(l),Lf(l)}t.fb=function(l){l?(this.j.info("Successfully pinged google.com"),Ft(2)):(this.j.info("Failed to ping google.com"),Ft(1))};function qf(l){if(l.G=0,l.ka=[],l.l){const d=wf(l.h);(d.length!=0||l.i.length!=0)&&(V(l.ka,d),V(l.ka,l.i),l.h.i.length=0,O(l.i),l.i.length=0),l.l.ra()}}function zf(l,d,g){var E=g instanceof ls?jn(g):new ls(g);if(E.g!="")d&&(E.g=d+"."+E.g),ga(E,E.s);else{var L=a.location;E=L.protocol,d=d?d+"."+L.hostname:L.hostname,L=+L.port;var U=new ls(null);E&&ma(U,E),d&&(U.g=d),L&&ga(U,L),g&&(U.l=g),E=U}return g=l.D,d=l.ya,g&&d&&Qe(E,g,d),Qe(E,"VER",l.la),Bi(l,E),E}function Wf(l,d,g){if(d&&!l.J)throw Error("Can't create secondary domain capable XhrIo object.");return d=l.Ca&&!l.pa?new nt(new _a({eb:g})):new nt(l.pa),d.Ha(l.J),d}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function Gf(){}t=Gf.prototype,t.ua=function(){},t.ta=function(){},t.sa=function(){},t.ra=function(){},t.isActive=function(){return!0},t.Na=function(){};function Ia(){}Ia.prototype.g=function(l,d){return new Kt(l,d)};function Kt(l,d){pe.call(this),this.g=new Mf(d),this.l=l,this.h=d&&d.messageUrlParams||null,l=d&&d.messageHeaders||null,d&&d.clientProtocolHeaderRequired&&(l?l["X-Client-Protocol"]="webchannel":l={"X-Client-Protocol":"webchannel"}),this.g.o=l,l=d&&d.initMessageHeaders||null,d&&d.messageContentType&&(l?l["X-WebChannel-Content-Type"]=d.messageContentType:l={"X-WebChannel-Content-Type":d.messageContentType}),d&&d.va&&(l?l["X-WebChannel-Client-Profile"]=d.va:l={"X-WebChannel-Client-Profile":d.va}),this.g.S=l,(l=d&&d.Sb)&&!k(l)&&(this.g.m=l),this.v=d&&d.supportsCrossDomainXhr||!1,this.u=d&&d.sendRawJson||!1,(d=d&&d.httpSessionIdParam)&&!k(d)&&(this.g.D=d,l=this.h,l!==null&&d in l&&(l=this.h,d in l&&delete l[d])),this.j=new Us(this)}D(Kt,pe),Kt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Kt.prototype.close=function(){Mc(this.g)},Kt.prototype.o=function(l){var d=this.g;if(typeof l=="string"){var g={};g.__data__=l,l=g}else this.u&&(g={},g.__data__=Et(l),l=g);d.i.push(new tw(d.Ya++,l)),d.G==3&&ba(d)},Kt.prototype.N=function(){this.g.l=null,delete this.j,Mc(this.g),delete this.g,Kt.aa.N.call(this)};function Kf(l){Sc.call(this),l.__headers__&&(this.headers=l.__headers__,this.statusCode=l.__status__,delete l.__headers__,delete l.__status__);var d=l.__sm__;if(d){e:{for(const g in d){l=g;break e}l=void 0}(this.i=l)&&(l=this.i,d=d!==null&&l in d?d[l]:void 0),this.data=d}else this.data=l}D(Kf,Sc);function Yf(){Pc.call(this),this.status=1}D(Yf,Pc);function Us(l){this.g=l}D(Us,Gf),Us.prototype.ua=function(){Te(this.g,"a")},Us.prototype.ta=function(l){Te(this.g,new Kf(l))},Us.prototype.sa=function(l){Te(this.g,new Yf)},Us.prototype.ra=function(){Te(this.g,"b")},Ia.prototype.createWebChannel=Ia.prototype.g,Kt.prototype.send=Kt.prototype.o,Kt.prototype.open=Kt.prototype.m,Kt.prototype.close=Kt.prototype.close,Mv=function(){return new Ia},Vv=function(){return ha()},Nv=os,zu={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},da.NO_ERROR=0,da.TIMEOUT=8,da.HTTP_ERROR=6,Ka=da,hf.COMPLETE="complete",xv=hf,of.EventType=Di,Di.OPEN="a",Di.CLOSE="b",Di.ERROR="c",Di.MESSAGE="d",pe.prototype.listen=pe.prototype.K,Qi=of,nt.prototype.listenOnce=nt.prototype.L,nt.prototype.getLastError=nt.prototype.Ka,nt.prototype.getLastErrorCode=nt.prototype.Ba,nt.prototype.getStatus=nt.prototype.Z,nt.prototype.getResponseJson=nt.prototype.Oa,nt.prototype.getResponseText=nt.prototype.oa,nt.prototype.send=nt.prototype.ea,nt.prototype.setWithCredentials=nt.prototype.Ha,Ov=nt}).apply(typeof ka<"u"?ka:typeof self<"u"?self:typeof window<"u"?window:{});const km="@firebase/firestore",Om="4.8.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fm=-62135596800,$m=1e6;class Oe{static now(){return Oe.fromMillis(Date.now())}static fromDate(e){return Oe.fromMillis(e.getTime())}static fromMillis(e){const n=Math.floor(e/1e3),r=Math.floor((e-1e3*n)*$m);return new Oe(n,r)}constructor(e,n){if(this.seconds=e,this.nanoseconds=n,n<0)throw new re(B.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(n>=1e9)throw new re(B.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(e<Fm)throw new re(B.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new re(B.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/$m}_compareTo(e){return this.seconds===e.seconds?Re(this.nanoseconds,e.nanoseconds):Re(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:Oe._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(Zo(e,Oe._jsonSchema))return new Oe(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-Fm;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}Oe._jsonSchemaVersion="firestore/timestamp/1.0",Oe._jsonSchema={type:ht("string",Oe._jsonSchemaVersion),seconds:ht("number"),nanoseconds:ht("number")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KC=new tt(de.comparator);function lr(){return KC}const aE=new tt(de.comparator);function Ji(...t){let e=aE;for(const n of t)e=e.insert(n.key,n);return e}function lE(t){let e=aE;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function _s(){return yo()}function cE(){return yo()}function yo(){return new Ns(t=>t.toString(),(t,e)=>t.isEqual(e))}const YC=new tt(de.comparator),QC=new ft(de.comparator);function Ne(...t){let e=QC;for(const n of t)e=e.add(n);return e}const JC=new ft(Re);function XC(){return JC}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BR{constructor(e,n,r,s){this.remoteDocumentCache=e,this.mutationQueue=n,this.documentOverlayCache=r,this.indexManager=s}getDocument(e,n){let r=null;return this.documentOverlayCache.getOverlay(e,n).next(s=>(r=s,this.remoteDocumentCache.getEntry(e,n))).next(s=>(r!==null&&_o(r.mutation,s,Zt.empty(),Oe.now()),s))}getDocuments(e,n){return this.remoteDocumentCache.getEntries(e,n).next(r=>this.getLocalViewOfDocuments(e,r,Ne()).next(()=>r))}getLocalViewOfDocuments(e,n,r=Ne()){const s=_s();return this.populateOverlays(e,s,n).next(()=>this.computeViews(e,n,s,r).next(i=>{let o=Ji();return i.forEach((a,c)=>{o=o.insert(a,c.overlayedDocument)}),o}))}getOverlayedDocuments(e,n){const r=_s();return this.populateOverlays(e,r,n).next(()=>this.computeViews(e,n,r,Ne()))}populateOverlays(e,n,r){const s=[];return r.forEach(i=>{n.has(i)||s.push(i)}),this.documentOverlayCache.getOverlays(e,s).next(i=>{i.forEach((o,a)=>{n.set(o,a)})})}computeViews(e,n,r,s){let i=lr();const o=yo(),a=function(){return yo()}();return n.forEach((c,u)=>{const h=r.get(u.key);s.has(u.key)&&(h===void 0||h.mutation instanceof ss)?i=i.insert(u.key,u):h!==void 0?(o.set(u.key,h.mutation.getFieldMask()),_o(h.mutation,u,h.mutation.getFieldMask(),Oe.now())):o.set(u.key,Zt.empty())}),this.recalculateAndSaveOverlays(e,i).next(c=>(c.forEach((u,h)=>o.set(u,h)),n.forEach((u,h)=>{var f;return a.set(u,new UR(h,(f=o.get(u))!==null&&f!==void 0?f:null))}),a))}recalculateAndSaveOverlays(e,n){const r=yo();let s=new tt((o,a)=>o-a),i=Ne();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,n).next(o=>{for(const a of o)a.keys().forEach(c=>{const u=n.get(c);if(u===null)return;let h=r.get(c)||Zt.empty();h=a.applyToLocalView(u,h),r.set(c,h);const f=(s.get(a.batchId)||Ne()).add(c);s=s.insert(a.batchId,f)})}).next(()=>{const o=[],a=s.getReverseIterator();for(;a.hasNext();){const c=a.getNext(),u=c.key,h=c.value,f=cE();h.forEach(p=>{if(!i.has(p)){const y=mE(n.get(p),r.get(p));y!==null&&f.set(p,y),i=i.add(p)}}),o.push(this.documentOverlayCache.saveOverlays(e,u,f))}return W.waitFor(o)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,n){return this.remoteDocumentCache.getEntries(e,n).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,n,r,s){return function(o){return de.isDocumentKey(o.path)&&o.collectionGroup===null&&o.filters.length===0}(n)?this.getDocumentsMatchingDocumentQuery(e,n.path):sE(n)?this.getDocumentsMatchingCollectionGroupQuery(e,n,r,s):this.getDocumentsMatchingCollectionQuery(e,n,r,s)}getNextDocuments(e,n,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,n,r,s).next(i=>{const o=s-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,n,r.largestBatchId,s-i.size):W.resolve(_s());let a=No,c=i;return o.next(u=>W.forEach(u,(h,f)=>(a<f.largestBatchId&&(a=f.largestBatchId),i.get(h)?W.resolve():this.remoteDocumentCache.getEntry(e,h).next(p=>{c=c.insert(h,p)}))).next(()=>this.populateOverlays(e,u,i)).next(()=>this.computeViews(e,c,u,Ne())).next(h=>({batchId:a,changes:lE(h)})))})}getDocumentsMatchingDocumentQuery(e,n){return this.getDocument(e,new de(n)).next(r=>{let s=Ji();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(e,n,r,s){const i=n.collectionGroup;let o=Ji();return this.indexManager.getCollectionParents(e,i).next(a=>W.forEach(a,c=>{const u=function(f,p){return new Si(p,null,f.explicitOrderBy.slice(),f.filters.slice(),f.limit,f.limitType,f.startAt,f.endAt)}(n,c.child(i));return this.getDocumentsMatchingCollectionQuery(e,u,r,s).next(h=>{h.forEach((f,p)=>{o=o.insert(f,p)})})}).next(()=>o))}getDocumentsMatchingCollectionQuery(e,n,r,s){let i;return this.documentOverlayCache.getOverlaysForCollection(e,n.path,r.largestBatchId).next(o=>(i=o,this.remoteDocumentCache.getDocumentsMatchingQuery(e,n,r,i,s))).next(o=>{i.forEach((c,u)=>{const h=u.getKey();o.get(h)===null&&(o=o.insert(h,Nt.newInvalidDocument(h)))});let a=Ji();return o.forEach((c,u)=>{const h=i.get(c);h!==void 0&&_o(h.mutation,u,Zt.empty(),Oe.now()),ac(n,u)&&(a=a.insert(c,u))}),a})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HR{constructor(){this.overlays=new tt(de.comparator),this.kr=new Map}getOverlay(e,n){return W.resolve(this.overlays.get(n))}getOverlays(e,n){const r=_s();return W.forEach(n,s=>this.getOverlay(e,s).next(i=>{i!==null&&r.set(s,i)})).next(()=>r)}saveOverlays(e,n,r){return r.forEach((s,i)=>{this.wt(e,n,i)}),W.resolve()}removeOverlaysForBatchId(e,n,r){const s=this.kr.get(r);return s!==void 0&&(s.forEach(i=>this.overlays=this.overlays.remove(i)),this.kr.delete(r)),W.resolve()}getOverlaysForCollection(e,n,r){const s=_s(),i=n.length+1,o=new de(n.child("")),a=this.overlays.getIteratorFrom(o);for(;a.hasNext();){const c=a.getNext().value,u=c.getKey();if(!n.isPrefixOf(u.path))break;u.path.length===i&&c.largestBatchId>r&&s.set(c.getKey(),c)}return W.resolve(s)}getOverlaysForCollectionGroup(e,n,r,s){let i=new tt((u,h)=>u-h);const o=this.overlays.getIterator();for(;o.hasNext();){const u=o.getNext().value;if(u.getKey().getCollectionGroup()===n&&u.largestBatchId>r){let h=i.get(u.largestBatchId);h===null&&(h=_s(),i=i.insert(u.largestBatchId,h)),h.set(u.getKey(),u)}}const a=_s(),c=i.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach((u,h)=>a.set(u,h)),!(a.size()>=s)););return W.resolve(a)}wt(e,n,r){const s=this.overlays.get(r.key);if(s!==null){const o=this.kr.get(s.largestBatchId).delete(r.key);this.kr.set(s.largestBatchId,o)}this.overlays=this.overlays.insert(r.key,new lR(n,r));let i=this.kr.get(n);i===void 0&&(i=Ne(),this.kr.set(n,i)),this.kr.set(n,i.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zR{constructor(e,n){this.indexManager=e,this.referenceDelegate=n,this.mutationQueue=[],this.er=1,this.Yr=new ft(pt.Qr)}checkEmpty(e){return W.resolve(this.mutationQueue.length===0)}addMutationBatch(e,n,r,s){const i=this.er;this.er++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new aR(i,n,r,s);this.mutationQueue.push(o);for(const a of s)this.Yr=this.Yr.add(new pt(a.key,i)),this.indexManager.addToCollectionParentIndex(e,a.key.path.popLast());return W.resolve(o)}lookupMutationBatch(e,n){return W.resolve(this.Zr(n))}getNextMutationBatchAfterBatchId(e,n){const r=n+1,s=this.Xr(r),i=s<0?0:s;return W.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return W.resolve(this.mutationQueue.length===0?fd:this.er-1)}getAllMutationBatches(e){return W.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,n){const r=new pt(n,0),s=new pt(n,Number.POSITIVE_INFINITY),i=[];return this.Yr.forEachInRange([r,s],o=>{const a=this.Zr(o.Hr);i.push(a)}),W.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,n){let r=new ft(Re);return n.forEach(s=>{const i=new pt(s,0),o=new pt(s,Number.POSITIVE_INFINITY);this.Yr.forEachInRange([i,o],a=>{r=r.add(a.Hr)})}),W.resolve(this.ei(r))}getAllMutationBatchesAffectingQuery(e,n){const r=n.path,s=r.length+1;let i=r;de.isDocumentKey(i)||(i=i.child(""));const o=new pt(new de(i),0);let a=new ft(Re);return this.Yr.forEachWhile(c=>{const u=c.key.path;return!!r.isPrefixOf(u)&&(u.length===s&&(a=a.add(c.Hr)),!0)},o),W.resolve(this.ei(a))}ei(e){const n=[];return e.forEach(r=>{const s=this.Zr(r);s!==null&&n.push(s)}),n}removeMutationBatch(e,n){He(this.ti(n.batchId,"removed")===0,55003),this.mutationQueue.shift();let r=this.Yr;return W.forEach(n.mutations,s=>{const i=new pt(s.key,n.batchId);return r=r.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,s.key)}).next(()=>{this.Yr=r})}rr(e){}containsKey(e,n){const r=new pt(n,0),s=this.Yr.firstAfterOrEqual(r);return W.resolve(n.isEqual(s&&s.key))}performConsistencyCheck(e){return this.mutationQueue.length,W.resolve()}ti(e,n){return this.Xr(e)}Xr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Zr(e){const n=this.Xr(e);return n<0||n>=this.mutationQueue.length?null:this.mutationQueue[n]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class JR{constructor(){this.As=!1,this.Rs=!1,this.Vs=100,this.fs=function(){return II()?8:AC(Vt())>0?6:4}()}initialize(e,n){this.gs=e,this.indexManager=n,this.As=!0}getDocumentsMatchingQuery(e,n,r,s){const i={result:null};return this.ps(e,n).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.ys(e,n,s,r).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new QR;return this.ws(e,n,o).next(a=>{if(i.result=a,this.Rs)return this.Ss(e,n,o,a.size)})}).next(()=>i.result)}Ss(e,n,r,s){return r.documentReadCount<this.Vs?(Ws()<=xe.DEBUG&&ie("QueryEngine","SDK will not create cache indexes for query:",Gs(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),W.resolve()):(Ws()<=xe.DEBUG&&ie("QueryEngine","Query:",Gs(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.fs*s?(Ws()<=xe.DEBUG&&ie("QueryEngine","The SDK decides to create cache indexes for query:",Gs(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Vn(n))):W.resolve())}ps(e,n){if(Jm(n))return W.resolve(null);let r=Vn(n);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(n.limit!==null&&s===1&&(n=Xu(n,null,"F"),r=Vn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const o=Ne(...i);return this.gs.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,r).next(c=>{const u=this.bs(n,a);return this.Ds(n,u,o,c.readTime)?this.ps(e,Xu(n,null,"F")):this.vs(e,u,n,c)}))})))}ys(e,n,r,s){return Jm(n)||s.isEqual(Ee.min())?W.resolve(null):this.gs.getDocuments(e,r).next(i=>{const o=this.bs(n,i);return this.Ds(n,o,r,s)?W.resolve(null):(Ws()<=xe.DEBUG&&ie("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Gs(n)),this.vs(e,o,n,EC(s,No)).next(a=>a))})}bs(e,n){let r=new ft(oE(e));return n.forEach((s,i)=>{ac(e,i)&&(r=r.add(i))}),r}Ds(e,n,r,s){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}ws(e,n,r){return Ws()<=xe.DEBUG&&ie("QueryEngine","Using full collection scan to execute query:",Gs(n)),this.gs.getDocumentsMatchingQuery(e,n,Kr.min(),r)}vs(e,n,r,s){return this.gs.getDocumentsMatchingQuery(e,r,s).next(i=>(n.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rt="WebChannelConnection";class dD extends uD{constructor(e){super(e),this.u_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}jo(e,n,r,s,i){const o=sh();return new Promise((a,c)=>{const u=new Ov;u.setWithCredentials(!0),u.listenOnce(xv.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case Ka.NO_ERROR:const f=u.getResponseJson();ie(Rt,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(f)),a(f);break;case Ka.TIMEOUT:ie(Rt,`RPC '${e}' ${o} timed out`),c(new re(B.DEADLINE_EXCEEDED,"Request time out"));break;case Ka.HTTP_ERROR:const p=u.getStatus();if(ie(Rt,`RPC '${e}' ${o} failed with status:`,p,"response text:",u.getResponseText()),p>0){let y=u.getResponseJson();Array.isArray(y)&&(y=y[0]);const D=y?.error;if(D&&D.status&&D.message){const O=function(M){const k=M.toLowerCase().replace(/_/g,"-");return Object.values(B).indexOf(k)>=0?k:B.UNKNOWN}(D.status);c(new re(O,D.message))}else c(new re(B.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new re(B.UNAVAILABLE,"Connection failed."));break;default:ye(9055,{c_:e,streamId:o,l_:u.getLastErrorCode(),h_:u.getLastError()})}}finally{ie(Rt,`RPC '${e}' ${o} completed.`)}});const h=JSON.stringify(s);ie(Rt,`RPC '${e}' ${o} sending request:`,s),u.send(n,"POST",h,r,15)})}P_(e,n,r){const s=sh(),i=[this.$o,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=Mv(),a=Vv(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(c.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(c.useFetchStreams=!0),this.zo(c.initMessageHeaders,n,r),c.encodeInitMessageHeaders=!0;const h=i.join("");ie(Rt,`Creating RPC '${e}' stream ${s}: ${h}`,c);const f=o.createWebChannel(h,c);this.T_(f);let p=!1,y=!1;const D=new hD({Ho:V=>{y?ie(Rt,`Not sending because RPC '${e}' stream ${s} is closed:`,V):(p||(ie(Rt,`Opening RPC '${e}' stream ${s} transport.`),f.open(),p=!0),ie(Rt,`RPC '${e}' stream ${s} sending:`,V),f.send(V))},Yo:()=>f.close()}),O=(V,M,k)=>{V.listen(M,x=>{try{k(x)}catch($){setTimeout(()=>{throw $},0)}})};return O(f,Qi.EventType.OPEN,()=>{y||(ie(Rt,`RPC '${e}' stream ${s} transport opened.`),D.s_())}),O(f,Qi.EventType.CLOSE,()=>{y||(y=!0,ie(Rt,`RPC '${e}' stream ${s} transport closed`),D.__(),this.I_(f))}),O(f,Qi.EventType.ERROR,V=>{y||(y=!0,Gr(Rt,`RPC '${e}' stream ${s} transport errored. Name:`,V.name,"Message:",V.message),D.__(new re(B.UNAVAILABLE,"The operation could not be completed")))}),O(f,Qi.EventType.MESSAGE,V=>{var M;if(!y){const k=V.data[0];He(!!k,16349);const x=k,$=x?.error||((M=x[0])===null||M===void 0?void 0:M.error);if($){ie(Rt,`RPC '${e}' stream ${s} received error:`,$);const F=$.status;let q=function(w){const b=ct[w];if(b!==void 0)return yE(b)}(F),S=$.message;q===void 0&&(q=B.INTERNAL,S="Unknown error status: "+F+" with message "+$.message),y=!0,D.__(new re(q,S)),f.close()}else ie(Rt,`RPC '${e}' stream ${s} received:`,k),D.a_(k)}}),O(a,Nv.STAT_EVENT,V=>{V.stat===zu.PROXY?ie(Rt,`RPC '${e}' stream ${s} detected buffering proxy`):V.stat===zu.NOPROXY&&ie(Rt,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{D.o_()},0),D}terminate(){this.u_.forEach(e=>e.close()),this.u_=[]}T_(e){this.u_.push(e)}I_(e){this.u_=this.u_.filter(n=>n===e)}}function uu(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DD{constructor(){this.ya=void 0,this.wa=[]}Sa(){return this.wa.some(e=>e.ba())}}class kD{constructor(){this.queries=yg(),this.onlineState="Unknown",this.Da=new Set}terminate(){(function(n,r){const s=be(n),i=s.queries;s.queries=yg(),i.forEach((o,a)=>{for(const c of a.wa)c.onError(r)})})(this,new re(B.ABORTED,"Firestore shutting down"))}}function yg(){return new Ns(t=>iE(t),oc)}async function $E(t,e){const n=be(t);let r=3;const s=e.query;let i=n.queries.get(s);i?!i.Sa()&&e.ba()&&(r=2):(i=new DD,r=e.ba()?0:1);try{switch(r){case 0:i.ya=await n.onListen(s,!0);break;case 1:i.ya=await n.onListen(s,!1);break;case 2:await n.onFirstRemoteStoreListen(s)}}catch(o){const a=Od(o,`Initialization of query '${Gs(e.query)}' failed`);return void e.onError(a)}n.queries.set(s,i),i.wa.push(e),e.va(n.onlineState),i.ya&&e.Ca(i.ya)&&xd(n)}async function UE(t,e){const n=be(t),r=e.query;let s=3;const i=n.queries.get(r);if(i){const o=i.wa.indexOf(e);o>=0&&(i.wa.splice(o,1),i.wa.length===0?s=e.ba()?0:1:!i.Sa()&&e.ba()&&(s=2))}switch(s){case 0:return n.queries.delete(r),n.onUnlisten(r,!0);case 1:return n.queries.delete(r),n.onUnlisten(r,!1);case 2:return n.onLastRemoteStoreUnlisten(r);default:return}}function OD(t,e){const n=be(t);let r=!1;for(const s of e){const i=s.query,o=n.queries.get(i);if(o){for(const a of o.wa)a.Ca(s)&&(r=!0);o.ya=s}}r&&xd(n)}function xD(t,e,n){const r=be(t),s=r.queries.get(e);if(s)for(const i of s.wa)i.onError(n);r.queries.delete(e)}function xd(t){t.Da.forEach(e=>{e.next()})}var ih,_g;(_g=ih||(ih={})).Fa="default",_g.Cache="cache";class BE{constructor(e,n,r){this.query=e,this.Ma=n,this.xa=!1,this.Oa=null,this.onlineState="Unknown",this.options=r||{}}Ca(e){if(!this.options.includeMetadataChanges){const r=[];for(const s of e.docChanges)s.type!==3&&r.push(s);e=new gi(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let n=!1;return this.xa?this.Na(e)&&(this.Ma.next(e),n=!0):this.Ba(e,this.onlineState)&&(this.La(e),n=!0),this.Oa=e,n}onError(e){this.Ma.error(e)}va(e){this.onlineState=e;let n=!1;return this.Oa&&!this.xa&&this.Ba(this.Oa,e)&&(this.La(this.Oa),n=!0),n}Ba(e,n){if(!e.fromCache||!this.ba())return!0;const r=n!=="Offline";return(!this.options.ka||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||n==="Offline")}Na(e){if(e.docChanges.length>0)return!0;const n=this.Oa&&this.Oa.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}La(e){e=gi.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.xa=!0,this.Ma.next(e)}ba(){return this.options.source!==ih.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
Respond ONLY with valid JSON in ${i.value==="en"?"English":"Arabic"}.`,De={type:"OBJECT",properties:{recommendationText:{type:"STRING"},patientCalculatedMsv:{type:"NUMBER"},Warning:{type:"STRING"}},required:["recommendationText","patientCalculatedMsv","Warning"]});try{const Se=await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyB9KAR0P6sxAj7fP2I-MyVSVOJJaW0J91M",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:[{text:A}]}],generationConfig:{responseMimeType:"application/json",responseSchema:De}})});if(!Se.ok)throw new Error(`API Error: ${Se.statusText}`);const Lt=await Se.json();y.value=JSON.parse(Lt.candidates[0].content.parts[0].text)}catch(qe){console.error("Error getting recommendation:",qe),D.value=i.value==="en"?`An error occurred: ${qe.message}`:`حدث خطأ: ${qe.message}`}finally{f.value=!1}};return(b,T)=>(G(),Y("div",{class:"recommend-page",dir:_(i)==="ar"?"rtl":"ltr"},[m("main",eN,[m("section",tN,[m("h2",null,C(_(i)==="en"?"Medical Scan Recommendation":"توصية الفحص الطبي"),1),m("p",null,C(_(i)==="en"?"Get an AI-powered recommendation based on patient details and radiation safety principles.":"احصل على توصية مدعومة بالذكاء الاصطناعي بناءً على تفاصيل المريض ومبادئ السلامة من الإشعاع."),1),m("div",nN,[m("button",{class:Ts({active:u.value==="personal"}),onClick:T[0]||(T[0]=I=>u.value="personal")},C(_(i)==="en"?"For Myself":"لنفسي"),3),O.value==="doctor"?(G(),Y("button",{key:0,class:Ts({active:u.value==="general"}),onClick:T[1]||(T[1]=I=>u.value="general")},C(_(i)==="en"?"For Another Patient":"لمريض آخر"),3)):ve("",!0)]),p.value?(G(),Y("div",rN,[m("span",null,C(_(i)==="en"?"Loading Patient Data...":"جاري تحميل بيانات المريض..."),1)])):ve("",!0),h.value.patientId&&h.value.patientName?(G(),Y("div",sN,[Ot(C(_(i)==="en"?"Getting recommendation for:":"الحصول على توصية لـ:")+" ",1),m("strong",null,C(h.value.patientName),1)])):ve("",!0),m("form",{onSubmit:et(w,["prevent"]),class:"recommend-form"},[m("div",iN,[m("label",null,[Ot(C(_(i)==="en"?"Date of Birth":"تاريخ الميلاد")+" ",1),T[13]||(T[13]=m("span",{class:"required-indicator"},"*",-1))]),fe(m("input",{type:"date","onUpdate:modelValue":T[2]||(T[2]=I=>h.value.birthDate=I),disabled:u.value==="personal",required:""},null,8,oN),[[ke,h.value.birthDate]])]),m("div",aN,[m("label",null,[Ot(C(_(i)==="en"?"Gender":"الجنس")+" ",1),T[14]||(T[14]=m("span",{class:"required-indicator"},"*",-1))]),fe(m("select",{"onUpdate:modelValue":T[3]||(T[3]=I=>h.value.gender=I),disabled:u.value==="personal",required:""},[m("option",cN,C(_(i)==="en"?"Male":"ذكر"),1),m("option",uN,C(_(i)==="en"?"Female":"أنثى"),1)],8,lN),[[cn,h.value.gender]])]),h.value.gender==="female"?(G(),Y("div",hN,[m("div",dN,[m("label",null,[fe(m("input",{type:"checkbox","onUpdate:modelValue":T[4]||(T[4]=I=>h.value.isPregnant=I),disabled:u.value==="personal"},null,8,fN),[[Kl,h.value.isPregnant]]),m("span",null,C(_(i)==="en"?"Is Pregnant?":"هل هي حامل؟"),1)])]),h.value.isPregnant?(G(),Y("div",pN,[m("label",null,[Ot(C(_(i)==="en"?"Estimated Due Date":"تاريخ الولادة المتوقع")+" ",1),T[15]||(T[15]=m("span",{class:"required-indicator"},"*",-1))]),fe(m("input",{type:"date","onUpdate:modelValue":T[5]||(T[5]=I=>h.value.estimatedDueDate=I),disabled:u.value==="personal",required:""},null,8,mN),[[ke,h.value.estimatedDueDate]])])):ve("",!0)])):ve("",!0),m("div",gN,[m("label",null,C(_(i)==="en"?"Relevant Medical History":"التاريخ الطبي ذو الصلة"),1),fe(m("textarea",{"onUpdate:modelValue":T[6]||(T[6]=I=>h.value.medicalHistory=I),rows:"3",disabled:u.value==="personal"},null,8,yN),[[ke,h.value.medicalHistory]])]),m("div",_N,[m("label",null,C(_(i)==="en"?"Current Symptoms":"الأعراض الحالية"),1),fe(m("textarea",{"onUpdate:modelValue":T[7]||(T[7]=I=>h.value.currentSymptoms=I),rows:"3"},null,512),[[ke,h.value.currentSymptoms]])]),O.value==="doctor"&&u.value==="general"?(G(),Y("div",vN,[m("h3",EN,C(_(i)==="en"?"Occupational Exposure Context":"سياق التعرض المهني"),1),m("div",wN,[m("label",null,C(_(i)==="en"?"Your positioning, shielding, etc. (Optional)":"موقعك، التدريع المستخدم، إلخ (اختياري)"),1),fe(m("textarea",{"onUpdate:modelValue":T[8]||(T[8]=I=>h.value.doctorAdditionalContext=I),rows:"3"},null,512),[[ke,h.value.doctorAdditionalContext]])])])):ve("",!0),m("h3",bN,C(_(i)==="en"?"Scan to Consider":"الفحص المقترح"),1),m("div",TN,[m("div",IN,[m("label",null,[Ot(C(_(i)==="en"?"Scan Category":"فئة الفحص")+" ",1),T[16]||(T[16]=m("span",{class:"required-indicator"},"*",-1))]),fe(m("select",{"onUpdate:modelValue":T[9]||(T[9]=I=>h.value.scanType=I),required:""},[m("option",AN,C(_(i)==="en"?"CT Scan":"الأشعة المقطعية"),1),m("option",SN,C(_(i)==="en"?"X-ray":"الأشعة السينية"),1)],512),[[cn,h.value.scanType]])]),m("div",PN,[m("label",null,[Ot(C(_(i)==="en"?"Scan Protocol":"بروتوكول الفحص")+" ",1),T[17]||(T[17]=m("span",{class:"required-indicator"},"*",-1))]),fe(m("select",{"onUpdate:modelValue":T[10]||(T[10]=I=>h.value.subScanType=I),required:""},[m("option",CN,C(_(i)==="en"?"Select...":"اختر..."),1),(G(!0),Y(dt,null,vi(M.value,I=>(G(),Y("option",{key:I.value,value:I.value},C(_(i)==="en"?I.en:I.ar),9,RN))),128))],512),[[cn,h.value.subScanType]])])]),k.value?(G(),Y("div",DN,[m("label",null,[Ot(C(_(i)==="en"?"Please specify scan protocol":"يرجى تحديد بروتوكول الفحص")+" ",1),T[18]||(T[18]=m("span",{class:"required-indicator"},"*",-1))]),fe(m("input",{type:"text","onUpdate:modelValue":T[11]||(T[11]=I=>h.value.otherScanDescription=I),placeholder:_(i)==="en"?"e.g., Chest X-ray":"مثال: أشعة سينية للصدر",required:""},null,8,kN),[[ke,h.value.otherScanDescription]])])):ve("",!0),m("button",{type:"submit",disabled:f.value,class:"action-button"},C(f.value?_(i)==="en"?"Getting Recommendations...":"جاري الحصول على التوصيات...":_(i)==="en"?"Get Recommendation":"الحصول على توصية"),9,ON)],32),D.value?(G(),Y("div",xN,C(D.value),1)):ve("",!0),y.value?(G(),Y("div",NN,[y.value.Warning?(G(),Y("div",VN,[m("h4",null,C(_(i)==="en"?"Important Warning":"تحذير هام"),1),m("p",null,C(y.value.Warning),1)])):ve("",!0),m("div",MN,[m("h3",null,C(_(i)==="en"?"AI Powered Recommendation":"التوصية المدعومة بالذكاء الاصطناعي"),1),m("div",LN,[y.value.patientCalculatedMsv!==null?(G(),Y("div",FN,[m("h4",null,C(x.value),1),m("p",null,[m("strong",null,C(y.value.patientCalculatedMsv)+" mSv",1)])])):ve("",!0),F.value?(G(),Y("div",$N,[m("h4",null,C($.value),1),m("p",null,[m("strong",null,C(y.value.doctorOccupationalMsv)+" mSv",1)])])):ve("",!0)]),m("div",UN,[m("h4",null,C(_(i)==="en"?"Recommendation":"التوصية"),1),m("p",null,C(y.value.recommendationText),1)])])])):ve("",!0),m("p",BN,[m("a",{href:"#",onClick:T[12]||(T[12]=et(I=>_(e).push("/dashboard"),["prevent"]))},C(_(i)==="en"?"Back to Dashboard":"العودة إلى لوحة التحكم"),1)])])])],8,Zx))}},HN=yt(jN,[["__scopeId","data-v-52056665"]]),qN=["dir"],zN={class:"modal-title"},WN={class:"form-group"},GN={class:"form-group"},KN={class:"form-group"},YN={value:"male"},QN={value:"female"},JN={key:0,class:"pregnancy-section"},XN={class:"form-group checkbox-group"},ZN={key:0,class:"form-group"},e4={class:"form-group"},t4={class:"form-group"},n4={class:"modal-actions"},r4=["disabled"],s4={__name:"PatientFormModal",props:{show:Boolean,patient:Object,isSaving:Boolean},emits:["close","save"],setup(t,{emit:e}){const n=t,r=e,s=Ue("currentLanguage"),i=hr({id:null,name:"",birthDate:"",gender:"male",isPregnant:!1,estimatedDueDate:"",medicalHistory:"",allergies:""});rt(()=>n.show,a=>{a&&(n.patient?(i.id=n.patient.id,i.name=n.patient.name,i.gender=n.patient.gender,i.isPregnant=n.patient.isPregnant||!1,i.birthDate=n.patient.birthDate?.toDate?n.patient.birthDate.toDate().toISOString().split("T")[0]:"",i.estimatedDueDate=n.patient.estimatedDueDate?.toDate?n.patient.estimatedDueDate.toDate().toISOString().split("T")[0]:"",i.medicalHistory=Array.isArray(n.patient.medicalHistory)?n.patient.medicalHistory.join(", "):"",i.allergies=Array.isArray(n.patient.allergies)?n.patient.allergies.join(", "):""):Object.assign(i,{id:null,name:"",birthDate:"",gender:"male",isPregnant:!1,estimatedDueDate:"",medicalHistory:"",allergies:""}))},{immediate:!0}),rt(()=>i.isPregnant,a=>{a||(i.estimatedDueDate="")});const o=()=>{if(!i.name||!i.birthDate){alert("Name and Date of Birth are required.");return}if(i.isPregnant&&!i.estimatedDueDate){alert("Please provide the estimated due date for the pregnancy.");return}(i.gender==="male"||!i.isPregnant)&&(i.isPregnant=!1,i.estimatedDueDate=null);const a={...i,birthDate:new Date(i.birthDate),estimatedDueDate:i.estimatedDueDate?new Date(i.estimatedDueDate):null,medicalHistory:i.medicalHistory.split(",").map(c=>c.trim()).filter(Boolean),allergies:i.allergies.split(",").map(c=>c.trim()).filter(Boolean)};r("save",a)};return(a,c)=>(G(),bn(fr,{name:"modal-fade"},{default:vn(()=>[t.show?(G(),Y("div",{key:0,class:"modal-overlay",onClick:c[9]||(c[9]=et(u=>a.$emit("close"),["self"]))},[m("div",{class:"modal-content",dir:_(s)==="ar"?"rtl":"ltr"},[m("button",{onClick:c[0]||(c[0]=u=>a.$emit("close")),class:"close-button"},"×"),m("h3",zN,C(t.patient?"Edit Patient":"Add New Patient"),1),m("form",{onSubmit:et(o,["prevent"]),class:"patient-form"},[m("div",WN,[m("label",null,C(_(s)==="en"?"Name":"الاسم"),1),fe(m("input",{type:"text","onUpdate:modelValue":c[1]||(c[1]=u=>i.name=u),required:""},null,512),[[ke,i.name]])]),m("div",GN,[m("label",null,C(_(s)==="en"?"Date of Birth":"تاريخ الميلاد"),1),fe(m("input",{type:"date","onUpdate:modelValue":c[2]||(c[2]=u=>i.birthDate=u),required:""},null,512),[[ke,i.birthDate]])]),m("div",KN,[m("label",null,C(_(s)==="en"?"Gender":"الجنس"),1),fe(m("select",{"onUpdate:modelValue":c[3]||(c[3]=u=>i.gender=u)},[m("option",YN,C(_(s)==="en"?"Male":"ذكر"),1),m("option",QN,C(_(s)==="en"?"Female":"أنثى"),1)],512),[[cn,i.gender]])]),i.gender==="female"?(G(),Y("div",JN,[m("div",XN,[m("label",null,[fe(m("input",{type:"checkbox","onUpdate:modelValue":c[4]||(c[4]=u=>i.isPregnant=u)},null,512),[[Kl,i.isPregnant]]),m("span",null,C(_(s)==="en"?"Currently Pregnant?":"هل هي حامل حاليًا؟"),1)])]),i.isPregnant?(G(),Y("div",ZN,[m("label",null,C(_(s)==="en"?"Estimated Due Date":"تاريخ الولادة المتوقع"),1),fe(m("input",{type:"date","onUpdate:modelValue":c[5]||(c[5]=u=>i.estimatedDueDate=u),required:""},null,512),[[ke,i.estimatedDueDate]])])):ve("",!0)])):ve("",!0),m("div",e4,[m("label",null,C(_(s)==="en"?"Medical History (comma-separated)":"التاريخ الطبي"),1),fe(m("textarea",{"onUpdate:modelValue":c[6]||(c[6]=u=>i.medicalHistory=u),rows:"3"},null,512),[[ke,i.medicalHistory]])]),m("div",t4,[m("label",null,C(_(s)==="en"?"Allergies (comma-separated)":"الحساسية"),1),fe(m("textarea",{"onUpdate:modelValue":c[7]||(c[7]=u=>i.allergies=u),rows:"3"},null,512),[[ke,i.allergies]])]),m("div",n4,[m("button",{type:"submit",class:"action-button",disabled:t.isSaving},C(t.isSaving?"Saving...":"Save"),9,r4),m("button",{type:"button",onClick:c[8]||(c[8]=u=>a.$emit("close")),class:"action-button secondary"}," Cancel ")])],32)],8,qN)])):ve("",!0)]),_:1}))}},i4=yt(s4,[["__scopeId","data-v-6c2953db"]]),o4=["dir"],a4={key:0,class:"patient-context-display"},l4={key:0,class:"form-row pregnancy-section"},c4={class:"form-group checkbox-group"},u4={key:0,class:"form-group"},h4={class:"form-row"},d4={class:"form-group"},f4={value:"X-ray"},p4={value:"CT"},m4={class:"form-group"},g4={disabled:"",value:""},y4=["value"],_4={key:1,class:"form-group"},v4=["placeholder"],E4={class:"form-group"},w4={class:"form-row"},b4={class:"form-group"},T4={class:"form-group"},I4={class:"form-group"},A4={class:"form-group"},S4={class:"form-group"},P4={class:"modal-actions"},C4=["disabled"],R4={__name:"ScanFormModal",props:{show:Boolean,scan:Object,isSaving:Boolean,patient:{type:Object,default:null}},emits:["close","save"],setup(t,{emit:e}){console.log("[ScanFormModal] Script setup started.");const n=t,r=e,s=Ue("currentLanguage"),i={CT:[{value:"Abdomen & Pelvis",en:"Abdomen & Pelvis",ar:"البطن والحوض"},{value:"Brain with contrast",en:"Brain with contrast",ar:"الدماغ بمادة تباين"},{value:"Angiography CTA",en:"Angiography CTA",ar:"تصوير الأوعية CTA"},{value:"Urography",en:"Urography",ar:"تصوير المسالك البولية"},{value:"Enterography",en:"Enterography",ar:"تصوير الأمعاء"},{value:"Other",en:"Other...",ar:"أخرى..."}],"X-ray":[{value:"Barium Swallow",en:"Barium Swallow",ar:"بلع الباريوم"},{value:"Barium Meal",en:"Barium Meal",ar:"وجبة الباريوم"},{value:"Barium Enema",en:"Barium Enema",ar:"حقنة الباريوم الشرجية"},{value:"IV Urogram (IVP)",en:"IV Urogram (IVP)",ar:"أشعة المسالك البولية (IVP)"},{value:"HSG",en:"HSG",ar:"أشعة الرحم (HSG)"},{value:"VCUG",en:"VCUG",ar:"دراسة المثانة بالصبغة (VCUG)"},{value:"Other",en:"Other...",ar:"أخرى..."}]},o=()=>new Date().toISOString().split("T")[0],a=hr({id:null,isPregnant:!1,pregnancyMonth:null,scanType:"X-ray",subScanType:"",otherScanDescription:"",scanDate:o(),dose:null,doctorDose:null,reason:"",notes:"",doctorAdditionalContext:""}),c=Ae(()=>i[a.scanType]||[]),u=Ae(()=>a.subScanType==="Other");rt(()=>n.show,f=>{if(console.log(`[ScanFormModal] WATCH props.show changed to: ${f}`),f&&(console.log("[ScanFormModal] Props received -> patient:",JSON.parse(JSON.stringify(n.patient))),console.log("[ScanFormModal] Props received -> scan (for editing):",JSON.parse(JSON.stringify(n.scan))),Object.assign(a,{id:null,isPregnant:!1,pregnancyMonth:null,scanType:"X-ray",subScanType:"",otherScanDescription:"",scanDate:o(),dose:null,doctorDose:null,reason:"",notes:"",doctorAdditionalContext:""}),console.log("[ScanFormModal] Form reset to initial state."),n.scan)){console.log("[ScanFormModal] Populating form for editing..."),a.id=n.scan.id,a.isPregnant=n.scan.isPregnant||!1,a.pregnancyMonth=n.scan.pregnancyMonth||null,a.scanType=n.scan.scanType;const p=n.scan.scanDate?.toDate?n.scan.scanDate.toDate():new Date(n.scan.scanDate);a.scanDate=isNaN(p)?o():p.toISOString().split("T")[0],a.dose=n.scan.patientDose,a.doctorDose=n.scan.doctorDose,a.reason=n.scan.reason,a.notes=n.scan.notes,a.doctorAdditionalContext=n.scan.doctorAdditionalContext,console.log("[ScanFormModal] Form populated with scan data:",JSON.parse(JSON.stringify(a)))}}),rt(()=>a.scanDate,f=>{console.log(`[ScanFormModal] WATCH form.scanDate changed to: ${f}`)});const h=async()=>{if(console.log("%c[ScanFormModal] ==> handleSubmit called.","color: green; font-weight: bold;"),console.log("[ScanFormModal] Current form state before validation:",JSON.parse(JSON.stringify(a))),!a.scanDate||!a.subScanType){console.warn("[ScanFormModal] handleSubmit validation failed."),alert("Please fill all required scan details.");return}const f={id:a.id,isPregnant:a.isPregnant,pregnancyMonth:a.pregnancyMonth,scanType:a.scanType,scanDetail:a.subScanType==="Other"?a.otherScanDescription:a.subScanType,scanDate:a.scanDate,dose:a.dose,doctorDose:a.doctorDose,reason:a.reason,notes:a.notes,doctorAdditionalContext:a.doctorAdditionalContext};console.log("%c[ScanFormModal] Emitting @save with payload:","color: magenta; font-weight: bold;",JSON.parse(JSON.stringify(f))),r("save",f)};return(f,p)=>(G(),bn(fr,{name:"modal-fade"},{default:vn(()=>[t.show?(G(),Y("div",{key:0,class:"modal-overlay",onClick:p[13]||(p[13]=et(y=>f.$emit("close"),["self"]))},[m("div",{class:"modal-content",dir:_(s)==="ar"?"rtl":"ltr"},[m("button",{class:"close-modal-button",onClick:p[0]||(p[0]=y=>f.$emit("close"))},"×"),m("h3",null,C(t.scan?_(s)==="en"?"Edit Scan Record":"تعديل سجل الفحص":_(s)==="en"?"Add New Scan Record":"إضافة سجل فحص جديد"),1),t.patient?(G(),Y("div",a4,[Ot(C(_(s)==="en"?"For Patient":"للمريض")+": ",1),m("strong",null,C(t.patient.name),1)])):ve("",!0),m("form",{onSubmit:et(h,["prevent"]),class:"scan-form"},[t.patient?.gender==="female"?(G(),Y("div",l4,[m("div",c4,[m("label",null,[fe(m("input",{type:"checkbox","onUpdate:modelValue":p[1]||(p[1]=y=>a.isPregnant=y)},null,512),[[Kl,a.isPregnant]]),m("span",null,C(_(s)==="en"?"Is Pregnant?":"هل المريضة حامل؟"),1)])]),a.isPregnant?(G(),Y("div",u4,[m("label",null,C(_(s)==="en"?"Month of Pregnancy":"شهر الحمل"),1),fe(m("input",{type:"number","onUpdate:modelValue":p[2]||(p[2]=y=>a.pregnancyMonth=y),min:"1",max:"9",placeholder:"1-9"},null,512),[[ke,a.pregnancyMonth]])])):ve("",!0)])):ve("",!0),m("div",h4,[m("div",d4,[m("label",null,C(_(s)==="en"?"Scan Category":"فئة الفحص"),1),fe(m("select",{"onUpdate:modelValue":p[3]||(p[3]=y=>a.scanType=y),required:""},[m("option",f4,C(_(s)==="en"?"X-ray":"أشعة سينية"),1),m("option",p4,C(_(s)==="en"?"CT":"أشعة مقطعية"),1)],512),[[cn,a.scanType]])]),m("div",m4,[m("label",null,C(_(s)==="en"?"Scan Protocol":"بروتوكول الفحص"),1),fe(m("select",{"onUpdate:modelValue":p[4]||(p[4]=y=>a.subScanType=y),required:""},[m("option",g4,C(_(s)==="en"?"Select...":"اختر..."),1),(G(!0),Y(dt,null,vi(c.value,y=>(G(),Y("option",{key:y.value,value:y.value},C(_(s)==="en"?y.en:y.ar),9,y4))),128))],512),[[cn,a.subScanType]])])]),u.value?(G(),Y("div",_4,[m("label",null,C(_(s)==="en"?"Please specify scan protocol":"يرجى تحديد بروتوكول الفحص"),1),fe(m("input",{type:"text","onUpdate:modelValue":p[5]||(p[5]=y=>a.otherScanDescription=y),placeholder:_(s)==="en"?"e.g., Chest X-ray":"مثال: أشعة سينية للصدر",required:""},null,8,v4),[[ke,a.otherScanDescription]])])):ve("",!0),m("div",E4,[m("label",null,C(_(s)==="en"?"Scan Date":"تاريخ الفحص"),1),fe(m("input",{type:"date","onUpdate:modelValue":p[6]||(p[6]=y=>a.scanDate=y),required:""},null,512),[[ke,a.scanDate]])]),m("div",w4,[m("div",b4,[m("label",null,C(_(s)==="en"?"Patient's Dose (mSv)":"جرعة المريض (mSv)"),1),fe(m("input",{type:"number",step:"0.01","onUpdate:modelValue":p[7]||(p[7]=y=>a.dose=y)},null,512),[[ke,a.dose]])]),m("div",T4,[m("label",null,C(_(s)==="en"?"Doctor's Dose (mSv)":"جرعة الطبيب (mSv)"),1),fe(m("input",{type:"number",step:"0.01","onUpdate:modelValue":p[8]||(p[8]=y=>a.doctorDose=y)},null,512),[[ke,a.doctorDose]])])]),m("div",I4,[m("label",null,C(_(s)==="en"?"Reason for Scan":"أسباب الفحص"),1),fe(m("textarea",{"onUpdate:modelValue":p[9]||(p[9]=y=>a.reason=y),rows:"2"},null,512),[[ke,a.reason]])]),m("div",A4,[m("label",null,C(_(s)==="en"?"Additional Notes":"ملاحظات إضافية"),1),fe(m("textarea",{"onUpdate:modelValue":p[10]||(p[10]=y=>a.notes=y),rows:"3"},null,512),[[ke,a.notes]])]),m("div",S4,[m("label",null,C(_(s)==="en"?"Details affecting your exposure (optional)":"تفاصيل إضافية على تعرضك (اختياري)"),1),fe(m("textarea",{"onUpdate:modelValue":p[11]||(p[11]=y=>a.doctorAdditionalContext=y),rows:"2"},null,512),[[ke,a.doctorAdditionalContext]])]),m("div",P4,[m("button",{type:"submit",class:"action-button",disabled:t.isSaving},C(t.isSaving?_(s)==="en"?"Saving...":"جار الحفظ...":_(s)==="en"?"Save":"حفظ"),9,C4),m("button",{type:"button",onClick:p[12]||(p[12]=y=>f.$emit("close")),class:"action-button secondary"},C(_(s)==="en"?"Cancel":"إلغاء"),1)])],32)],8,o4)])):ve("",!0)]),_:1}))}},D4=yt(R4,[["__scopeId","data-v-af0da691"]]),k4={class:"modal-content delete-confirm-modal"},O4={class:"modal-title"},x4={class:"warning-text"},N4={class:"modal-actions"},V4={__name:"ConfirmDeleteModal",props:{show:Boolean,title:String,message:String},emits:["close","confirm"],setup(t){const e=Ue("triggerMsvRecalculation"),n=Ue("currentLanguage");return(r,s)=>(G(),bn(fr,{name:"modal-fade"},{default:vn(()=>[t.show?(G(),Y("div",{key:0,class:"modal-overlay",onClick:s[2]||(s[2]=et(i=>r.$emit("close"),["self"]))},[m("div",k4,[m("h3",O4,C(t.title),1),m("p",null,C(t.message),1),m("p",x4,C(_(n)==="en"?"This action cannot be undone.":"لا يمكن التراجع عن هذا الإجراء."),1),m("div",N4,[m("button",{onClick:s[0]||(s[0]=i=>r.$emit("close")),class:"action-button secondary"},C(_(n)==="en"?"Cancel":"إلغاء"),1),m("button",{onClick:s[1]||(s[1]=i=>{r.$emit("confirm"),_(e)()}),class:"action-button delete-button-confirm"},C(_(n)==="en"?"Delete":"حذف"),1)])])])):ve("",!0)]),_:1}))}},nf=yt(V4,[["__scopeId","data-v-acf7426f"]]),M4=["dir"],L4={key:0},F4={class:"scans-list-container"},$4={key:0,class:"loading-message"},U4={key:1,class:"no-scans-message"},B4={key:2,class:"scans-list"},j4={class:"scan-info"},H4={class:"scan-type"},q4={class:"scan-date"},z4={class:"scan-dose"},W4={class:"scan-actions"},G4=["onClick"],K4=["onClick"],Y4={__name:"PatientDetailsModal",props:{show:Boolean,patient:Object},emits:["close"],setup(t,{emit:e}){console.log("[PatientDetailsModal] Script setup started.");const n=t,r=Ls(),s=Ue("currentLanguage"),i=Ue("triggerMsvRecalculation"),o=Ie([]),a=Ie(null),c=Ie(null),u=Ie(!1),h=Ie(!1),f=Ae(()=>{const x=n.patient?.id;return console.log(`[PatientDetailsModal] Computed patientId is now: ${x}`),x}),p=async()=>{if(console.log(`[PatientDetailsModal] ==> fetchScans called with patientId: ${f.value}`),!f.value){o.value=[],console.warn("[PatientDetailsModal] fetchScans aborted: patientId is invalid.");return}const x=await r.fetchScansForPatient(f.value);x?(o.value=x,console.log("[PatientDetailsModal] <== fetchScans SUCCESS. Scans:",JSON.parse(JSON.stringify(x)))):console.error("[PatientDetailsModal] <== fetchScans FAILED or returned no data.")};rt(()=>n.show,x=>{console.log(`[PatientDetailsModal] WATCH props.show changed to: ${x}`),x&&console.log("[PatientDetailsModal] Modal is now visible. Patient prop data:",JSON.parse(JSON.stringify(n.patient))),x&&f.value&&p()});const y=async x=>{if(console.log("%c[PatientDetailsModal] ==> handleSavePatientScan called.","color: orange; font-weight: bold;"),console.log("[PatientDetailsModal] Data received from form (@save event):",JSON.parse(JSON.stringify(x))),!n.patient?.id){console.error("[PatientDetailsModal] SAVE FAILED: props.patient.id is missing.",JSON.parse(JSON.stringify(n.patient))),alert("Critical error: Patient context was lost.");return}if(console.log(`[PatientDetailsModal] Patient context is valid. ID: ${n.patient.id}`),!x.scanDate||isNaN(new Date(x.scanDate))){console.error(`[PatientDetailsModal] SAVE FAILED: Invalid date value received: "${x.scanDate}"`),alert(`Invalid or missing scan date: "${x.scanDate}"`);return}console.log(`[PatientDetailsModal] Date is valid: "${x.scanDate}"`);const $={...x,patientId:n.patient.id,scanDate:Oe.fromDate(new Date(x.scanDate)),patientDose:typeof x.dose=="number"?x.dose:null,doctorDose:typeof x.doctorDose=="number"?x.doctorDose:null};delete $.dose,console.log("%c[PatientDetailsModal] Final payload being sent to DB store:","color: blue; font-weight: bold;",JSON.parse(JSON.stringify($)));try{($.id?await r.updateScan($.id,$):await r.createScan($))?(console.log("[PatientDetailsModal] <== handleSavePatientScan SUCCESS."),u.value=!1,await p(),i&&i()):(console.error("[PatientDetailsModal] <== handleSavePatientScan FAILED. DB store error:",r.error),alert(`Error saving patient scan: ${r.error}`))}catch(F){console.error("%c[PatientDetailsModal] <== handleSavePatientScan CRITICAL ERROR.","color: red; font-weight: bold;",F),alert(`A critical error occurred: ${F.message}`)}},D=async()=>{if(console.log("[PatientDetailsModal] ==> handleDeleteScan called."),!c.value?.id){console.warn("[PatientDetailsModal] Aborted delete: scanToDelete has no ID.");return}console.log("[PatientDetailsModal] Deleting scan:",JSON.parse(JSON.stringify(c.value)))};function O(){console.log("[PatientDetailsModal] openAddScanModal called. Preparing for new scan."),a.value=null,u.value=!0}function V(x){console.log("[PatientDetailsModal] openEditScanModal called with scan:",JSON.parse(JSON.stringify(x)));const $={...x,dose:x.patientDose};a.value=$,u.value=!0}function M(x){console.log("[PatientDetailsModal] openConfirmDeleteScanModal called with scan:",JSON.parse(JSON.stringify(x))),c.value=x,h.value=!0}const k=x=>!x||!x.toDate?"N/A":x.toDate().toLocaleDateString();return(x,$)=>(G(),Y(dt,null,[Pe(fr,{name:"modal-fade"},{default:vn(()=>[t.show?(G(),Y("div",{key:0,class:"modal-overlay",onClick:$[1]||($[1]=et(F=>x.$emit("close"),["self"]))},[m("div",{class:"modal-content-details",dir:_(s)==="ar"?"rtl":"ltr"},[m("button",{class:"close-modal-button",onClick:$[0]||($[0]=F=>x.$emit("close"))},"×"),t.patient?(G(),Y("div",L4,[m("h3",null,[Ot(C(_(s)==="en"?"Scan History for":"سجل الفحوصات لـ")+" ",1),m("strong",null,C(t.patient.name),1)]),m("p",null,C(_(s)==="en"?"Review past scans or add a new record.":"مراجعة الفحوصات السابقة أو إضافة سجل جديد."),1),m("button",{onClick:O,class:"add-scan-button"},[Pe(_(Jt),{icon:"plus"}),Ot(" "+C(_(s)==="en"?"Add New Scan":"إضافة فحص جديد"),1)]),m("div",F4,[_(r).loading?(G(),Y("div",$4,[Pe(_(Jt),{icon:"spinner",spin:""}),Ot(" "+C(_(s)==="en"?"Loading scans...":"جاري تحميل الفحوصات..."),1)])):o.value.length===0?(G(),Y("div",U4,C(_(s)==="en"?"No scans recorded for this patient yet.":"لا توجد فحوصات مسجلة لهذا المريض بعد."),1)):(G(),Y("ul",B4,[(G(!0),Y(dt,null,vi(o.value,F=>(G(),Y("li",{key:F.id,class:"scan-item"},[m("div",j4,[m("span",H4,C(F.scanType),1),m("span",q4,C(k(F.scanDate)),1),m("span",z4,C(_(s)==="en"?"Dose:":"الجرعة:")+" "+C(F.patientDose)+" mSv",1)]),m("div",W4,[m("button",{onClick:q=>V(F),class:"action-button-icon edit-button"},[Pe(_(Jt),{icon:"edit"})],8,G4),m("button",{onClick:q=>M(F),class:"action-button-icon delete-button"},[Pe(_(Jt),{icon:"trash-alt"})],8,K4)])]))),128))]))])])):ve("",!0)],8,M4)])):ve("",!0)]),_:1}),Pe(D4,{show:u.value,patient:t.patient,scan:a.value,"is-saving":_(r).loading,onClose:$[2]||($[2]=F=>u.value=!1),onSave:y},null,8,["show","patient","scan","is-saving"]),Pe(nf,{show:h.value,title:_(s)==="en"?"Delete Scan":"حذف الفحص",message:`${_(s)==="en"?"Are you sure you want to delete this scan from":"هل أنت متأكد من حذف هذا الفحص بتاريخ"} ${k(c.value?.scanDate)}?`,onClose:$[3]||($[3]=F=>h.value=!1),onConfirm:D},null,8,["show","title","message"])],64))}},Q4=yt(Y4,[["__scopeId","data-v-8acbe5db"]]),J4={class:"patient-list-page"},X4={class:"patient-list-main-content"},Z4={class:"patient-list-card"},eV=["dir"],tV={key:0,class:"loading-message"},nV={key:1,class:"no-patients-message"},rV={key:2,class:"patient-table-container"},sV={class:"patient-table"},iV={class:"details-column"},oV={class:"details-column"},aV={class:"details-column"},lV={class:"details-column"},cV={class:"action-buttons-wrapper"},uV=["onClick","title"],hV=["onClick","title"],dV=["onClick","title"],fV=["onClick","title"],pV={class:"switch-link-container"},mV={__name:"PatientsView",setup(t){const e=en(),n=Ls(),r=xs(),s=Ue("currentLanguage"),i=Ie([]),o=Ie(null),a=Ie(null),c=Ie(null),u=Ie(!1),h=Ie(!1),f=Ie(!1),p=Ae(()=>e.user?.uid),y=async()=>{const q=await n.fetchPatientsForDoctor();q&&(i.value=q)},D=q=>{if(!q?.toDate)return"N/A";const S=q.toDate(),v=new Date;let w=v.getFullYear()-S.getFullYear(),b=v.getMonth()-S.getMonth();if(v.getDate()<S.getDate()&&b--,b<0&&(w--,b+=12),w>=2)return`${w} ${s.value==="ar"?"سنوات":"years"}`;{const T=s.value==="ar"?"سنة":"year",I=s.value==="ar"?"أشهر":"months",A=s.value==="ar"?"شهر":"month";return w>0?`${w} ${T}, ${b} ${b===1?A:I}`:b>0?`${b} ${b===1?A:I}`:s.value==="ar"?"أقل من شهر":"Less than a month"}},O=async q=>{const{id:S,...v}=q;let w=!1;S?w=await n.updatePatientProfile(S,v):w=!!await n.addNewPatient(v),w?(u.value=!1,await y()):alert(`Failed to save patient. Error: ${n.error}`)},V=async()=>{if(!o.value?.id)return;await n.deletePatientProfile(o.value.id)?(f.value=!1,await y()):alert(`Failed to delete patient. Error: ${n.error}`)};function M(){c.value=null,u.value=!0}function k(q){c.value=q,u.value=!0}function x(q){a.value=q,h.value=!0}function $(q){o.value=q,f.value=!0}function F(q){q&&r.push({name:"recommend",query:{patientId:q}})}return rt(p,q=>{q&&y()},{immediate:!0}),(q,S)=>(G(),Y("div",J4,[m("div",X4,[m("div",Z4,[m("h2",null,C(_(s)==="en"?"Manage Patients":"إدارة المرضى"),1),m("p",null,C(_(s)==="en"?"Add new patients or view existing records":"أضف مرضى جدد أو اطلع على السجلات الحالية."),1),m("button",{onClick:M,class:"add-new-patient-button"},C(_(s)==="en"?"Add New Patient":"إضافة مريض جديد"),1),m("div",{class:"patient-list-section",dir:_(s)==="ar"?"rtl":"ltr"},[m("h3",null,C(_(s)==="en"?"Existing Patients":"المرضى الحاليون"),1),_(n).loading?(G(),Y("div",tV,[Pe(_(Jt),{icon:"spinner",spin:""}),Ot(" "+C(_(s)==="en"?"Loading patients...":"جاري تحميل المرضى..."),1)])):!i.value||i.value.length===0?(G(),Y("div",nV,C(_(s)==="en"?"No patients added yet.":"لم يتم إضافة أي مرضى بعد."),1)):(G(),Y("div",rV,[m("table",sV,[m("thead",null,[m("tr",null,[m("th",null,C(_(s)==="en"?"Name":"الاسم"),1),m("th",null,C(_(s)==="en"?"Age":"العمر"),1),m("th",null,C(_(s)==="en"?"Gender":"الجنس"),1),m("th",iV,C(_(s)==="en"?"Medical History":"التاريخ الطبي"),1),m("th",oV,C(_(s)==="en"?"Allergies":"الحساسية"),1),m("th",null,C(_(s)==="en"?"Actions":"الإجراءات"),1)])]),m("tbody",null,[(G(!0),Y(dt,null,vi(i.value,v=>(G(),Y("tr",{key:v.id},[m("td",null,C(v.name??"N/A"),1),m("td",null,C(D(v.birthDate)),1),m("td",null,C(_(s)==="en"?(v.gender?.charAt(0).toUpperCase()??"")+(v.gender?.slice(1)??"N/A"):v.gender==="male"?"ذكر":"أنثى"),1),m("td",aV,C(v.medicalHistory?.join(", ")||(_(s)==="en"?"None":"لا يوجد")),1),m("td",lV,C(v.allergies?.join(", ")||(_(s)==="en"?"None":"لا يوجد")),1),m("td",null,[m("div",cV,[m("button",{onClick:w=>x(v),class:"action-button-sm view-button",title:_(s)==="en"?"View Scan History":"عرض سجل الفحوصات"},[Pe(_(Jt),{icon:"eye"})],8,uV),m("button",{onClick:w=>k(v),class:"action-button-sm edit-button",title:_(s)==="en"?"Edit Patient Details":"تعديل تفاصيل المريض"},[Pe(_(Jt),{icon:"edit"})],8,hV),m("button",{onClick:w=>$(v),class:"action-button-sm delete-button",title:_(s)==="en"?"Delete Patient":"حذف المريض"},[Pe(_(Jt),{icon:"trash-alt"})],8,dV),m("button",{onClick:w=>F(v.id),class:"action-button-sm recommend-button",title:_(s)==="en"?"Get Recommendation":"الحصول على توصية"},[Pe(_(Jt),{icon:"file-medical"})],8,fV)])])]))),128))])])]))],8,eV),m("div",pV,[m("a",{href:"#",onClick:S[0]||(S[0]=et(v=>_(r).push("/dashboard"),["prevent"]))},C(_(s)==="en"?"Back to dashboard":"العودة إلى لوحة التحكم"),1)])])]),Pe(i4,{show:u.value,patient:c.value,"is-saving":_(n).loading,onClose:S[1]||(S[1]=v=>u.value=!1),onSave:O},null,8,["show","patient","is-saving"]),Pe(Q4,{show:h.value,patient:a.value,onClose:S[2]||(S[2]=v=>h.value=!1)},null,8,["show","patient"]),Pe(nf,{show:f.value,title:_(s)==="en"?"Delete Patient":"حذف المريض",message:`${_(s)==="en"?"Are you sure you want to delete":"هل أنت متأكد من الحذف"} ${o.value?.name??"this patient"}?`,onClose:S[3]||(S[3]=v=>f.value=!1),onConfirm:V},null,8,["show","title","message"])]))}},gV=yt(mV,[["__scopeId","data-v-b0e986d2"]]),yV={key:0,class:"loading-container"},_V={key:0,class:"role-modal-backdrop"},vV={class:"role-modal"},EV={class:"form-group"},wV={value:"",disabled:""},bV={value:"doctor"},TV={value:"patient"},IV={class:"form-group"},AV={class:"form-group"},SV={value:"",disabled:""},PV={value:"male"},CV={value:"female"},RV={class:"form-group"},DV=["placeholder"],kV={class:"form-group"},OV=["placeholder"],xV=["disabled"],NV={key:1},VV={class:"dashboard-main-content"},MV={class:"dashboard-card"},LV=["dir"],FV=["dir"],$V={class:"dashboard-features"},UV=["dir"],BV=["dir"],jV=["dir"],HV=["dir"],qV=["dir"],zV=["dir"],WV={__name:"DashboardView",setup(t){const e=en(),n=Ls(),r=xs(),s=Ie({role:null,birthDate:"",gender:"",allergies:"",medicalHistory:""}),i=Ae(()=>!e.isAuthReady||e.isProfileLoading),o=Ae(()=>e.user?!e.isProfileComplete:!1),a=Ae(()=>e.role),c=Ue("currentLanguage"),u=async()=>{const{uid:f,email:p,displayName:y}=e.user,{role:D,birthDate:O,gender:V,allergies:M,medicalHistory:k}=s.value;if(!D||!O||!V){alert("Please fill out all required fields: Role, Birth Date, and Gender.");return}const x={email:p,displayName:y,role:D,birthDate:Oe.fromDate(new Date(O)),gender:V,allergies:M.split(",").map(F=>F.trim()).filter(Boolean),medicalHistory:k.split(",").map(F=>F.trim()).filter(Boolean)};await n.setUserProfile(f,x)?e.setUserProfile(x):alert(`Failed to save profile. Error: ${n.error}`)},h=async()=>{await e.logout(),r.push("/signin")};return(f,p)=>(G(),Y("div",null,[i.value?(G(),Y("div",yV,[m("p",null,C(_(c)==="en"?"Verifying session...":"جار التحقق من الجلسة..."),1),Pe(_(Jt),{icon:"spinner",spin:"",size:"2x"})])):(G(),Y(dt,{key:1},[o.value?(G(),Y("div",_V,[m("div",vV,[m("h2",null,C(_(c)==="en"?"Complete Your Profile":"أكمل ملفك الشخصي"),1),m("div",EV,[m("label",null,C(_(c)==="en"?"I am a:":"أنا:"),1),fe(m("select",{"onUpdate:modelValue":p[0]||(p[0]=y=>s.value.role=y)},[m("option",wV,C(_(c)==="en"?"-- Select Role --":"-- اختر دورك --"),1),m("option",bV,C(_(c)==="en"?"Doctor":"طبيب"),1),m("option",TV,C(_(c)==="en"?"Patient":"مريض"),1)],512),[[cn,s.value.role]])]),m("div",IV,[m("label",null,C(_(c)==="en"?"Birth Date":"تاريخ الميلاد"),1),fe(m("input",{type:"date","onUpdate:modelValue":p[1]||(p[1]=y=>s.value.birthDate=y)},null,512),[[ke,s.value.birthDate]])]),m("div",AV,[m("label",null,C(_(c)==="en"?"Gender":"الجنس"),1),fe(m("select",{"onUpdate:modelValue":p[2]||(p[2]=y=>s.value.gender=y)},[m("option",SV,C(_(c)==="en"?"-- Select Gender --":"-- اختر الجنس --"),1),m("option",PV,C(_(c)==="en"?"Male":"ذكر"),1),m("option",CV,C(_(c)==="en"?"Female":"أنثى"),1)],512),[[cn,s.value.gender]])]),m("div",RV,[m("label",null,C(_(c)==="en"?"Allergies (comma-separated)":"الحساسية (مفصولة بفاصلة)"),1),fe(m("textarea",{"onUpdate:modelValue":p[3]||(p[3]=y=>s.value.allergies=y),rows:"2",placeholder:_(c)==="en"?"e.g., Iodine-Based Dyes":"مثال: صبغات اليود"},null,8,DV),[[ke,s.value.allergies]])]),m("div",kV,[m("label",null,C(_(c)==="en"?"Medical History (comma-separated)":"التاريخ الطبي (مفصول بفاصلة)"),1),fe(m("textarea",{"onUpdate:modelValue":p[4]||(p[4]=y=>s.value.medicalHistory=y),rows:"2",placeholder:_(c)==="en"?"e.g., Diabetes, Asthma":"مثال: مرض السكري, الربو"},null,8,OV),[[ke,s.value.medicalHistory]])]),m("button",{class:"action-button",onClick:u,disabled:_(n).loading},[_(n).loading?(G(),bn(_(Jt),{key:0,icon:"spinner",spin:""})):(G(),Y("span",NV,C(_(c)==="en"?"Save & Continue":"حفظ ومتابعة"),1))],8,xV)])])):ve("",!0),m("div",{class:Ts(["dashboard-page dashboard-blur-area",{"is-blurred":o.value}])},[m("main",VV,[m("section",MV,[m("h2",{dir:_(c)==="ar"?"rtl":"ltr"},C(_(c)==="en"?"Welcome to mSv Dose Tracker":"مرحبًا بك في متتبع جرعات الأشعة السينية"),9,LV),m("p",{dir:_(c)==="ar"?"rtl":"ltr"},C(_(c)==="en"?"Your comprehensive tool for managing radiation exposure.":"أداتك الشاملة لإدارة التعرض للإشعاع."),9,FV),m("div",$V,[m("div",{class:"feature-item",onClick:p[5]||(p[5]=y=>_(r).push("/recommend"))},[p[8]||(p[8]=m("i",{class:"fas fa-file-medical"},null,-1)),m("h3",{dir:_(c)==="ar"?"rtl":"ltr"},C(_(c)==="en"?"Get Scan Recommendation":"الحصول على توصية"),9,UV),m("p",{dir:_(c)==="ar"?"rtl":"ltr"},C(_(c)==="en"?"Use AI to get recommendations on the necessity of radiological scans.":"استخدم الذكاء الاصطناعي للحصول على توصيات حول ضرورة الفحوصات الإشعاعية."),9,BV)]),a.value==="doctor"?(G(),Y("div",{key:0,class:"feature-item",onClick:p[6]||(p[6]=y=>_(r).push("/patients"))},[p[9]||(p[9]=m("i",{class:"fas fa-users"},null,-1)),m("h3",{dir:_(c)==="ar"?"rtl":"ltr"},C(_(c)==="en"?"Manage Patients":"إدارة المرضى"),9,jV),m("p",{dir:_(c)==="ar"?"rtl":"ltr"},C(_(c)==="en"?"View, add, and manage your patient records and their scan histories.":"عرض وإضافة وإدارة سجلات مرضاك وتاريخ فحوصاتهم."),9,HV)])):ve("",!0),m("div",{class:"feature-item",onClick:p[7]||(p[7]=y=>_(r).push("/profile"))},[p[10]||(p[10]=m("i",{class:"fas fa-user"},null,-1)),m("h3",{dir:_(c)==="ar"?"rtl":"ltr"},C(_(c)==="en"?"View Profile":"عرض الملف الشخصي"),9,qV),m("p",{dir:_(c)==="ar"?"rtl":"ltr"},C(_(c)==="en"?"Review your personal details and dose history.":"راجع معلوماتك الشخصية وسجل جرعاتك."),9,zV)])]),m("button",{onClick:h,class:"action-button secondary logout-button"},C(_(c)==="en"?"Logout":"تسجيل الخروج"),1)])])],2)],64))]))}},GV=yt(WV,[["__scopeId","data-v-f652aedd"]]),KV={class:"reset-password-page"},YV={class:"reset-password-main-content"},QV={class:"reset-password-card"},JV=["dir"],XV=["dir"],ZV={class:"form-group"},eM=["dir"],tM=["placeholder","dir"],nM=["disabled"],rM={key:0},sM={key:1},iM=["dir"],oM=["dir"],aM=["dir"],lM={__name:"ResetPasswordView",setup(t){const e=xs(),n=en(),r=Ue("currentLanguage"),s=Ie(""),i=async()=>{await n.sendPasswordReset(s.value)},o=()=>{e.push("/signin")};return(a,c)=>(G(),Y("div",KV,[m("main",YV,[m("section",QV,[m("h2",{dir:_(r)==="ar"?"rtl":"ltr"},C(_(r)==="en"?"Reset Your Password":"إعادة تعيين كلمة المرور"),9,JV),m("p",{dir:_(r)==="ar"?"rtl":"ltr"},C(_(r)==="en"?"Enter your email address to receive a password reset link.":"أدخل عنوان بريدك الإلكتروني لتلقي رابط إعادة تعيين كلمة المرور."),9,XV),m("form",{onSubmit:et(i,["prevent"]),class:"reset-password-form"},[m("div",ZV,[m("label",{for:"email",dir:_(r)==="ar"?"rtl":"ltr"},C(_(r)==="en"?"Email Address":"عنوان البريد الإلكتروني"),9,eM),fe(m("input",{type:"email",id:"email","onUpdate:modelValue":c[0]||(c[0]=u=>s.value=u),placeholder:_(r)==="en"?"Enter your email":"أدخل بريدك الإلكتروني",dir:_(r)==="ar"?"rtl":"ltr",required:""},null,8,tM),[[ke,s.value]])]),m("button",{class:"action-button primary",type:"submit",disabled:_(n).loading},[_(n).loading?(G(),Y("span",rM,C(_(r)==="en"?"Sending Link...":"جاري إرسال الرابط..."),1)):(G(),Y("span",sM,C(_(r)==="en"?"Send Reset Link":"إرسال رابط إعادة التعيين"),1))],8,nM)],32),_(n).error?(G(),Y("div",{key:0,class:"message error-message",dir:_(r)==="ar"?"rtl":"ltr"},C(_(n).error),9,iM)):ve("",!0),_(n).successMessage?(G(),Y("div",{key:1,class:"message success-message",dir:_(r)==="ar"?"rtl":"ltr"},C(_(n).successMessage),9,oM)):ve("",!0),m("p",{class:"switch-link-container",dir:_(r)==="ar"?"rtl":"ltr"},[Ot(C(_(r)==="en"?"Remembered your password?":"هل تذكرت كلمة المرور؟")+" ",1),m("a",{href:"#",onClick:et(o,["prevent"])},C(_(r)==="en"?"Sign In":"تسجيل الدخول"),1)],8,aM)])])]))}},cM=yt(lM,[["__scopeId","data-v-73a48bd7"]]),uM=["dir"],hM={class:"modal-title"},dM={class:"form-group"},fM={value:"doctor"},pM={value:"patient"},mM={class:"form-group"},gM={class:"form-group"},yM={value:"male"},_M={value:"female"},vM={key:0,class:"pregnancy-section"},EM={class:"form-group checkbox-group"},wM={key:0,class:"form-group"},bM={class:"form-group"},TM={class:"form-group"},IM={class:"modal-actions"},AM={type:"submit",class:"action-button"},SM={__name:"ProfileFormModal",props:{show:Boolean,profileData:{type:Object,default:()=>null}},emits:["close","save"],setup(t,{emit:e}){const n=t,r=e,s=Ue("currentLanguage"),i=hr({role:"",birthDate:"",gender:"male",isPregnant:!1,estimatedDueDate:"",allergies:"",medicalHistory:""});rt(()=>n.show,a=>{a&&n.profileData&&(console.log("ProfileFormModal: Modal is shown, populating form with data:",n.profileData),i.role=n.profileData.role||"patient",i.birthDate=n.profileData.birthDate||"",i.gender=n.profileData.gender||"male",i.isPregnant=n.profileData.isPregnant||!1,i.estimatedDueDate=n.profileData.estimatedDueDate||"",i.allergies=Array.isArray(n.profileData.allergies)?n.profileData.allergies.join(", "):"",i.medicalHistory=Array.isArray(n.profileData.medicalHistory)?n.profileData.medicalHistory.join(", "):"")},{immediate:!0}),rt(()=>i.gender,a=>{a==="male"&&(i.isPregnant=!1,i.estimatedDueDate="")}),rt(()=>i.isPregnant,a=>{a||(i.estimatedDueDate="")});const o=()=>{if(!i.role||!i.birthDate||!i.gender){alert("Role, Birth Date, and Gender are required.");return}if(i.isPregnant&&!i.estimatedDueDate){alert("Estimated due date is required for pregnant patients.");return}r("save",i)};return(a,c)=>(G(),bn(fr,{name:"modal-fade"},{default:vn(()=>[t.show?(G(),Y("div",{key:0,class:"modal-overlay",onClick:c[9]||(c[9]=et(u=>r("close"),["self"]))},[m("div",{class:"modal-content",dir:_(s)==="ar"?"rtl":"ltr"},[m("button",{class:"close-button",onClick:c[0]||(c[0]=u=>r("close"))},"×"),m("h3",hM,C(_(s)==="en"?"Edit Profile":"تعديل الملف الشخصي"),1),m("form",{onSubmit:et(o,["prevent"]),class:"profile-form"},[m("div",dM,[m("label",null,C(_(s)==="en"?"Role":"الدور"),1),fe(m("select",{"onUpdate:modelValue":c[1]||(c[1]=u=>i.role=u),required:""},[m("option",fM,C(_(s)==="en"?"Doctor":"طبيب"),1),m("option",pM,C(_(s)==="en"?"Patient":"مريض"),1)],512),[[cn,i.role]])]),m("div",mM,[m("label",null,C(_(s)==="en"?"Birth Date":"تاريخ الميلاد"),1),fe(m("input",{type:"date","onUpdate:modelValue":c[2]||(c[2]=u=>i.birthDate=u),required:""},null,512),[[ke,i.birthDate]])]),m("div",gM,[m("label",null,C(_(s)==="en"?"Gender":"الجنس"),1),fe(m("select",{"onUpdate:modelValue":c[3]||(c[3]=u=>i.gender=u),required:""},[m("option",yM,C(_(s)==="en"?"Male":"ذكر"),1),m("option",_M,C(_(s)==="en"?"Female":"أنثى"),1)],512),[[cn,i.gender]])]),i.gender==="female"?(G(),Y("div",vM,[m("div",EM,[m("label",null,[fe(m("input",{type:"checkbox","onUpdate:modelValue":c[4]||(c[4]=u=>i.isPregnant=u)},null,512),[[Kl,i.isPregnant]]),m("span",null,C(_(s)==="en"?"Currently Pregnant?":"هل أنت حامل حاليًا؟"),1)])]),i.isPregnant?(G(),Y("div",wM,[m("label",null,C(_(s)==="en"?"Estimated Due Date":"تاريخ الولادة المتوقع"),1),fe(m("input",{type:"date","onUpdate:modelValue":c[5]||(c[5]=u=>i.estimatedDueDate=u),required:""},null,512),[[ke,i.estimatedDueDate]])])):ve("",!0)])):ve("",!0),m("div",bM,[m("label",null,C(_(s)==="en"?"Allergies (comma-separated)":"الحساسية (مفصولة بفاصلة)"),1),fe(m("textarea",{"onUpdate:modelValue":c[6]||(c[6]=u=>i.allergies=u),rows:"2"},null,512),[[ke,i.allergies]])]),m("div",TM,[m("label",null,C(_(s)==="en"?"Medical History (comma-separated)":"التاريخ الطبي (مفصول بفاصلة)"),1),fe(m("textarea",{"onUpdate:modelValue":c[7]||(c[7]=u=>i.medicalHistory=u),rows:"2"},null,512),[[ke,i.medicalHistory]])]),m("div",IM,[m("button",{type:"button",onClick:c[8]||(c[8]=u=>r("close")),class:"action-button secondary"},C(_(s)==="en"?"Cancel":"إلغاء"),1),m("button",AM,C(_(s)==="en"?"Save Changes":"حفظ التغييرات"),1)])],32)],8,uM)])):ve("",!0)]),_:1}))}},PM=yt(SM,[["__scopeId","data-v-2d4615c7"]]),CM=["dir"],RM={class:"form-row"},DM={class:"form-group"},kM={value:"X-ray"},OM={value:"CT"},xM={class:"form-group"},NM={disabled:"",value:""},VM=["value"],MM={key:0,class:"form-group"},LM=["placeholder"],FM={class:"form-group"},$M={class:"form-group"},UM=["placeholder"],BM={class:"form-group"},jM={class:"form-group"},HM={class:"modal-actions"},qM=["disabled"],zM={__name:"PersonalScanFormModal",props:{show:Boolean,scan:Object,isSaving:Boolean},emits:["close","save"],setup(t,{emit:e}){const n=t,r=e,s=en();Ls();const i=Ue("currentLanguage"),o={CT:[{value:"Abdomen & Pelvis",en:"Abdomen & Pelvis",ar:"البطن والحوض"},{value:"Brain with contrast",en:"Brain with contrast",ar:"الدماغ بمادة تباين"},{value:"Angiography CTA",en:"Angiography CTA",ar:"تصوير الأوعية CTA"},{value:"Urography",en:"Urography",ar:"تصوير المسالك البولية"},{value:"Enterography",en:"Enterography",ar:"تصوير الأمعاء"},{value:"Other",en:"Other...",ar:"أخرى..."}],"X-ray":[{value:"Barium Swallow",en:"Barium Swallow",ar:"بلع الباريوم"},{value:"Barium Meal",en:"Barium Meal",ar:"وجبة الباريوم"},{value:"Barium Enema",en:"Barium Enema",ar:"حقنة الباريوم الشرجية"},{value:"IV Urogram (IVP)",en:"IV Urogram (IVP)",ar:"أشعة المسالك البولية (IVP)"},{value:"HSG",en:"HSG",ar:"أشعة الرحم (HSG)"},{value:"VCUG",en:"VCUG",ar:"دراسة المثانة بالصبغة (VCUG)"},{value:"Other",en:"Other...",ar:"أخرى..."}]},a=hr({id:null,scanType:"X-ray",subScanType:"",otherScanDescription:"",scanDate:"",patientDose:null,reason:"",notes:""}),c=Ae(()=>o[a.scanType]||[]),u=Ae(()=>a.subScanType==="Other");rt(()=>n.show,p=>{if(p&&(Object.assign(a,{id:null,scanType:"X-ray",subScanType:"",otherScanDescription:"",scanDate:new Date().toISOString().split("T")[0],patientDose:null,reason:"",notes:""}),n.scan)){a.id=n.scan.id,a.scanType=n.scan.scanType,a.scanDate=n.scan.scanDate?.toDate()?.toISOString().split("T")[0]||"",a.patientDose=n.scan.patientDose,a.reason=n.scan.reason,a.notes=n.scan.notes;const y=n.scan.scanDetail;c.value.some(O=>O.value===y)?a.subScanType=y:y&&(a.subScanType="Other",a.otherScanDescription=y)}}),rt(()=>a.scanType,()=>{a.subScanType="",a.otherScanDescription=""});const h=async()=>{const p=s.userProfile,y=p?.birthDate?new Date().getFullYear()-p.birthDate.toDate().getFullYear():"N/A",D=c.value.find(k=>k.value===a.subScanType);let O="";u.value?O=a.otherScanDescription:D&&(O=i.value==="en"?D.en:D.ar);const V=`Estimate the typical effective dose (in mSv) for a patient undergoing a ${a.scanType} scan with the specific protocol: "${O}". Patient Age: ${y}. Reason for scan: "${a.reason||"Not provided"}". Respond ONLY with a single number. Do not add any other text or units.`,M=a.scanType==="CT"?{min:.5,max:40}:{min:.001,max:10};try{const F=await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyB9KAR0P6sxAj7fP2I-MyVSVOJJaW0J91M",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:[{text:V}]}],generationConfig:{responseMimeType:"text/plain"}})});if(!F.ok)throw new Error(`API Error: ${F.statusText}`);const S=(await F.json()).candidates?.[0]?.content?.parts?.[0]?.text||"",v=parseFloat(S.match(/[\d.]+/));if(isNaN(v)||v<M.min||v>M.max)throw new Error("AI returned an invalid or out-of-range value.");return a.patientDose=v,!0}catch(k){return console.error("Dose estimation failed:",k),alert(i.value==="en"?"AI estimation failed. Please enter the dose manually.":"فشل تقدير الذكاء الاصطناعي. يرجى إدخال الجرعة يدويًا."),!1}},f=async()=>{if(!a.scanDate||!a.subScanType||a.subScanType==="Other"&&!a.otherScanDescription){alert(i.value==="en"?"Please fill all required scan details.":"يرجى ملء جميع تفاصيل الفحص المطلوبة.");return}if(!a.patientDose&&a.patientDose!==0&&!await h())return;const p=u.value?a.otherScanDescription:a.subScanType,y={id:a.id,scanType:a.scanType,scanDetail:p,scanDate:a.scanDate,patientDose:a.patientDose,reason:a.reason,notes:a.notes,isPersonalScan:!0};r("save",y)};return(p,y)=>(G(),bn(fr,{name:"modal-fade"},{default:vn(()=>[t.show?(G(),Y("div",{key:0,class:"modal-overlay",onClick:y[9]||(y[9]=et(D=>p.$emit("close"),["self"]))},[m("div",{class:"modal-content",dir:_(i)==="ar"?"rtl":"ltr"},[m("button",{class:"close-modal-button",onClick:y[0]||(y[0]=D=>p.$emit("close"))},"×"),m("h3",null,C(t.scan?_(i)==="en"?"Edit Personal Scan":"تعديل الفحص الشخصي":_(i)==="en"?"Add Personal Scan":"إضافة فحص شخصي"),1),m("form",{onSubmit:et(f,["prevent"]),class:"scan-form"},[m("div",RM,[m("div",DM,[m("label",null,C(_(i)==="en"?"Scan Category":"فئة الفحص"),1),fe(m("select",{"onUpdate:modelValue":y[1]||(y[1]=D=>a.scanType=D),required:""},[m("option",kM,C(_(i)==="en"?"X-ray":"أشعة سينية"),1),m("option",OM,C(_(i)==="en"?"CT":"أشعة مقطعية"),1)],512),[[cn,a.scanType]])]),m("div",xM,[m("label",null,C(_(i)==="en"?"Scan Protocol":"بروتوكول الفحص"),1),fe(m("select",{"onUpdate:modelValue":y[2]||(y[2]=D=>a.subScanType=D),required:""},[m("option",NM,C(_(i)==="en"?"Select...":"اختر..."),1),(G(!0),Y(dt,null,vi(c.value,D=>(G(),Y("option",{key:D.value,value:D.value},C(_(i)==="en"?D.en:D.ar),9,VM))),128))],512),[[cn,a.subScanType]])])]),u.value?(G(),Y("div",MM,[m("label",null,C(_(i)==="en"?"Please specify scan protocol":"يرجى تحديد بروتوكول الفحص"),1),fe(m("input",{type:"text","onUpdate:modelValue":y[3]||(y[3]=D=>a.otherScanDescription=D),placeholder:_(i)==="en"?"e.g., Left Hand X-ray":"مثال: أشعة سينية لليد اليسرى",required:""},null,8,LM),[[ke,a.otherScanDescription]])])):ve("",!0),m("div",FM,[m("label",null,C(_(i)==="en"?"Scan Date":"تاريخ الفحص"),1),fe(m("input",{type:"date","onUpdate:modelValue":y[4]||(y[4]=D=>a.scanDate=D),required:""},null,512),[[ke,a.scanDate]])]),m("div",$M,[m("label",null,C(_(i)==="en"?"Your Dose (mSv)":"جرعتك (mSv)"),1),fe(m("input",{type:"number",step:"0.01","onUpdate:modelValue":y[5]||(y[5]=D=>a.patientDose=D),placeholder:_(i)==="en"?"Leave blank for AI estimate":"اتركه فارغًا لتقدير الذكاء الاصطناعي"},null,8,UM),[[ke,a.patientDose]])]),m("div",BM,[m("label",null,C(_(i)==="en"?"Reason for Scan":"أسباب الفحص"),1),fe(m("textarea",{"onUpdate:modelValue":y[6]||(y[6]=D=>a.reason=D),rows:"2"},null,512),[[ke,a.reason]])]),m("div",jM,[m("label",null,C(_(i)==="en"?"Additional Notes":"ملاحظات إضافية"),1),fe(m("textarea",{"onUpdate:modelValue":y[7]||(y[7]=D=>a.notes=D),rows:"3"},null,512),[[ke,a.notes]])]),m("div",HM,[m("button",{type:"button",onClick:y[8]||(y[8]=D=>p.$emit("close")),class:"action-button secondary"},C(_(i)==="en"?"Cancel":"إلغاء"),1),m("button",{type:"submit",class:"action-button",disabled:t.isSaving},C(t.isSaving?_(i)==="en"?"Saving...":"جار الحفظ...":_(i)==="en"?"Save":"حفظ"),9,qM)])],32)],8,CM)])):ve("",!0)]),_:1}))}},WM=yt(zM,[["__scopeId","data-v-213e1796"]]),GM={class:"history-table-container"},KM={key:0,class:"loading-message"},YM={key:1,class:"no-items-message"},QM={key:2,class:"history-table"},JM={key:0},XM={class:"reason-column"},ZM={key:1},eL={class:"actions-column"},tL={key:0},nL={class:"reason-column"},rL={key:1},sL={class:"action-buttons-wrapper"},iL=["onClick"],oL=["onClick"],aL={__name:"HistoryTable",props:{scans:Array,isLoading:Boolean,isPersonalView:{type:Boolean,default:!1}},emits:["edit","delete"],setup(t,{emit:e}){const n=en(),r=Ue("currentLanguage");Ae(()=>n.role);const s=o=>{if(!o)return"N/A";const a=o.toDate?o.toDate():new Date(o);return isNaN(a)?"Invalid Date":new Date(a).toLocaleDateString("en-GB")},i=o=>typeof o=="number"?o.toFixed(3):"N/A";return(o,a)=>(G(),Y("div",GM,[t.isLoading?(G(),Y("div",KM,"...")):t.scans.length===0?(G(),Y("div",YM,C(_(r)==="en"?"No scan history found.":"لم يتم العثور على سجل فحوصات."),1)):(G(),Y("table",QM,[m("thead",null,[m("tr",null,[t.isPersonalView?ve("",!0):(G(),Y("th",JM,C(_(r)==="en"?"Patient Name":"اسم المريض"),1)),m("th",null,C(_(r)==="en"?"Scan Type":"نوع الفحص"),1),m("th",null,C(_(r)==="en"?"Scan Date":"تاريخ الفحص"),1),m("th",XM,C(_(r)==="en"?"Reason":"السبب"),1),m("th",null,C(_(r)==="en"?"Patient's Dose":"جرعة المريض"),1),t.isPersonalView?ve("",!0):(G(),Y("th",ZM,C(_(r)==="en"?"Doctor's Dose":"جرعة الطبيب"),1)),m("th",eL,C(_(r)==="en"?"Actions":"الإجراءات"),1)])]),m("tbody",null,[(G(!0),Y(dt,null,vi(t.scans,c=>(G(),Y("tr",{key:c.id},[t.isPersonalView?ve("",!0):(G(),Y("td",tL,C(c.patientName),1)),m("td",null,C(c.scanType),1),m("td",null,C(s(c.scanDate)),1),m("td",nL,C(c.reason||"N/A"),1),m("td",null,C(i(c.patientDose)),1),t.isPersonalView?ve("",!0):(G(),Y("td",rL,C(i(c.doctorDose)),1)),m("td",null,[m("div",sL,[m("button",{onClick:u=>o.$emit("edit",c),class:"action-button-sm edit-button"},C(_(r)==="en"?"Edit":"تعديل"),9,iL),m("button",{onClick:u=>o.$emit("delete",c),class:"action-button-sm delete-button"},C(_(r)==="en"?"Delete":"حذف"),9,oL)])])]))),128))])]))]))}},lL=yt(aL,[["__scopeId","data-v-6b648eda"]]),cL=["dir"],uL={class:"profile-section card"},hL={class:"card-header"},dL={key:0,class:"loading-state"},fL={key:1,class:"profile-details"},pL={key:0,class:"role-tag"},mL={key:1,class:"role-tag"},gL={key:0},yL={key:1},_L={key:2},vL={key:0},EL={key:0},wL={key:1},bL={class:"history-section card"},TL={class:"card-header"},IL={class:"switch-link-container"},AL={__name:"ProfileView",setup(t){const e=en(),n=Ls(),r=xs(),s=Ue("currentLanguage"),i=Ue("triggerMsvRecalculation"),o=Ie([]),a=Ie(!1),c=Ie(!1),u=Ie(!1),h=Ie(null),f=Ie(null),p=Ae(()=>e.user?.uid),y=Ae(()=>{if(!e.userProfile)return{displayName:e.user?.displayName||"",email:e.user?.email||""};const F=q=>{if(!q)return"";const S=q.toDate?q.toDate():new Date(q);return isNaN(S)?"":S.toISOString().split("T")[0]};return{...e.userProfile,displayName:e.user?.displayName,email:e.user?.email,birthDate:F(e.userProfile.birthDate),estimatedDueDate:F(e.userProfile.estimatedDueDate)}}),D=async()=>{if(!p.value)return;const F=await n.fetchScansForPatient(p.value);F&&(o.value=F)},O=async F=>{if(!p.value)return;const q={...e.userProfile,displayName:e.user.displayName,email:e.user.email,role:F.role,birthDate:Oe.fromDate(new Date(F.birthDate)),gender:F.gender,isPregnant:F.isPregnant,estimatedDueDate:F.isPregnant&&F.estimatedDueDate?Oe.fromDate(new Date(F.estimatedDueDate)):null,allergies:Array.isArray(F.allergies)?F.allergies:F.allergies.split(",").map(v=>v.trim()).filter(Boolean),medicalHistory:Array.isArray(F.medicalHistory)?F.medicalHistory:F.medicalHistory.split(",").map(v=>v.trim()).filter(Boolean)};await n.setUserProfile(p.value,q)?(e.setUserProfile(q),a.value=!1,i&&i()):alert(`Failed to save profile. Error: ${n.error}`)},V=async F=>{if(!p.value)return;const q={patientId:p.value,scanType:F.scanType,scanDate:Oe.fromDate(new Date(F.scanDate)),patientDose:Number(F.patientDose),doctorDose:0,reason:F.reason,notes:F.notes};(F.id?await n.updateScan(F.id,q):await n.createScan(q))?(c.value=!1,await D(),i&&i()):alert(`Failed to save scan: ${n.error}`)},M=async()=>{if(!f.value?.id)return;await n.deleteScan(f.value.id)?(u.value=!1,await D(),i&&i()):alert(`Failed to delete scan: ${n.error}`)},k=()=>{h.value=null,c.value=!0},x=F=>{h.value=F,c.value=!0},$=F=>{f.value=F,u.value=!0};return Hh(()=>{rt(()=>e.isAuthReady,F=>{F&&p.value&&D()},{immediate:!0})}),(F,q)=>(G(),Y("div",{class:"profile-page",dir:_(s)==="ar"?"rtl":"ltr"},[m("div",uL,[m("div",hL,[m("h2",null,C(_(s)==="en"?"My Profile":"ملفي الشخصي"),1),m("button",{onClick:q[0]||(q[0]=S=>a.value=!0),class:"action-button"},C(_(s)==="en"?"Edit Profile":"تعديل الملف الشخصي"),1)]),_(e).isProfileLoading?(G(),Y("div",dL,"Loading profile...")):y.value?(G(),Y("div",fL,[m("p",null,[m("strong",null,C(_(s)==="en"?"Name:":"اﻹسم:"),1),m("span",null,C(y.value.displayName),1)]),m("p",null,[m("strong",null,C(_(s)==="en"?"Email:":"البريد اﻹلكتروني:"),1),m("span",null,C(y.value.email),1)]),m("p",null,[m("strong",null,C(_(s)==="en"?"Role":"الدور")+":",1),y.value.role==="doctor"?(G(),Y("span",pL,C(_(s)==="en"?"Doctor":"طبيب"),1)):(G(),Y("span",mL,C(_(s)==="en"?"Patient":"مريض"),1))]),m("p",null,[m("strong",null,C(_(s)==="en"?"Birth Date:":"تاريخ الميلاد:"),1),m("span",null,C(y.value.birthDate||"Not set"),1)]),m("p",null,[m("strong",null,C(_(s)==="en"?"Gender: ":"الجنس: "),1),y.value.gender==="male"?(G(),Y("span",gL,C(_(s)==="en"?"Male":"ذكر"),1)):y.value.gender==="female"?(G(),Y("span",yL,C(_(s)==="en"?"Female":"أنثى"),1)):(G(),Y("span",_L,"Not set"))]),y.value.gender==="female"?(G(),Y("p",vL,[m("strong",null,C(_(s)==="en"?"Pregnant: ":"حامل: "),1),y.value.isPregnant?(G(),Y("span",EL,C(_(s)==="en"?"Yes":"نعم")+" ("+C(_(s)==="en"?"Due:":"المتوقع:")+" "+C(y.value.estimatedDueDate)+")",1)):(G(),Y("span",wL,C(_(s)==="en"?"No":"لا"),1))])):ve("",!0),m("p",null,[m("strong",null,C(_(s)==="en"?"Allergies:":"الحساسية:"),1),m("span",null,C(y.value.allergies?.join(", ")||"None"),1)]),m("p",null,[m("strong",null,C(_(s)==="en"?"Medical History:":"التاريخ الطبي:"),1),m("span",null,C(y.value.medicalHistory?.join(", ")||"None"),1)])])):ve("",!0)]),m("div",bL,[m("div",TL,[m("h2",null,C(_(s)==="en"?"Personal Scan History":"تاريخ الفحوصات الشخصية"),1),m("button",{onClick:k,class:"action-button"},C(_(s)==="en"?"Add Personal Scan":"إضافة فحص شخصي"),1)]),Pe(lL,{scans:o.value,"is-loading":_(n).loading,"is-personal-view":!0,onEdit:x,onDelete:$},null,8,["scans","is-loading"])]),Pe(PM,{show:a.value,"profile-data":y.value,onClose:q[1]||(q[1]=S=>a.value=!1),onSave:O},null,8,["show","profile-data"]),Pe(WM,{show:c.value,scan:h.value,"is-saving":_(n).loading,onClose:q[2]||(q[2]=S=>c.value=!1),onSave:V},null,8,["show","scan","is-saving"]),Pe(nf,{show:u.value,title:"Delete Scan",message:"Are you sure you want to delete this scan?",onClose:q[3]||(q[3]=S=>u.value=!1),onConfirm:M},null,8,["show"]),m("div",IL,[m("a",{href:"#",onClick:q[4]||(q[4]=et(S=>_(r).push("/dashboard"),["prevent"]))},C(_(s)==="en"?"Back to dashboard":"العودة إلى لوحة التحكم"),1)])],8,cL))}},SL=yt(AL,[["__scopeId","data-v-2ff55410"]]),Nl=JT({history:PT("/X-ray"),routes:[{path:"/",name:"signup",component:Dx},{path:"/signin",name:"signin",component:Xx},{path:"/dashboard",name:"dashboard",component:GV,meta:{requiresAuth:!0}},{path:"/recommend/:patientId?",name:"recommend",component:HN,meta:{requiresAuth:!0}},{path:"/patients",name:"patients",component:gV,meta:{requiresAuth:!0}},{path:"/profile",name:"profile",component:SL,meta:{requiresAuth:!0}},{path:"/resetpassword",name:"resetpassword",component:cM},{path:"/__/auth/handler",name:"firebaseAuthHandler",component:{render(){return oi("div")}},beforeEnter:(t,e,n)=>{n()}},{path:"/:catchAll(.*)",redirect:"/dashboard"},{path:"/__/auth/iframe",name:"firebaseAuthIframeHandler",component:{render(){return oi("div")}},beforeEnter:(t,e,n)=>{n()}}]});Nl.beforeEach(async(t,e,n)=>{const r=en();r.isAuthReady||await new Promise(a=>{const c=r.$subscribe((u,h)=>{h.isAuthReady&&(c(),a())})});const s=!!r.user;if(t.path.startsWith("/__/auth/handler")||t.path.startsWith("/__/auth/iframe")){n();return}console.log(`Navigating to: ${t.path} (name: ${t.name})`),console.log(`isAuthenticated: ${s}`);const o=["signup","signin","resetpassword","newpassword"].includes(t.name);s?o?(console.log(`Redirecting authenticated user from ${t.name} to /dashboard.`),n("/dashboard")):(console.log(`Allowing authenticated access to ${t.path}.`),n()):o?(console.log(`Allowing unauthenticated access to ${t.name}.`),n()):(console.log(`Redirecting unauthenticated user from ${t.path} (requires auth) to /signin.`),n("/signin"))});var PL="firebase",CL="11.10.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
