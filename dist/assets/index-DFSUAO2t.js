 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vo=-1;function pC(t,e){const n=t.toTimestamp().seconds,r=t.toTimestamp().nanoseconds+1,s=Pe.fromTimestamp(r===1e9?new Oe(n+1,0):new Oe(n,r));return new Yr(s,_e.empty(),e)}function mC(t){return new Yr(t.readTime,t.key,Vo)}class Yr{constructor(e,n,r){this.readTime=e,this.documentKey=n,this.largestBatchId=r}static min(){return new Yr(Pe.min(),_e.empty(),Vo)}static max(){return new Yr(Pe.max(),_e.empty(),Vo)}}function gC(t,e){let n=t.readTime.compareTo(e.readTime);return n!==0?n:(n=_e.comparator(t.documentKey,e.documentKey),n!==0?n:Ne(t.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jC=new st(_e.comparator);function ur(){return jC}const i1=new st(_e.comparator);function Zi(...t){let e=i1;for(const n of t)e=e.insert(n.key,n);return e}function o1(t){let e=i1;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function ws(){return _o()}function a1(){return _o()}function _o(){return new Vs(t=>t.toString(),(t,e)=>t.isEqual(e))}const qC=new st(_e.comparator),HC=new _t(_e.comparator);function Fe(...t){let e=HC;for(const n of t)e=e.add(n);return e}const zC=new _t(Ne);function WC(){return zC}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eh{constructor(){this.qr=new _t(bt.Qr),this.$r=new _t(bt.Ur)}isEmpty(){return this.qr.isEmpty()}addReference(e,n){const r=new bt(e,n);this.qr=this.qr.add(r),this.$r=this.$r.add(r)}Kr(e,n){e.forEach(r=>this.addReference(r,n))}removeReference(e,n){this.Wr(new bt(e,n))}Gr(e,n){e.forEach(r=>this.removeReference(r,n))}zr(e){const n=new _e(new et([])),r=new bt(n,e),s=new bt(n,e+1),i=[];return this.$r.forEachInRange([r,s],o=>{this.Wr(o),i.push(o.key)}),i}jr(){this.qr.forEach(e=>this.Wr(e))}Wr(e){this.qr=this.qr.delete(e),this.$r=this.$r.delete(e)}Jr(e){const n=new _e(new et([])),r=new bt(n,e),s=new bt(n,e+1);let i=Fe();return this.$r.forEachInRange([r,s],o=>{i=i.add(o.key)}),i}containsKey(e){const n=new bt(e,0),r=this.qr.firstAfterOrEqual(n);return r!==null&&e.isEqual(r.key)}}class bt{constructor(e,n){this.key=e,this.Hr=n}static Qr(e,n){return _e.comparator(e.key,n.key)||Ne(e.Hr,n.Hr)}static Ur(e,n){return Ne(e.Hr,n.Hr)||_e.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zR{constructor(){this.As=!1,this.Rs=!1,this.Vs=100,this.fs=function(){return vI()?8:_C(Bt())>0?6:4}()}initialize(e,n){this.gs=e,this.indexManager=n,this.As=!0}getDocumentsMatchingQuery(e,n,r,s){const i={result:null};return this.ps(e,n).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.ys(e,n,s,r).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new HR;return this.ws(e,n,o).next(c=>{if(i.result=c,this.Rs)return this.Ss(e,n,o,c.size)})}).next(()=>i.result)}Ss(e,n,r,s){return r.documentReadCount<this.Vs?(Ks()<=$e.DEBUG&&ce("QueryEngine","SDK will not create cache indexes for query:",Ys(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),G.resolve()):(Ks()<=$e.DEBUG&&ce("QueryEngine","Query:",Ys(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.fs*s?(Ks()<=$e.DEBUG&&ce("QueryEngine","The SDK decides to create cache indexes for query:",Ys(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Vn(n))):G.resolve())}ps(e,n){if(Km(n))return G.resolve(null);let r=Vn(n);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(n.limit!==null&&s===1&&(n=Ju(n,null,"F"),r=Vn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const o=Fe(...i);return this.gs.getDocuments(e,o).next(c=>this.indexManager.getMinOffset(e,r).next(l=>{const u=this.bs(n,c);return this.Ds(n,u,o,l.readTime)?this.ps(e,Ju(n,null,"F")):this.vs(e,u,n,l)}))})))}ys(e,n,r,s){return Km(n)||s.isEqual(Pe.min())?G.resolve(null):this.gs.getDocuments(e,r).next(i=>{const o=this.bs(n,i);return this.Ds(n,o,r,s)?G.resolve(null):(Ks()<=$e.DEBUG&&ce("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Ys(n)),this.vs(e,o,n,pC(s,Vo)).next(c=>c))})}bs(e,n){let r=new _t(s1(e));return n.forEach((s,i)=>{cc(e,i)&&(r=r.add(i))}),r}Ds(e,n,r,s){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}ws(e,n,r){return Ks()<=$e.DEBUG&&ce("QueryEngine","Using full collection scan to execute query:",Ys(n)),this.gs.getDocumentsMatchingQuery(e,n,Yr.min(),r)}vs(e,n,r,s){return this.gs.getDocumentsMatchingQuery(e,r,s).next(i=>(n.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mt="WebChannelConnection";class oD extends sD{constructor(e){super(e),this.u_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}jo(e,n,r,s,i){const o=sd();return new Promise((c,l)=>{const u=new D_;u.setWithCredentials(!0),u.listenOnce(k_.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case Qa.NO_ERROR:const m=u.getResponseJson();ce(Mt,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(m)),c(m);break;case Qa.TIMEOUT:ce(Mt,`RPC '${e}' ${o} timed out`),l(new ae(q.DEADLINE_EXCEEDED,"Request time out"));break;case Qa.HTTP_ERROR:const p=u.getStatus();if(ce(Mt,`RPC '${e}' ${o} failed with status:`,p,"response text:",u.getResponseText()),p>0){let v=u.getResponseJson();Array.isArray(v)&&(v=v[0]);const R=v?.error;if(R&&R.status&&R.message){const I=function(k){const N=k.toLowerCase().replace(/_/g,"-");return Object.values(q).indexOf(N)>=0?N:q.UNKNOWN}(R.status);l(new ae(I,R.message))}else l(new ae(q.UNKNOWN,"Server responded with status "+u.getStatus()))}else l(new ae(q.UNAVAILABLE,"Connection failed."));break;default:Se(9055,{c_:e,streamId:o,l_:u.getLastErrorCode(),h_:u.getLastError()})}}finally{ce(Mt,`RPC '${e}' ${o} completed.`)}});const h=JSON.stringify(s);ce(Mt,`RPC '${e}' ${o} sending request:`,s),u.send(n,"POST",h,r,15)})}P_(e,n,r){const s=sd(),i=[this.$o,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=N_(),c=x_(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.zo(l.initMessageHeaders,n,r),l.encodeInitMessageHeaders=!0;const h=i.join("");ce(Mt,`Creating RPC '${e}' stream ${s}: ${h}`,l);const m=o.createWebChannel(h,l);this.T_(m);let p=!1,v=!1;const R=new iD({Ho:E=>{v?ce(Mt,`Not sending because RPC '${e}' stream ${s} is closed:`,E):(p||(ce(Mt,`Opening RPC '${e}' stream ${s} transport.`),m.open(),p=!0),ce(Mt,`RPC '${e}' stream ${s} sending:`,E),m.send(E))},Yo:()=>m.close()}),I=(E,k,N)=>{E.listen(k,$=>{try{N($)}catch(V){setTimeout(()=>{throw V},0)}})};return I(m,Ji.EventType.OPEN,()=>{v||(ce(Mt,`RPC '${e}' stream ${s} transport opened.`),R.s_())}),I(m,Ji.EventType.CLOSE,()=>{v||(v=!0,ce(Mt,`RPC '${e}' stream ${s} transport closed`),R.__(),this.I_(m))}),I(m,Ji.EventType.ERROR,E=>{v||(v=!0,Kr(Mt,`RPC '${e}' stream ${s} transport errored. Name:`,E.name,"Message:",E.message),R.__(new ae(q.UNAVAILABLE,"The operation could not be completed")))}),I(m,Ji.EventType.MESSAGE,E=>{var k;if(!v){const N=E.data[0];We(!!N,16349);const $=N,V=$?.error||((k=$[0])===null||k===void 0?void 0:k.error);if(V){ce(Mt,`RPC '${e}' stream ${s} received error:`,V);const F=V.status;let X=function(T){const C=mt[T];if(C!==void 0)return m1(C)}(F),P=V.message;X===void 0&&(X=q.INTERNAL,P="Unknown error status: "+F+" with message "+V.message),v=!0,R.__(new ae(X,P)),m.close()}else ce(Mt,`RPC '${e}' stream ${s} received:`,N),R.a_(N)}}),I(c,O_.STAT_EVENT,E=>{E.stat===zu.PROXY?ce(Mt,`RPC '${e}' stream ${s} detected buffering proxy`):E.stat===zu.NOPROXY&&ce(Mt,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{R.o_()},0),R}terminate(){this.u_.forEach(e=>e.close()),this.u_=[]}T_(e){this.u_.push(e)}I_(e){this.u_=this.u_.filter(n=>n===e)}}function hu(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this._a?(cr(n),this._a=!1):ce("OnlineStateTracker",n)}ha(){this.oa!==null&&(this.oa.cancel(),this.oa=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oi{static emptySet(e){return new oi(e.comparator)}constructor(e){this.comparator=e?(n,r)=>e(n,r)||_e.comparator(n.key,r.key):(n,r)=>_e.comparator(n.key,r.key),this.keyedMap=Zi(),this.sortedSet=new st(this.comparator)}has(e){return this.keyedMap.get(e)!=null}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const n=this.keyedMap.get(e);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal((n,r)=>(e(n),!1))}add(e){const n=this.delete(e.key);return n.copy(n.keyedMap.insert(e.key,e),n.sortedSet.insert(e,null))}delete(e){const n=this.get(e);return n?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(n)):this}isEqual(e){if(!(e instanceof oi)||this.size!==e.size)return!1;const n=this.sortedSet.getIterator(),r=e.sortedSet.getIterator();for(;n.hasNext();){const s=n.getNext().key,i=r.getNext().key;if(!s.isEqual(i))return!1}return!0}toString(){const e=[];return this.forEach(n=>{e.push(n.toString())}),e.length===0?"DocumentSet ()":`DocumentSet (
  `+e.join(`  
`)+`
...
Note: Always consult your healthcare provider for personalized medical decisions.
  `,C={type:"OBJECT",properties:{recommendationText:{type:"STRING"},Warning:{type:"STRING"}},required:["recommendationText","Warning"]};try{const xe=await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyC8npsehZb6bm1r7lOc4oofjwkrldVINvY",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:[{text:T}]}],generationConfig:{responseMimeType:"application/json",responseSchema:C}})});if(!xe.ok)throw new Error(`API error: ${xe.statusText}`);const Te=await xe.json(),he=JSON.parse(Te.candidates[0].content.parts[0].text);R.value={...he,patientCalculatedMsv:I.value}}catch(x){console.error("AI generation failed:",x),R.value={recommendationText:F==="en"?"Unable to get AI advice at the moment. Please consult your doctor.":"غير قادر على الحصول على نصيحة الذكاء الاصطناعي الآن. يرجى استشارة طبيبك.",Warning:F==="en"?"Review your inputs carefully.":"يرجى مراجعة مدخلاتك بعناية.",patientCalculatedMsv:I.value}}finally{p.value=!1}}return($,V)=>(U(),j("div",{class:"recommend-page",dir:y(r)==="ar"?"rtl":"ltr"},[d("main",j5,[d("section",q5,[d("h2",null,_(y(r)==="en"?"Medical Scan Advisor for Guests":"مستشار الفحص الطبي للضيوف"),1),d("p",null,_(y(r)==="en"?"Fill in your details to get simple AI-powered advice. Scan details are optional.":"املأ تفاصيلك للحصول على نصيحة بسيطة مدعومة بالذكاء الاصطناعي. تفاصيل الفحص اختيارية."),1),d("form",{onSubmit:tt(N,["prevent"]),class:"recommend-form",novalidate:""},[d("div",H5,[d("label",null,_(y(r)==="en"?"Weight (kg)":"الوزن (كجم)"),1),ee(d("input",{type:"number",step:"0.1","onUpdate:modelValue":V[0]||(V[0]=F=>i.value.weight=F),placeholder:"e.g. 70.5",dir:y(r)==="ar"?"rtl":"ltr",min:"1"},null,8,z5),[[pe,i.value.weight]])]),d("div",W5,[d("label",null,[at(_(y(r)==="en"?"Date of Birth":"تاريخ الميلاد")+" ",1),V[14]||(V[14]=d("span",{class:"required-indicator"},"*",-1))]),ee(d("input",{type:"date","onUpdate:modelValue":V[1]||(V[1]=F=>i.value.birthDate=F),required:"",dir:y(r)==="ar"?"rtl":"ltr"},null,8,G5),[[pe,i.value.birthDate]])]),d("div",K5,[d("label",null,[at(_(y(r)==="en"?"Gender":"الجنس")+" ",1),V[15]||(V[15]=d("span",{class:"required-indicator"},"*",-1))]),ee(d("select",{"onUpdate:modelValue":V[2]||(V[2]=F=>i.value.gender=F),required:"",dir:y(r)==="ar"?"rtl":"ltr"},[d("option",X5,_(y(r)==="en"?"Male":"ذكر"),1),d("option",Q5,_(y(r)==="en"?"Female":"أنثى"),1)],8,Y5),[[lt,i.value.gender]])]),i.value.gender==="female"?(U(),j("div",J5,[d("div",Z5,[d("label",null,[ee(d("input",{type:"checkbox","onUpdate:modelValue":V[3]||(V[3]=F=>i.value.isPregnant=F)},null,512),[[Ko,i.value.isPregnant]]),d("span",null,_(y(r)==="en"?"Is Pregnant?":"هل هي حامل؟"),1)])]),i.value.isPregnant?(U(),j("div",e6,[d("label",null,[at(_(y(r)==="en"?"Estimated Due Date":"تاريخ الولادة المتوقع")+" ",1),V[16]||(V[16]=d("span",{class:"required-indicator"},"*",-1))]),ee(d("input",{type:"date","onUpdate:modelValue":V[4]||(V[4]=F=>i.value.estimatedDueDate=F),required:"",dir:y(r)==="ar"?"rtl":"ltr"},null,8,t6),[[pe,i.value.estimatedDueDate]])])):fe("",!0)])):fe("",!0),d("div",n6,[d("label",null,_(y(r)==="en"?"Relevant Medical History (optional)":"التاريخ الطبي ذو الصلة (اختياري)"),1),ee(d("textarea",{"onUpdate:modelValue":V[5]||(V[5]=F=>i.value.medicalHistory=F),rows:"3"},null,512),[[pe,i.value.medicalHistory]])]),d("div",r6,[d("label",null,_(y(r)==="en"?"Estimated Radiation Exposure in Past Year (mSv) - optional":"الجرعة المقدرة للإشعاع في السنة الماضية (mSv) - اختياري"),1),ee(d("input",{type:"number",step:"0.001",min:"0","onUpdate:modelValue":V[6]||(V[6]=F=>i.value.previousYearDose=F),placeholder:"e.g. 2.5",dir:y(r)==="ar"?"rtl":"ltr"},null,8,s6),[[pe,i.value.previousYearDose,void 0,{number:!0}]])]),d("div",i6,[d("label",null,_(y(r)==="en"?"Current Symptoms (optional)":"الأعراض الحالية (اختياري)"),1),ee(d("textarea",{"onUpdate:modelValue":V[7]||(V[7]=F=>i.value.currentSymptoms=F),rows:"3"},null,512),[[pe,i.value.currentSymptoms]])]),d("h3",o6,_(y(r)==="en"?"Scan to Consider (optional)":"الفحص المقترح (اختياري)"),1),d("div",a6,[d("label",null,_(y(r)==="en"?"Place of Scan":"مكان الفحص"),1),ee(d("select",{"onUpdate:modelValue":V[8]||(V[8]=F=>i.value.scanPlace=F),dir:y(r)==="ar"?"rtl":"ltr"},[d("option",c6,_(y(r)==="en"?"Select...":"اختر..."),1),(U(),j(Xe,null,Jt(c,F=>d("option",{key:F.value,value:F.value},_(y(r)==="en"?F.en:F.ar),9,u6)),64))],8,l6),[[lt,i.value.scanPlace]])]),m.value?(U(),j("div",d6,[d("label",null,_(y(r)==="en"?"Please specify other place":"يرجى تحديد المكان الآخر"),1),ee(d("input",{type:"text","onUpdate:modelValue":V[9]||(V[9]=F=>i.value.otherScanPlaceDescription=F),dir:y(r)==="ar"?"rtl":"ltr"},null,8,h6),[[pe,i.value.otherScanPlaceDescription]])])):fe("",!0),d("div",f6,[d("div",p6,[d("label",null,_(y(r)==="en"?"Scan Category":"فئة الفحص"),1),ee(d("select",{"onUpdate:modelValue":V[10]||(V[10]=F=>i.value.scanType=F),dir:y(r)==="ar"?"rtl":"ltr"},[d("option",g6,_(y(r)==="en"?"CT Scan":"الأشعة المقطعية"),1),d("option",y6,_(y(r)==="en"?"X-ray":"الأشعة السينية"),1)],8,m6),[[lt,i.value.scanType]])]),d("div",v6,[d("label",null,_(y(r)==="en"?"Scan Protocol":"بروتوكول الفحص"),1),ee(d("select",{"onUpdate:modelValue":V[11]||(V[11]=F=>i.value.subScanType=F),dir:y(r)==="ar"?"rtl":"ltr"},[d("option",b6,_(y(r)==="en"?"Select...":"اختر..."),1),(U(!0),j(Xe,null,Jt(u.value,F=>(U(),j("option",{key:F.value,value:F.value},_(y(r)==="en"?F.en:F.ar),9,w6))),128))],8,_6),[[lt,i.value.subScanType]])])]),h.value?(U(),j("div",E6,[d("label",null,_(y(r)==="en"?"Please specify scan protocol":"يرجى تحديد بروتوكول الفحص"),1),ee(d("input",{type:"text","onUpdate:modelValue":V[12]||(V[12]=F=>i.value.otherScanDescription=F),dir:y(r)==="ar"?"rtl":"ltr"},null,8,T6),[[pe,i.value.otherScanDescription]])])):fe("",!0),d("button",{type:"submit",class:"action-button",disabled:p.value},_(p.value?y(r)==="en"?"Getting Advice...":"جاري الحصول على النصيحة...":y(r)==="en"?"Get Advice":"الحصول على نصيحة"),9,I6)],32),v.value?(U(),j("div",S6,_(v.value),1)):fe("",!0),R.value?(U(),j("div",A6,[R.value.Warning?(U(),j("div",P6,[d("h4",null,_(y(r)==="en"?"Important Note":"ملاحظة هامة"),1),d("p",C6,_(R.value.Warning),1)])):fe("",!0),d("div",R6,[R.value.patientCalculatedMsv!==null?(U(),j("div",D6,[d("div",k6,[d("h4",null,_(y(r)==="en"?"Total Estimated Dose This Year":"الجرعة المقدرة الكلية لهذا العام"),1),d("p",null,[d("strong",null,_(R.value.patientCalculatedMsv.toFixed(3))+" mSv",1)])]),d("div",{class:zr(["msv-details overdose-status",{overdosed:E.value}])},[d("h4",null,_(y(r)==="en"?"Dose Safety Status":"حالة أمان الجرعة"),1),d("p",null,_(E.value?y(r)==="en"?"Above recommended safety limit! Proceed with caution.":"فوق الحد الآمن الموصى به! يرجى توخي الحذر.":y(r)==="en"?"Within safe limits.":"ضمن الحدود الآمنة."),1)],2)])):fe("",!0),d("div",O6,[d("h4",null,_(y(r)==="en"?"AI-Powered Advice":"نصيحة مدعومة بالذكاء الاصطناعي"),1),d("p",x6,_(R.value.recommendationText),1)])])])):fe("",!0),d("p",N6,[d("a",{href:"#",onClick:V[13]||(V[13]=tt(F=>y(e).push("/signin"),["prevent"]))},_(y(r)==="en"?"Back to Sign In":"العودة لتسجيل الدخول"),1)])])])],8,B5))}},M6=vt(V6,[["__scopeId","data-v-5f31265c"]]),$l=zT({history:wT("/X-ray/"),routes:[{path:"/",name:"signup",component:ok},{path:"/signin",name:"signin",component:Rk},{path:"/dashboard",name:"dashboard",component:bM,meta:{requiresAuth:!0}},{path:"/recommend/:patientId?",name:"recommend",component:UO,meta:{requiresAuth:!0}},{path:"/recommend/guest",name:"recommendGuest",component:M6,meta:{requiresAuth:!1}},{path:"/patients",name:"patients",component:q4,meta:{requiresAuth:!0}},{path:"/profile",name:"profile",component:U5,meta:{requiresAuth:!0}},{path:"/resetpassword",name:"resetpassword",component:MM},{path:"/__/auth/handler",name:"firebaseAuthHandler",component:{render(){return ci("div")}},beforeEnter:(t,e,n)=>{n()}},{path:"/:catchAll(.*)",redirect:"/dashboard"},{path:"/__/auth/iframe",name:"firebaseAuthIframeHandler",component:{render(){return ci("div")}},beforeEnter:(t,e,n)=>{n()}}]});$l.beforeEach(async(t,e,n)=>{const r=gn();r.isAuthReady||await new Promise(c=>{const l=r.$subscribe((u,h)=>{h.isAuthReady&&(l(),c())})});const s=!!r.user;if(t.path.startsWith("/__/auth/handler")||t.path.startsWith("/__/auth/iframe")){n();return}console.log(`Navigating to: ${t.path} (name: ${t.name})`),console.log(`isAuthenticated: ${s}`);const o=["signup","signin","resetpassword","newpassword","recommendGuest"].includes(t.name);s?o?(console.log(`Redirecting authenticated user from ${t.name} to /dashboard.`),n("/dashboard")):(console.log(`Allowing authenticated access to ${t.path}.`),n()):o?(console.log(`Allowing unauthenticated access to ${t.name}.`),n()):(console.log(`Redirecting unauthenticated user from ${t.path} (requires auth) to /signin.`),n("/signin"))});var L6="firebase",$6="11.10.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
